/*Auto generated by Kirby - v1.0.0 czlab.kirby.bl.stdlib - Fri Nov 17 2017 10:10:10 GMT+1100 (AEDT)*/
...
let A____1=Array.prototype.slice.call(arguments,1);
let A____2= A____1;
let readable_QUERY;
readable_QUERY=A____2[0];
...
switch (type) {
case "vector":
C____5=coll["____vec"]=true;
break;
case "list":
C____5=coll["____list"]=true;
break;
case "map":
C____5=coll["____map"]=true;
break;
}};
return coll;
}
...
let A____6=Array.prototype.slice.call(arguments,0);
let A____7= A____6;
let pfx;
pfx=A____7[0];
return symbol([
