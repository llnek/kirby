/*Auto generated by Kirby - v1.0.0 czlab.kirby.main - Fri Nov 17 2017 10:12:29 GMT+1100 (AEDT)*/
...
{
let G____9= pin;
G____9.setEncoding("utf8");
G____9.resume();
G____9.on("data",function () {
let ____args= Array.prototype.slice.call(arguments);
return source += ____args[0].toString();
});
G____9.on("end",function () {
let ____args= Array.prototype.slice.call(arguments);
return (function(){
try {
...
let A____10= options;
let source_DASH_map,show_DASH_ast;
source_DASH_map=A____10["source_DASH_map"];
show_DASH_ast=A____10["show_DASH_ast"];
let source= null;
if ((!show_DASH_ast)) {
if (console) {
console.log([
