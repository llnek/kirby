/*Auto generated by Kirby - v1.0.0 czlab.kirby.cg.transpiler - Fri Nov 17 2017 10:12:09 GMT+1100 (AEDT)*/
...
let A____8=Array.prototype.slice.call(arguments,1);
let A____9= A____8;
let line,file,msg;
line=A____9[0];
file=A____9[1];
...
let A____10=Array.prototype.slice.call(arguments,1);
let A____11= A____10;
let ast,cmd;
ast=A____11[0];
cmd=A____11[1];
...
{
let G____13= keys;
Object.entries(G____13).forEach(function (e) {
return (function (v,k) {
...
{
let G____14= root;
for (let G____16=0,G____15=false,____break=false;((!____break)&&((!G____15)&&(G____16 < G____14.length))); G____16=(G____16+1)){
let r= G____14[G____16];
let tmp= tx_STAR(r,env);
if ((!true)) {
G____15=true;
};
if (((!G____15)&&some_QUERY(tmp))) {
{
ret.add([
tmp,
"\n"
...
let A____17=Array.prototype.slice.call(arguments,2);
let A____18= A____17;
let return_QUERY;
return_QUERY=A____18[0];
let ret= node_QUOTE(tnode(),ast);
let stmtQ= stmt_QUERY(ast);
let e= null;
...
{
let G____19= kks;
Object.entries(G____19).forEach(function (e) {
return (function (v,k) {
return EXTERNS[k]=k;
})(e[1],e[0]);
});
...
{
let G____20= kks;
Object.entries(G____20).forEach(function (e) {
return (function (v,k) {
return EXTERNS[k]=k;
})(e[1],e[0]);
});
...
if (((!private_QUERY)&&(!dot_QUERY)&&(1 === rt.globalEnv().countNSPCache()))) {
EXTERNS[fname]=fname;
};
return ret;
}
...
let arr= [];
{
let G____22= code.split("\n");
for (let G____24=0,G____23=false,____break=false;((!____break)&&((!G____23)&&(G____24 < G____22.length))); G____24=(G____24+1)){
let s= G____22[G____24];
null;
if ((!true)) {
G____23=true;
};
...
let A____25= options;
let source_DASH_map,format;
source_DASH_map=A____25["source_DASH_map"];
format=A____25["format"];
let cstr= "";
let fopts= {};
...
let A____26=Array.prototype.slice.call(arguments,2);
let A____27= A____26;
let options;
options=A____27[0];
...
let A____28=Array.prototype.slice.call(arguments,2);
let A____29= A____28;
let options;
options=A____29[0];
return transpileXXX(code,file,opt_QUERY__QUERY(options,{}));
