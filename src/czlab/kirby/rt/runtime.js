/*Auto generated by Kirby - v1.0.0 czlab.kirby.rt.runtime Mon Nov 06 2017 23:09:41 GMT-0800 (PST)*/
...
((!c) ?
(function (){ throw new Error("missing namespace"); })(this) :
null);
...
//
function wrap_DASHstr(s) {
return ["\"",s.replace(/\\/g,"\\\\").replace(/"/g,"\\\"").replace(/\n/g,"\\n"),"\""].join("");
}

//
function unwrap_DASHstr(s) {
...
return (std.sequential_QUERY(x)&&std.not_DASHempty(x));
}
...
//
function fn_DASHwrap(run,ast,env,params) {
return (function() {
let f;
f= function () {
let ____args;
...
ret=fn_DASHwrap(compute,ast[2],env,ast[1]);
return G__13;
}).call(this) :
(true ?
(function() {
