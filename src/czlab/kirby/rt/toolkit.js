/*Auto generated by Kirby - v1.0.0 czlab.kirby.rt.toolkit Mon Nov 06 2017 23:09:37 GMT-0800 (PST)*/
...
let pfx;
pfx=G____5[0];
return std.symbol([(pfx||"G__"),std.swap_BANG(gensym_DASHcounter,function (x) {
return (x+1);
})].join(""));
}
...
},"symbol*": std.symbol,"is-symbol?": std.symbol_QUERY,"keyword*": std.keyword,"is-keyword?": std.keyword_QUERY,"println*": prnice,"prn*": prn_DASHstr,"slurp*": slurp,"<": function (a,b) {
return (a < b);
},"<=": function (a,b) {
return (a <= b);
},">": function (a,b) {
...
arr.slice(1) :
[]);
},"is-empty?": std.empty_QUERY,"not-empty*": std.not_DASHempty,"count*": std.count,"apply*": fapply,"map*": fmap,"type*": function (x) {
return typeof(x);
