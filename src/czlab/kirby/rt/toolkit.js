/*Auto generated by Kirby - v1.0.0 czlab.kirby.rt.toolkit Sat Oct 28 2017 00:36:57 GMT-0700 (PDT)*/
...
let xs=Array.prototype.slice.call(arguments,0);
  ...
  return (arr ?
    arr.slice(1) :
    []);
  },"is-empty?": std.empty_QUERY,"not-empty*": std.not_empty,"count*": std.count,"apply*": apply,"map*": map,"type*": function (x) {
  return typeof(x);
  },"evens*": std.evens,"odds*": std.odds,"conj*": conj,"seq*": seq,"with-meta*": withMeta,"meta*": meta,"atom*": types.atom,"is-atom?": types.atom_QUERY,"deref*": deref,"reset*": reset,"swap*": swap,"js-eval*": evalJS,"js*": invokeJS };
