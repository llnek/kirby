/*Auto generated by Kirby - v1.0.0 czlab.kirby.rt.toolkit Sun Nov 05 2017 17:33:30 GMT-0800 (PST)*/
...
let pfx;
pfx=G____5[0];
return std.symbol([(pfx||"G__"),swap_BANG(gensym_counter,function (x) {
return (x+1);
})].join(""));
}
