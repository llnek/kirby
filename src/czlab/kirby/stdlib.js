/*Auto generated by Kirby v1.0.0 - Sun Mar 11 2018 17:27:21 GMT-0700 (PDT)
  czlab.kirby.stdlib
...
////////////////////////////////////////////////////////////////////////////////
//fn: [println] in file: stdlib.ky, line: 824
...
////////////////////////////////////////////////////////////////////////////////
//fn: [not-empty] in file: stdlib.ky, line: 829
...
////////////////////////////////////////////////////////////////////////////////
//fn: [noCRef] in file: stdlib.ky, line: 837
...
////////////////////////////////////////////////////////////////////////////////
//fn: [stringify] in file: stdlib.ky, line: 855
...
////////////////////////////////////////////////////////////////////////////////
//fn: [opt??] in file: stdlib.ky, line: 863
  ...
  if (nichts_QMRK(coll)) {
    ...
    if ( (Array.isArray(coll)) ) {
      ...
      if (( (Object.prototype.toString.call(coll) === "[object Set]") )) {
        let GS__1 = xs;
        for (let GS__3 = 0, GS__2 = false, ____break = false; ((!____break) && ((!GS__2) && (GS__3 < GS__1.length))); GS__3 = (GS__3 + 1)) {
          let x = getProp(GS__1, GS__3);
          null;
          if ( (!true) ) {
            (
            GS__2 = true);
...
////////////////////////////////////////////////////////////////////////////////
//fn: [conj] in file: stdlib.ky, line: 890
//Like conj! but
...
////////////////////////////////////////////////////////////////////////////////
//fn: [disj!] in file: stdlib.ky, line: 907
...
////////////////////////////////////////////////////////////////////////////////
//fn: [disj] in file: stdlib.ky, line: 913
//disj[oin]. Returns a new set without these keys
const disj = function(coll) {
  let xs = Array.prototype.slice.call(arguments, 1);
  let s2 = new Set(xs);
  return new Set(Array.from(coll.values()).filter(function() {
    let ____args = Array.prototype.slice.call(arguments);
    return (!s2.has(____args[0]));
  }));
};
////////////////////////////////////////////////////////////////////////////////
//fn: [pop!] in file: stdlib.ky, line: 920
...
////////////////////////////////////////////////////////////////////////////////
//fn: [pop] in file: stdlib.ky, line: 933
...
////////////////////////////////////////////////////////////////////////////////
//fn: [getProp] in file: stdlib.ky, line: 956
...
////////////////////////////////////////////////////////////////////////////////
//fn: [prnArr*] in file: stdlib.ky, line: 992
//Print an array
...
////////////////////////////////////////////////////////////////////////////////
//fn: [prn*] in file: stdlib.ky, line: 1000
const prn_STAR = function(obj, r_QMRK, func) {
  ...
  return (function() {
    ...
    switch (typeid(obj)) {
      case "atom":
        C__9 = wrap_DASH_str(func(null, obj.value), "(atom ", ")");
        break;
      case "lambda-arg":
      case "regex-obj":
      case "keyword":
      case "symbol":
        ...
        break;
      case "object":
        C__9 = wrap_DASH_str(seq(obj).reduce(function(acc, GS__10) {
          let k = getIndex(GS__10, 0);
          let v = getIndex(GS__10, 1);
          let x = func(k, v);
        ...
        break;
      case "objectMap":
        C__9 = wrap_DASH_str(seq(obj).reduce(function(acc, GS__11) {
          let k = getIndex(GS__11, 0);
          let v = getIndex(GS__11, 1);
          let x = func(k, v);
          if ( (!((typeof (x) === "undefined"))) ) {
            conj_BANG(acc, [pfx(k), " ", pfx(x)].join(""));
          } else {
        ...
        break;
      case "objectSet":
        C__9 = wrap_DASH_str(seq(obj).reduce(function(acc, v) {
          let x = func(v, v);
          if ( (!((typeof (x) === "undefined"))) ) {
            conj_BANG(acc, pfx(v));
          } else {
...
class LambdaArg {
  ////////////////////////////////////////////////////////////////////////////////
  //fn: [constructor] in file: stdlib.ky, line: 1055
  constructor(arg) {
    let name = ((arg === "%") ?
      "1" :
      arg.slice(1));
  ...
  ////////////////////////////////////////////////////////////////////////////////
  //fn: [toString] in file: stdlib.ky, line: 1062
  toString() {
    return this.value;
  }
}
...
class Primitive {
  ////////////////////////////////////////////////////////////////////////////////
  //fn: [constructor] in file: stdlib.ky, line: 1067
  constructor(v) {
    (
    this.value = v);
    return this;
  ...
  ////////////////////////////////////////////////////////////////////////////////
  //fn: [toString] in file: stdlib.ky, line: 1069
  toString() {
    return this.value;
  }
}
...
class RegexObj {
  ////////////////////////////////////////////////////////////////////////////////
  //fn: [constructor] in file: stdlib.ky, line: 1074
  constructor(v) {
    (
    this.value = v);
    return this;
...
class Keyword {
  ////////////////////////////////////////////////////////////////////////////////
  //fn: [constructor] in file: stdlib.ky, line: 1081
  constructor(name) {
    (
    this.value = name);
    return this;
  ...
  ////////////////////////////////////////////////////////////////////////////////
  //fn: [toString] in file: stdlib.ky, line: 1083
  toString() {
...
class Symbol {
  ////////////////////////////////////////////////////////////////////////////////
  //fn: [constructor] in file: stdlib.ky, line: 1091
  constructor(name) {
    (
    this.value = name);
    return this;
...
class Atom {
  ////////////////////////////////////////////////////////////////////////////////
  //fn: [constructor] in file: stdlib.ky, line: 1147
  constructor(val) {
    (
    this.value = val);
    return this;
...
////////////////////////////////////////////////////////////////////////////////
//fn: [atom?] in file: stdlib.ky, line: 1150
//Returns true if an Atom
const atom_QMRK = function(atm) {
  return (atm instanceof Atom);
};
////////////////////////////////////////////////////////////////////////////////
//fn: [atom] in file: stdlib.ky, line: 1154
//Create a new Atom
const atom = function(val) {
  return new Atom(val);
};
////////////////////////////////////////////////////////////////////////////////
//fn: [reset!] in file: stdlib.ky, line: 1158
...
////////////////////////////////////////////////////////////////////////////////
//fn: [resetVec!] in file: stdlib.ky, line: 1162
...
////////////////////////////////////////////////////////////////////////////////
//fn: [resetMap!] in file: stdlib.ky, line: 1166
...
////////////////////////////////////////////////////////////////////////////////
//fn: [resetSet!] in file: stdlib.ky, line: 1170
...
////////////////////////////////////////////////////////////////////////////////
//fn: [resetObject!] in file: stdlib.ky, line: 1174
...
////////////////////////////////////////////////////////////////////////////////
//fn: [objClass] in file: stdlib.ky, line: 1180
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sort!] in file: stdlib.ky, line: 1184
...
////////////////////////////////////////////////////////////////////////////////
//fn: [XXfind] in file: stdlib.ky, line: 1191
//Returns the value of the first element
//in the collection that satisfies the
//provided predicate function
const XXfind = function(coll, pred) {
  let ret = null;
  let c = null;
...
////////////////////////////////////////////////////////////////////////////////
//fn: [deref] in file: stdlib.ky, line: 1207
//Get value inside the Atom
const deref = function(a) {
  return a.value;
};
////////////////////////////////////////////////////////////////////////////////
//fn: [swap!] in file: stdlib.ky, line: 1211
...
////////////////////////////////////////////////////////////////////////////////
//fn: [typeid] in file: stdlib.ky, line: 1219
//Returns the type-id
//of this object
...
////////////////////////////////////////////////////////////////////////////////
//fn: [complex?] in file: stdlib.ky, line: 1246
...
////////////////////////////////////////////////////////////////////////////////
//fn: [simple?] in file: stdlib.ky, line: 1253
//True if x is a
...
////////////////////////////////////////////////////////////////////////////////
//fn: [value?] in file: stdlib.ky, line: 1259
//Returns true
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sequential?] in file: stdlib.ky, line: 1274
//True if coll
...
////////////////////////////////////////////////////////////////////////////////
//fn: [set2Set] in file: stdlib.ky, line: 1282
const set2Set = function(s) {
  let ret = new Set();
  for (let i = 0, sz = count(s), ____break = false; ((!____break) && (i < sz)); i = (i + 1)) {
    ret.add(m[i]);
  }
  return ret;
};
////////////////////////////////////////////////////////////////////////////////
//fn: [eqSets?] in file: stdlib.ky, line: 1289
...
////////////////////////////////////////////////////////////////////////////////
//fn: [map2Map] in file: stdlib.ky, line: 1300
...
////////////////////////////////////////////////////////////////////////////////
//fn: [eqMaps?] in file: stdlib.ky, line: 1307
...
////////////////////////////////////////////////////////////////////////////////
//fn: [map2Obj] in file: stdlib.ky, line: 1318
...
////////////////////////////////////////////////////////////////////////////////
//fn: [eq?] in file: stdlib.ky, line: 1328
...
////////////////////////////////////////////////////////////////////////////////
//fn: [object?] in file: stdlib.ky, line: 1379
//Returns true
//if a js object
...
////////////////////////////////////////////////////////////////////////////////
//fn: [last] in file: stdlib.ky, line: 1387
...
////////////////////////////////////////////////////////////////////////////////
//fn: [into!] in file: stdlib.ky, line: 1393
...
const into_BANG = function(type, coll) {
  ...
  switch (type) {
    ...
    case "map":
    case "vector":
      C__17 = (coll["____typeid"] = type);
      break;
  }
  return coll;
};
////////////////////////////////////////////////////////////////////////////////
//fn: [into] in file: stdlib.ky, line: 1400
//Like into! but
...
////////////////////////////////////////////////////////////////////////////////
//fn: [pairs?] in file: stdlib.ky, line: 1406
//Returns true if
...
////////////////////////////////////////////////////////////////////////////////
//fn: [object] in file: stdlib.ky, line: 1459
...
////////////////////////////////////////////////////////////////////////////////
//fn: [seq] in file: stdlib.ky, line: 1466
//Returns a sequence
...
////////////////////////////////////////////////////////////////////////////////
//fn: [contains?] in file: stdlib.ky, line: 1476
...
////////////////////////////////////////////////////////////////////////////////
//fn: [nichts?] in file: stdlib.ky, line: 1485
//True if object is
...
////////////////////////////////////////////////////////////////////////////////
//fn: [some?] in file: stdlib.ky, line: 1489
//True if object is
...
////////////////////////////////////////////////////////////////////////////////
//fn: [count] in file: stdlib.ky, line: 1493
...
////////////////////////////////////////////////////////////////////////////////
//fn: [concat*] in file: stdlib.ky, line: 1503
...
////////////////////////////////////////////////////////////////////////////////
//fn: [every] in file: stdlib.ky, line: 1508
...
////////////////////////////////////////////////////////////////////////////////
//fn: [evens] in file: stdlib.ky, line: 1514
//Collect every
...
////////////////////////////////////////////////////////////////////////////////
//fn: [odds] in file: stdlib.ky, line: 1518
//Collect every
...
////////////////////////////////////////////////////////////////////////////////
//fn: [modulo] in file: stdlib.ky, line: 1522
//Modulo
...
////////////////////////////////////////////////////////////////////////////////
//fn: [partition] in file: stdlib.ky, line: 1530
//Returns a sequence of lists of n items each.
const partition = function(n, coll) {
  return (function() {
    let _x_ = null;
    let recur = null;
    let _f_ = function(ret, GS__18) {
      let x = getIndex(GS__18, 0);
      let y = getIndex(GS__18, 1);
      if (not_DASH_empty(x)) {
        conj_BANG(ret, x);
      }
      return ((0 === count(y)) ?
...
////////////////////////////////////////////////////////////////////////////////
//fn: [split-str] in file: stdlib.ky, line: 1543
...
////////////////////////////////////////////////////////////////////////////////
//fn: [interleave] in file: stdlib.ky, line: 1554
...
////////////////////////////////////////////////////////////////////////////////
//fn: [zipmap] in file: stdlib.ky, line: 1565
...
////////////////////////////////////////////////////////////////////////////////
//fn: [zipobj] in file: stdlib.ky, line: 1577
//Returns an object with the
//keys mapped to the corresponding vals
...
////////////////////////////////////////////////////////////////////////////////
//fn: [extendAttr] in file: stdlib.ky, line: 1589
...
////////////////////////////////////////////////////////////////////////////////
//fn: [cons] in file: stdlib.ky, line: 1595
...
////////////////////////////////////////////////////////////////////////////////
//fn: [gensym] in file: stdlib.ky, line: 1604
...
////////////////////////////////////////////////////////////////////////////////
//fn: [carve] in file: stdlib.ky, line: 1611
const carve = function(coll) {
  let GS__21 = Array.prototype.slice.call(arguments, 1);
  let start = getIndex(GS__21, 0);
  let end = getIndex(GS__21, 1);
...
////////////////////////////////////////////////////////////////////////////////
//fn: [assoc!] in file: stdlib.ky, line: 1619
...
////////////////////////////////////////////////////////////////////////////////
//fn: [dissoc!] in file: stdlib.ky, line: 1631
const dissoc_BANG = function(obj) {
  let xs = Array.prototype.slice.call(arguments, 1);
  let k;
  if (obj) {
    for (let i = 0, sz = count(xs), ____break = false; ((!____break) && (i < sz)); i = (i + 1)) {
      (
      k = xs[i]);
      if (( (Object.prototype.toString.call(obj) === "[object Map]") )) {
        obj.delete(k);
...
////////////////////////////////////////////////////////////////////////////////
//fn: [truthy?] in file: stdlib.ky, line: 1642
//LISP truthy
const truthy_QMRK = function(a) {
  return (!falsy_QMRK(a));
};
////////////////////////////////////////////////////////////////////////////////
//fn: [falsy?] in file: stdlib.ky, line: 1645
//LISP falsy
const falsy_QMRK = function(a) {
  return (((a === null)) || ((a === false)));
};
////////////////////////////////////////////////////////////////////////////////
//fn: [flatten] in file: stdlib.ky, line: 1648
//Flatten an array
...
////////////////////////////////////////////////////////////////////////////////
//fn: [identity] in file: stdlib.ky, line: 1653
  ...
  return (function() {
    let bind = function(mv, mf) {
      return function(state) {
        return (function() {
          let GS__22 = mv(state);
          let value = getIndex(GS__22, 0);
          let newState = getIndex(GS__22, 1);
...
////////////////////////////////////////////////////////////////////////////////
//fn: [run-cont] in file: stdlib.ky, line: 1714
...
////////////////////////////////////////////////////////////////////////////////
//fn: [quote-str] in file: stdlib.ky, line: 1721
...
////////////////////////////////////////////////////////////////////////////////
//fn: [unquote-str] in file: stdlib.ky, line: 1738
...
////////////////////////////////////////////////////////////////////////////////
//fn: [escXml] in file: stdlib.ky, line: 1762
...
////////////////////////////////////////////////////////////////////////////////
//fn: [split-seq] in file: stdlib.ky, line: 1777
...
////////////////////////////////////////////////////////////////////////////////
//fn: [select-keys] in file: stdlib.ky, line: 1783
...
////////////////////////////////////////////////////////////////////////////////
//fn: [doUpdateIn!] in file: stdlib.ky, line: 1791
...
////////////////////////////////////////////////////////////////////////////////
//fn: [update-in!] in file: stdlib.ky, line: 1801
...
////////////////////////////////////////////////////////////////////////////////
//fn: [get-in] in file: stdlib.ky, line: 1833
...
////////////////////////////////////////////////////////////////////////////////
//fn: [merge!] in file: stdlib.ky, line: 1857
const merge_BANG = function(base, m) {
  ...
  if (object_QMRK(GS__23)) {
    let GS__25 = GS__23;
    Object.keys(GS__25).forEach(function(p) {
      return GS__24(getProp(GS__25, p), p);
    });
  } else {
...
////////////////////////////////////////////////////////////////////////////////
//fn: [mix!] in file: stdlib.ky, line: 1863
const mix_BANG = function(base, m) {
  ...
  if (object_QMRK(GS__26)) {
    let GS__28 = GS__26;
    Object.keys(GS__28).forEach(function(p) {
      return GS__27(getProp(GS__28, p), p);
    });
  } else {
...
////////////////////////////////////////////////////////////////////////////////
//fn: [merge] in file: stdlib.ky, line: 1869
...
////////////////////////////////////////////////////////////////////////////////
//fn: [mixin] in file: stdlib.ky, line: 1878
...
////////////////////////////////////////////////////////////////////////////////
//fn: [fillArray] in file: stdlib.ky, line: 1887
const fillArray = function(len, v) {
  let ret = [];
  for (let x = 0, GS__29 = len, ____break = false; ((!____break) && (x < GS__29)); x = (x + 1)) {
...
////////////////////////////////////////////////////////////////////////////////
//fn: [copyArray] in file: stdlib.ky, line: 1893
...
////////////////////////////////////////////////////////////////////////////////
//fn: [difference] in file: stdlib.ky, line: 1901
...
////////////////////////////////////////////////////////////////////////////////
//fn: [inc] in file: stdlib.ky, line: 1914
//Returns a number one greater than x.
const inc = function(x) {
  return (x + 1);
};
////////////////////////////////////////////////////////////////////////////////
//fn: [dec] in file: stdlib.ky, line: 1917
//Returns a number one lesser than x.
const dec = function(x) {
  return (x - 1);
};
////////////////////////////////////////////////////////////////////////////////
//fn: [percent] in file: stdlib.ky, line: 1920
const percent = function(numerator, denominator) {
  return (100 * (numerator / denominator));
};
////////////////////////////////////////////////////////////////////////////////
//fn: [toFixed] in file: stdlib.ky, line: 1924
...
////////////////////////////////////////////////////////////////////////////////
//fn: [mapcat] in file: stdlib.ky, line: 1929
const mapcat = function(func, coll) {
  let ret = [];
  return ret.concat.apply(ret, coll.map(func));
};
////////////////////////////////////////////////////////////////////////////////
//fn: [ensureTest] in file: stdlib.ky, line: 1938
...
////////////////////////////////////////////////////////////////////////////////
//fn: [ensureTestThrown] in file: stdlib.ky, line: 1944
...
////////////////////////////////////////////////////////////////////////////////
//fn: [runtest] in file: stdlib.ky, line: 1953
...
////////////////////////////////////////////////////////////////////////////////
//fn: [pushNSP] in file: stdlib.ky, line: 1974
...
////////////////////////////////////////////////////////////////////////////////
//fn: [popNSP] in file: stdlib.ky, line: 1980
...
////////////////////////////////////////////////////////////////////////////////
//fn: [peekNSP] in file: stdlib.ky, line: 1985
const peekNSP = function() {
  return getProp(_STAR_ns_DASH_cache_STAR.value, 0);
};
////////////////////////////////////////////////////////////////////////////////
//fn: [*ns*] in file: stdlib.ky, line: 1988
...
////////////////////////////////////////////////////////////////////////////////
//fn: [minBy] in file: stdlib.ky, line: 1991
...
////////////////////////////////////////////////////////////////////////////////
//fn: [maxBy] in file: stdlib.ky, line: 1998
...
const ____macros = {
  ...
  "values": "(macro* values (obj) (syntax-quote (Array.from (.values (unquote obj)))))",
  ...
  "let": "(macro* let (bindings & xs) (syntax-quote (do (vars (splice-unquote bindings)) (splice-unquote xs))))",
  ...
  "do-with": "(macro* do-with (bindings & xs) (let* [f (nth* bindings 0)] (syntax-quote (let [(unquote f) (unquote (nth* bindings 1))] (splice-unquote xs) (unquote f)))))",
  ...
  "dotimes": "(macro* dotimes (bindings & xs) (let* [_t (gensym*) b1 (first* bindings)] (syntax-quote (for [(unquote b1) 0 (unquote _t) (unquote (nth* bindings 1)) :while (< (unquote b1) (unquote _t)) :recur (1 (unquote b1))] (splice-unquote xs)))))",
  ...
  "if-some+": "(macro* if-some+ (bindings then else) (let* [tst (gensym*)] (syntax-quote (let [(unquote tst) (unquote (nth* bindings 1)) (unquote (first* bindings)) (unquote tst)] (if (> (n# (unquote tst)) 0) (unquote then) (unquote else))))))",
  "if-some": "(macro* if-some (bindings then else) (let* [tst (gensym*)] (syntax-quote (let [(unquote tst) (unquote (nth* bindings 1)) (unquote (first* bindings)) (unquote tst)] (if (or (undef? (unquote tst)) (nil? (unquote tst))) (unquote else) (unquote then))))))",
  "if-let": "(macro* if-let (bindings then else) (let* [tst (gensym*)] (syntax-quote (let [(unquote tst) (unquote (nth* bindings 1)) (unquote (first* bindings)) (unquote tst)] (if (unquote tst) (unquote then) (unquote else))))))",
  "when-some+": "(macro* when-some+ (bindings & xs) (let* [tst (gensym*)] (syntax-quote (let [(unquote tst) (unquote (nth* bindings 1)) (unquote (first* bindings)) (unquote tst)] (when (> (n# (unquote tst)) 0) (splice-unquote xs))))))",
  "when-some": "(macro* when-some (bindings & xs) (let* [tst (gensym*)] (syntax-quote (let [(unquote tst) (unquote (nth* bindings 1)) (unquote (first* bindings)) (unquote tst)] (when-not (or (undef? (unquote tst)) (nil? (unquote tst))) (splice-unquote xs))))))",
  "when-let": "(macro* when-let (bindings & xs) (let* [tst (gensym*)] (syntax-quote (let [(unquote tst) (unquote (nth* bindings 1)) (unquote (first* bindings)) (unquote tst)] (when (unquote tst) (splice-unquote xs))))))",
  ...
  "monad": "(macro* monad (docstring operations) (syntax-quote (do (var~ bind unit zero plus) (let [(splice-unquote operations)] (object :bind bind :unit unit :zero zero :plus plus)))))",
  ...
  "with-local-vars": "(macro* with-local-vars (bindings & more) (let* [e (count* more) b (count* bindings)] (if* (not* (is-even? b)) (throw* \"wanted even number of binding forms\") (if* (> e 0) (syntax-quote (do (vars (splice-unquote bindings)) (splice-unquote more))) (syntax-quote (vars (splice-unquote bindings)))))))"
};
module.exports = {
