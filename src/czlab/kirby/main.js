/*Auto generated by Kirby v1.0.0 - Sun Jan 21 2018 00:20:08 GMT-0800 (PST)
  czlab.kirby.main
...
const tx = require("/wdrive/mygit/kirby/src/czlab/kirby/compiler");
...
const init = function() {
  ...
  let f = function(module, fname) {
    ...
    let GS__13 = c.transpile(rt.slurp(fin), fin);
    let code = GS__13[0];
    let err = GS__13[1];
    return (err ?
      (function() {
...
const pcli = function(gopt) {
  ...
  let GS__16 = opt.options;
  let version = GS__16["version"];
  let repl = GS__16["repl"];
  let watch = GS__16["watch"];
  let help = GS__16["help"];
  if (version) {
