/*Auto generated by Kirby - v1.0.0 czlab.kirby.main Sat Oct 28 2017 20:00:41 GMT-0700 (PDT)*/
...
return (function() {
try {
return pout.write(kirby.transpile(source,process.cwd()));
...
return (function() {
try {
let G____1= opt.options;
let source_map,show_ast;
source_map=G____1["source-map"];
show_ast=G____1["show-ast"];
;
let source;
source= null;
;
