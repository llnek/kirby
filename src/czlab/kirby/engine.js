/*Auto generated by Kirby - v1.0.0 czlab.kirby.engine Sat Dec 02 2017 02:03:10 GMT-0800 (PST)*/
  ...
  return (function() {
    ...
    switch (oid) {
      ...
      case "array":
        ...
        break;
      case "object":
        S____5 = Object.entries(obj).reduce(function(acc, en) {
          acc[en[0]] = last(en);
          return acc;
        }, {});
        break;
...
////////////////////////////////////////////////////////////////////////////////
//name: [seq] in file: engine.ky near line: 158
...
////////////////////////////////////////////////////////////////////////////////
//name: [fapply] in file: engine.ky near line: 170
const fapply = function(f) {
  let xs = Array.prototype.slice.call(arguments, 1);
  return f.apply(this, xs);
};
////////////////////////////////////////////////////////////////////////////////
//name: [fmap] in file: engine.ky near line: 173
...
var GLOBAL = ((typeof (window) === "undefined") ?
  ...
  window);
////////////////////////////////////////////////////////////////////////////////
//name: [resolveJS] in file: engine.ky near line: 179
...
////////////////////////////////////////////////////////////////////////////////
//name: [filterJS] in file: engine.ky near line: 187
...
////////////////////////////////////////////////////////////////////////////////
//name: [withMeta] in file: engine.ky near line: 192
...
////////////////////////////////////////////////////////////////////////////////
//name: [meta] in file: engine.ky near line: 197
...
////////////////////////////////////////////////////////////////////////////////
//name: [evalJS] in file: engine.ky near line: 205
const evalJS = function(s) {
  return filterJS(eval(s.toString()));
};
////////////////////////////////////////////////////////////////////////////////
//name: [invokeJS] in file: engine.ky near line: 209
...
var CACHE = {};
////////////////////////////////////////////////////////////////////////////////
//name: [loadMacros] in file: engine.ky near line: 317
...
////////////////////////////////////////////////////////////////////////////////
//name: [setMacro] in file: engine.ky near line: 323
...
////////////////////////////////////////////////////////////////////////////////
//name: [getMacro] in file: engine.ky near line: 335
//Get macro
...
////////////////////////////////////////////////////////////////////////////////
//name: [wrap-str] in file: engine.ky near line: 350
const wrap_DASH_str = function(s) {
  return ["\"", s.replace(/\\/g, "\\\\").replace(/"/g, "\\\"").replace(/\n/g, "\\n"), "\""].join("");
};
////////////////////////////////////////////////////////////////////////////////
//name: [unwrap-str] in file: engine.ky near line: 356
...
////////////////////////////////////////////////////////////////////////////////
//name: [dbg] in file: engine.ky near line: 365
...
////////////////////////////////////////////////////////////////////////////////
//name: [readAST] in file: engine.ky near line: 369
//Returns the AST
...
////////////////////////////////////////////////////////////////////////////////
//name: [isList?] in file: engine.ky near line: 376
//Returns true
//if a non-empty list
...
////////////////////////////////////////////////////////////////////////////////
//name: [quasiquote] in file: engine.ky near line: 382
...
////////////////////////////////////////////////////////////////////////////////
//name: [evalAst] in file: engine.ky near line: 423
...
////////////////////////////////////////////////////////////////////////////////
//name: [handleAND] in file: engine.ky near line: 455
...
////////////////////////////////////////////////////////////////////////////////
//name: [handleOR] in file: engine.ky near line: 463
...
////////////////////////////////////////////////////////////////////////////////
//name: [handleLet] in file: engine.ky near line: 471
...
////////////////////////////////////////////////////////////////////////////////
//name: [handleMacro] in file: engine.ky near line: 481
...
////////////////////////////////////////////////////////////////////////////////
//name: [fn-wrap] in file: engine.ky near line: 527
...
////////////////////////////////////////////////////////////////////////////////
//name: [compute*] in file: engine.ky near line: 538
...
////////////////////////////////////////////////////////////////////////////////
//name: [compute] in file: engine.ky near line: 618
...
////////////////////////////////////////////////////////////////////////////////
//name: [show] in file: engine.ky near line: 624
const show = function(exp) {
  return prn(exp);
};
////////////////////////////////////////////////////////////////////////////////
//name: [newEnv] in file: engine.ky near line: 627
...
////////////////////////////////////////////////////////////////////////////////
//name: [init] in file: engine.ky near line: 686
const init = function() {
  global_env = newEnv();
...
////////////////////////////////////////////////////////////////////////////////
//name: [globalEnv] in file: engine.ky near line: 695
