/*Auto generated by Kirby - v1.0.0 czlab.kirby.bl.stdlib Thu Nov 09 2017 17:47:17 GMT-0800 (PST)*/
...
function prn(obj) {
  ...
  let _r,
    pa;
  _r = opt_QUERY__QUERY(readable_QUERY, true);
  pa = function(arr, s, e) {
...
m_DASH_state = {
  ...
  "result": function(v) {
    return function(s) {
      return vector().concat(vector(v, s));
    };
  }
};

let m_DASH_continuation;
m_DASH_continuation = {
  "bind": function(mv, mf) {
    return function(c) {
