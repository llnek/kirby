/*Auto generated by Kirby - v1.0.0 czlab.kirby.bl.stdlib Mon Nov 06 2017 23:09:17 GMT-0800 (PST)*/


//
function not_DASHempty(coll) {
return ((0 === count(coll)) ?
null :
coll);
}
...
//
function lambda_DASHarg(name) {
return new LambdaArg(name);
}

//
function lambda_DASHarg_QUERY(obj) {
...
//
function typeid(obj) {
return (lambda_DASHarg_QUERY(obj) ?
"lambda-arg" :
(keyword_QUERY(obj) ?
"keyword" :
(symbol_QUERY(obj) ?
...
lambda_DASHarg: lambda_DASHarg,
lambda_DASHarg_QUERY: lambda_DASHarg_QUERY,
Atom: Atom,
atom: atom,
