/*Auto generated by Kirby - v1.0.0 czlab.kirby.bl.parser Sat Nov 04 2017 01:35:06 GMT-0700 (PDT)*/
...
return std.vector(std.symbol("quote"),read_STAR(tokens));
});
break;
case "`":
____x= skip_PLUSparse(tokens,function () {
...
return std.vector(std.symbol("quasiquote"),read_STAR(tokens));
});
break;
case "~":
____x= skip_PLUSparse(tokens,function () {
...
return std.vector(std.symbol("unquote"),read_STAR(tokens));
});
break;
case "~@":
____x= skip_PLUSparse(tokens,function () {
...
return std.vector(std.symbol("splice-unquote"),read_STAR(tokens));
});
break;
case "^":
____x= skip_PLUSparse(tokens,function () {
tmp=read_STAR(tokens);
return std.vector(std.symbol("with-meta"),read_STAR(tokens),tmp);
});
break;
case "@":
____x= skip_PLUSparse(tokens,function () {
...
return std.vector(std.symbol("deref"),read_STAR(tokens));
});
break;
case "#":
____x= skip_PLUSparse(tokens,function () {
...
return std.vector(std.symbol("lambda"),read_STAR(tokens));
});
break;
case ")":
