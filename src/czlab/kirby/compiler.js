/*Auto generated by Kirby - v1.0.0 czlab.kirby.compiler Thu Dec 07 2017 23:37:10 GMT-0800 (PST)*/
...
////////////////////////////////////////////////////////////////////////////////
//name: [quoteMap] in file: compiler.ky near line: 322
...
////////////////////////////////////////////////////////////////////////////////
//name: [quoteBlock] in file: compiler.ky near line: 334
...
const evalMeta = function(ast, env) {
  return (Array.isArray(ast) ?
    ...
    (keyword_QUERY(ast) ?
      ...
      (symbol_QUERY(ast) ?
        JSON.parse([tx_STAR([kirbystdlibref.symbol("tag"), ast], env)].join("")) :
        (true ?
          error_BANG("invalid-meta", ast) :
          null))));
};
////////////////////////////////////////////////////////////////////////////////
//name: [maybeStripStdlib] in file: compiler.ky near line: 492
...
////////////////////////////////////////////////////////////////////////////////
//name: [assertInfo] in file: compiler.ky near line: 501
const assertInfo = function(ast) {
  return ((!(typeof (ast.line) === "number")) ?
    error_BANG("no-sourcemap-info", ast) :
    null);
};
////////////////////////////////////////////////////////////////////////////////
//name: [assertArity] in file: compiler.ky near line: 505
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-quote] in file: compiler.ky near line: 511
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-deftype] in file: compiler.ky near line: 517
//Define a JS Class
...
SPEC_DASH_OPS["deftype-"] = sf_DASH_deftype;
////////////////////////////////////////////////////////////////////////////////
//name: [sf-compOp] in file: compiler.ky near line: 559
const sf_DASH_compOp = function(ast, env) {
  if ( (!((kirbystdlibref.count(ast) >= 3) && (!(0 === kirbystdlibref.modulo(kirbystdlibref.count(ast), 2))))) ) {
    error_BANG("invalid-arity", ast);
  }
  assertInfo(ast);
  let ret = node_QTE(ast);
  ...
  for (let i = 0, op = tx_STAR(ast.shift(), env), ____break = false; ((!____break) && (i < (ast.length - 1))); i = (i + 1)) {
    ret.add(tnx(ast, [tx_STAR(ast[i], env), " ", op, " ", tx_STAR(ast[i + 1], env)]));
  }
  ret.join(" && ");
  return wrap(ret, "(", ")");
};
...
SPEC_DASH_OPS["<="] = sf_DASH_compOp;
////////////////////////////////////////////////////////////////////////////////
//name: [sf-arithOp] in file: compiler.ky near line: 577
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-do] in file: compiler.ky near line: 608
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-case] in file: compiler.ky near line: 621
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-vardefs] in file: compiler.ky near line: 658
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-var] in file: compiler.ky near line: 680
const sf_DASH_var = function(ast, env) {
  ...
  let rval,
    ...
    lhs,
    rhs;
  (ast = xfi(ast, ast.slice(1)), cmd = (cmd.startsWith("const") ?
    "const" :
    ((cmd == "var") ?
      "let" :
      "var")));
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-inst?] in file: compiler.ky near line: 719
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-delete] in file: compiler.ky near line: 728
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-new] in file: compiler.ky near line: 740
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-throw] in file: compiler.ky near line: 747
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-x-opop] in file: compiler.ky near line: 759
...
SPEC_DASH_OPS["--$"] = sf_DASH_x_DASH_opop;
////////////////////////////////////////////////////////////////////////////////
//name: [sf-x-eq] in file: compiler.ky near line: 771
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-set-in] in file: compiler.ky near line: 802
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-set] in file: compiler.ky near line: 821
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-if] in file: compiler.ky near line: 939
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-get] in file: compiler.ky near line: 959
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-array] in file: compiler.ky near line: 966
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-object] in file: compiler.ky near line: 981
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-include] in file: compiler.ky near line: 997
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-require] in file: compiler.ky near line: 1025
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-ns] in file: compiler.ky near line: 1063
const sf_DASH_ns = function(ast, env) {
  ...
  if ( ((nsp === "czlab.kirby.macros") || (nsp === "czlab.kirby.stdlib")) ) {
    ...
    if (nsp.startsWith("czlab.kirby.")) {
      conj_BANG(ret, tnx(ast, "const kirbystdlibref=std;\n"));
    } else {
      if (true) {
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-for] in file: compiler.ky near line: 1100
const sf_DASH_for = function(ast, env) {
  ...
  if ( (0 === kirbystdlibref.count(body)) ) {
    ...
    sf_DASH_floop(ret, xfi(ast, ast[1]), xfi(ast, body), env, stmtQ);
  }
  return ret;
};
SPEC_DASH_OPS["for"] = sf_DASH_for;
////////////////////////////////////////////////////////////////////////////////
//name: [sf-floop] in file: compiler.ky near line: 1112
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-jscode] in file: compiler.ky near line: 1150
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-macro] in file: compiler.ky near line: 1159
const sf_DASH_macro = function(ast, env) {
  ...
  let a2 = xfi(ast, [kirbystdlibref.symbol("fn*"), pms].concat(body));
...
SPEC_DASH_OPS["!"] = sf_DASH_unary;
////////////////////////////////////////////////////////////////////////////////
//name: [xfi] in file: compiler.ky near line: 1200
