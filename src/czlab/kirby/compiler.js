/*Auto generated by Kirby - v1.0.0 czlab.kirby.compiler Thu Dec 07 2017 17:52:56 GMT-0800 (PST)*/
...
////////////////////////////////////////////////////////////////////////////////
//name: [tnx] in file: compiler.ky near line: 74
const tnx = function(from, x) {
  return tnode(from.source, from.line, from.column, x, x);
};
////////////////////////////////////////////////////////////////////////////////
//name: [doFuncArgs] in file: compiler.ky near line: 78
...
////////////////////////////////////////////////////////////////////////////////
//name: [destruct*] in file: compiler.ky near line: 122
...
////////////////////////////////////////////////////////////////////////////////
//name: [destructVec] in file: compiler.ky near line: 141
...
////////////////////////////////////////////////////////////////////////////////
//name: [destructMap] in file: compiler.ky near line: 182
...
////////////////////////////////////////////////////////////////////////////////
//name: [simple?] in file: compiler.ky near line: 208
...
////////////////////////////////////////////////////////////////////////////////
//name: [wrap] in file: compiler.ky near line: 212
...
////////////////////////////////////////////////////////////////////////////////
//name: [exprHint] in file: compiler.ky near line: 218
...
////////////////////////////////////////////////////////////////////////////////
//name: [stmt?] in file: compiler.ky near line: 222
...
////////////////////////////////////////////////////////////////////////////////
//name: [error!] in file: compiler.ky near line: 226
...
////////////////////////////////////////////////////////////////////////////////
//name: [testre?] in file: compiler.ky near line: 233
...
////////////////////////////////////////////////////////////////////////////////
//name: [pad] in file: compiler.ky near line: 236
const pad = function(n) {
  return " ".repeat(n);
};
////////////////////////////////////////////////////////////////////////////////
//name: [node'] in file: compiler.ky near line: 239
...
////////////////////////////////////////////////////////////////////////////////
//name: [txTree] in file: compiler.ky near line: 246
...
////////////////////////////////////////////////////////////////////////////////
//name: [txForm] in file: compiler.ky near line: 253
...
////////////////////////////////////////////////////////////////////////////////
//name: [txAtom] in file: compiler.ky near line: 259
...
////////////////////////////////////////////////////////////////////////////////
//name: [tx*] in file: compiler.ky near line: 277
...
////////////////////////////////////////////////////////////////////////////////
//name: [gcmd] in file: compiler.ky near line: 280
...
////////////////////////////////////////////////////////////////////////////////
//name: [quoteSingle] in file: compiler.ky near line: 288
...
////////////////////////////////////////////////////////////////////////////////
//name: [quoteMap] in file: compiler.ky near line: 309
...
////////////////////////////////////////////////////////////////////////////////
//name: [quoteBlock] in file: compiler.ky near line: 321
...
////////////////////////////////////////////////////////////////////////////////
//name: [txPairs] in file: compiler.ky near line: 330
...
////////////////////////////////////////////////////////////////////////////////
//name: [writeDoc] in file: compiler.ky near line: 389
//Convert to jsdoc
...
////////////////////////////////////////////////////////////////////////////////
//name: [txDo] in file: compiler.ky near line: 399
...
////////////////////////////////////////////////////////////////////////////////
//name: [meta??] in file: compiler.ky near line: 417
...
////////////////////////////////////////////////////////////////////////////////
//name: [fmtRegoSpecOps] in file: compiler.ky near line: 429
const fmtRegoSpecOps = function(alias, fname) {
  return [parser.jsid("SPEC-OPS"), "[\"", alias, "\"] = ", fname].join("");
};
////////////////////////////////////////////////////////////////////////////////
//name: [fmtSpecOps] in file: compiler.ky near line: 433
...
////////////////////////////////////////////////////////////////////////////////
//name: [writeFuncInfo] in file: compiler.ky near line: 440
...
var icache = [];
////////////////////////////////////////////////////////////////////////////////
//name: [includeFile] in file: compiler.ky near line: 455
...
////////////////////////////////////////////////////////////////////////////////
//name: [evalMeta] in file: compiler.ky near line: 463
...
////////////////////////////////////////////////////////////////////////////////
//name: [maybeStripStdlib] in file: compiler.ky near line: 479
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-quote] in file: compiler.ky near line: 489
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-deftype] in file: compiler.ky near line: 495
//Define a JS Class
const sf_DASH_deftype = function(ast, env) {
  ...
  let czargs = ast[3];
  let ret = node_QTE(ast);
  let G____12 = ((typeof (ast[4]) === "string") ?
  ...
  for (let i = 0, pos = 0, sz = kirbystdlibref.count(mtds), ____break = false; ((!____break) && (i < sz)); i = (i + 1)) {
    ...
    m.unshift(kirbystdlibref.symbol("method"));
...
SPEC_DASH_OPS["deftype-"] = sf_DASH_deftype;
////////////////////////////////////////////////////////////////////////////////
//name: [sf-compOp] in file: compiler.ky near line: 536
...
SPEC_DASH_OPS["<="] = sf_DASH_compOp;
////////////////////////////////////////////////////////////////////////////////
//name: [sf-arithOp] in file: compiler.ky near line: 553
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-do] in file: compiler.ky near line: 583
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-case] in file: compiler.ky near line: 595
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-vardefs] in file: compiler.ky near line: 631
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-var] in file: compiler.ky near line: 652
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-inst?] in file: compiler.ky near line: 690
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-delete] in file: compiler.ky near line: 698
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-new] in file: compiler.ky near line: 709
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-throw] in file: compiler.ky near line: 715
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-x-opop] in file: compiler.ky near line: 726
...
SPEC_DASH_OPS["--$"] = sf_DASH_x_DASH_opop;
////////////////////////////////////////////////////////////////////////////////
//name: [sf-x-eq] in file: compiler.ky near line: 737
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-set-in] in file: compiler.ky near line: 767
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-set] in file: compiler.ky near line: 785
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-fn] in file: compiler.ky near line: 801
//(fn [x y] ...)
const sf_DASH_fn = function(ast, env) {
  let ret = node_QTE(ast);
  let fargs = null;
  let body = Array.prototype.slice.call(ast, 2);
  let G____13 = meta_QUERY__QUERY(ast[1], env);
  let args = G____13[1];
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-func] in file: compiler.ky near line: 817
const sf_DASH_func = function(ast, env) {
  ...
  let fargs = null;
  let ret = node_QTE(ast);
  let G____14 = ((typeof (ast[2]) === "string") ?
    [ast[2], 3] :
    [null, 2]);
  let doc = G____14[0];
  let pargs = G____14[1];
  let body = Array.prototype.slice.call(ast, (pargs + 1));
  let G____15 = meta_QUERY__QUERY(ast[pargs], env);
  let hints = G____15[0];
  let args = G____15[1];
  if ( (!Array.isArray(args)) ) {
    error_BANG("invalid-fargs", ast);
...
SPEC_DASH_OPS["defn-"] = sf_DASH_func;
////////////////////////////////////////////////////////////////////////////////
//name: [sf-try] in file: compiler.ky near line: 858
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-if] in file: compiler.ky near line: 899
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-get] in file: compiler.ky near line: 918
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-array] in file: compiler.ky near line: 924
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-object] in file: compiler.ky near line: 938
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-include] in file: compiler.ky near line: 953
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-require] in file: compiler.ky near line: 980
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-ns] in file: compiler.ky near line: 1017
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-comment] in file: compiler.ky near line: 1048
const sf_DASH_comment = function(ast, env) {
  return node_QTE(ast);
};
SPEC_DASH_OPS["comment"] = sf_DASH_comment;
////////////////////////////////////////////////////////////////////////////////
//name: [sf-for] in file: compiler.ky near line: 1051
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-floop] in file: compiler.ky near line: 1062
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-jscode] in file: compiler.ky near line: 1100
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-macro] in file: compiler.ky near line: 1108
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-unary] in file: compiler.ky near line: 1139
...
SPEC_DASH_OPS["!"] = sf_DASH_unary;
////////////////////////////////////////////////////////////////////////////////
//name: [xfi] in file: compiler.ky near line: 1147
const xfi = function(from, to) {
  (to["source"] = from.source, to["line"] = from.line, to["column"] = from.column);
  return to;
};
////////////////////////////////////////////////////////////////////////////////
//name: [spitExterns] in file: compiler.ky near line: 1154
...
////////////////////////////////////////////////////////////////////////////////
//name: [banner] in file: compiler.ky near line: 1161
const banner = function() {
  return ["/*", "Auto generated by Kirby - v", MODULE_DASH_VERSION, " ", eng.globalEnv().firstNSP(), " - ", new Date(), "*/\n\n"].join("");
};
////////////////////////////////////////////////////////////////////////////////
//name: [cleanCode] in file: compiler.ky near line: 1167
...
////////////////////////////////////////////////////////////////////////////////
//name: [transpile*] in file: compiler.ky near line: 1176
const transpile_STAR = function(source, fname, options) {
  ...
  let G____18 = options;
  let source_DASH_map = G____18["source-map"];
  let format = G____18["format"];
...
////////////////////////////////////////////////////////////////////////////////
//name: [transpile] in file: compiler.ky near line: 1204
...
////////////////////////////////////////////////////////////////////////////////
//name: [dbgAST] in file: compiler.ky near line: 1211
