/*Auto generated by Kirby v1.0.0 - Wed Mar 28 2018 20:18:16 GMT-0700 (PDT)
...
////////////////////////////////////////////////////////////////////////////////
//fn: [exprHint] in file: compiler.ky, line: 196
...
////////////////////////////////////////////////////////////////////////////////
//fn: [stmt?] in file: compiler.ky, line: 202
...
////////////////////////////////////////////////////////////////////////////////
//fn: [error!] in file: compiler.ky, line: 206
...
////////////////////////////////////////////////////////////////////////////////
//fn: [testre?] in file: compiler.ky, line: 213
//Test a regex
...
////////////////////////////////////////////////////////////////////////////////
//fn: [fn??] in file: compiler.ky, line: 214
...
////////////////////////////////////////////////////////////////////////////////
//fn: [pad] in file: compiler.ky, line: 218
const pad = function(n) {
  return " ".repeat(n);
};
////////////////////////////////////////////////////////////////////////////////
//fn: [node'] in file: compiler.ky, line: 221
...
////////////////////////////////////////////////////////////////////////////////
//fn: [txTree] in file: compiler.ky, line: 226
...
////////////////////////////////////////////////////////////////////////////////
//fn: [txForm] in file: compiler.ky, line: 245
...
////////////////////////////////////////////////////////////////////////////////
//fn: [txAtom] in file: compiler.ky, line: 250
...
////////////////////////////////////////////////////////////////////////////////
//fn: [quote!] in file: compiler.ky, line: 297
...
////////////////////////////////////////////////////////////////////////////////
//fn: [quoteMap] in file: compiler.ky, line: 304
...
////////////////////////////////////////////////////////////////////////////////
//fn: [quoteBlock] in file: compiler.ky, line: 315
...
////////////////////////////////////////////////////////////////////////////////
//fn: [spreadInfo] in file: compiler.ky, line: 322
...
////////////////////////////////////////////////////////////////////////////////
//fn: [txPairs] in file: compiler.ky, line: 331
...
////////////////////////////////////////////////////////////////////////////////
//fn: [writeDoc] in file: compiler.ky, line: 384
//Convert to jsdoc
...
////////////////////////////////////////////////////////////////////////////////
//fn: [txDo] in file: compiler.ky, line: 391
//A Do block
...
////////////////////////////////////////////////////////////////////////////////
//fn: [fmtSpecOps] in file: compiler.ky, line: 420
...
////////////////////////////////////////////////////////////////////////////////
//fn: [writeFuncPre] in file: compiler.ky, line: 428
...
////////////////////////////////////////////////////////////////////////////////
//fn: [writeFuncInfo] in file: compiler.ky, line: 436
...
////////////////////////////////////////////////////////////////////////////////
//fn: [evalMeta] in file: compiler.ky, line: 448
...
////////////////////////////////////////////////////////////////////////////////
//fn: [slib!] in file: compiler.ky, line: 459
...
////////////////////////////////////////////////////////////////////////////////
//fn: [assertArity] in file: compiler.ky, line: 467
...
////////////////////////////////////////////////////////////////////////////////
//fn: [assertInfo] in file: compiler.ky, line: 471
...
////////////////////////////////////////////////////////////////////////////////
//fn: [loadRLib] in file: compiler.ky, line: 479
...
////////////////////////////////////////////////////////////////////////////////
//fn: [isPub?] in file: compiler.ky, line: 491
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-juxt] in file: compiler.ky, line: 497
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-deref] in file: compiler.ky, line: 517
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-compose] in file: compiler.ky, line: 527
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-quote] in file: compiler.ky, line: 556
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-deftype] in file: compiler.ky, line: 563
//Define a Class
const sf_DASH_deftype = function(ast, env) {
  ...
  rt.addVar(czn, (new Map([["ns", std._STAR_ns_STAR()], ["type", "class"]])));
  ...
  for (let GS__42 = 0, GS__40 = true, GS__41 = mtds, ____sz = kirbystdlibref.count(GS__41), ____break = false; (!____break && GS__40 && (GS__42 < ____sz)); ++GS__42) {
    ...
    xfi(m1, mtd);
    cons_BANG(mtd, m);
    rt.addVar([czn, ".", m1].join(""), (new Map([["ns", std._STAR_ns_STAR()], ["type", "method"]])));
...
SPEC_DASH_OPS["deftype-"] = sf_DASH_deftype;
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-compOp] in file: compiler.ky, line: 594
...
SPEC_DASH_OPS["="] = sf_DASH_compOp;
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-arithOp] in file: compiler.ky, line: 613
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-do] in file: compiler.ky, line: 656
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-case] in file: compiler.ky, line: 674
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-var] in file: compiler.ky, line: 712
...
const sf_DASH_var = function(ast, env) {
  ...
  for (let ____coll = ast, i = 1, ____end = kirbystdlibref.count(____coll), ____break = false; ((!____break) && (i < ____end)); i = (i + 2)) {
    ...
    if (symbol_QMRK(lhs)) {
      ...
      if ( (!("let" == cmd)) ) {
        rt.addVar([x].join(""), (new Map([["ns", std._STAR_ns_STAR()], ["type", "var"]])));
      } else {
        null;
      }
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-inst?] in file: compiler.ky, line: 743
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-delete] in file: compiler.ky, line: 756
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-dissoc!] in file: compiler.ky, line: 770
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-new] in file: compiler.ky, line: 783
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-throw] in file: compiler.ky, line: 797
//Throw an exception
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-x-opop] in file: compiler.ky, line: 811
...
SPEC_DASH_OPS["--$"] = sf_DASH_x_DASH_opop;
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-x-eq] in file: compiler.ky, line: 824
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-assoc!] in file: compiler.ky, line: 857
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-assign!] in file: compiler.ky, line: 873
//Object property assignment or array index setter.
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-set] in file: compiler.ky, line: 887
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-fn] in file: compiler.ky, line: 903
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-func] in file: compiler.ky, line: 923
...
const sf_DASH_func = function(ast, env) {
  ...
  if ( (!mtd_QMRK) ) {
    rt.addVar(fname0, (new Map([["ns", std._STAR_ns_STAR()], ["type", "fn"]])));
  } else {
    null;
  }
  if ( (!(Array.isArray(args))) ) {
...
SPEC_DASH_OPS["defn-"] = sf_DASH_func;
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-try] in file: compiler.ky, line: 980
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-if] in file: compiler.ky, line: 1035
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-get] in file: compiler.ky, line: 1065
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-array] in file: compiler.ky, line: 1089
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-objObj] in file: compiler.ky, line: 1113
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-mapObj] in file: compiler.ky, line: 1129
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-setObj] in file: compiler.ky, line: 1143
//Returns a new Set.
//(set 1 2 3)
...
////////////////////////////////////////////////////////////////////////////////
//fn: [require!] in file: compiler.ky, line: 1160
const require_BANG = function(path) {
  return require(path);
};
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-require2] in file: compiler.ky, line: 1165
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-require] in file: compiler.ky, line: 1227
//Loads libs.
...
const sf_DASH_require = function(ast, env) {
  ...
  for (let GS__53 = 0, GS__51 = true, GS__52 = ast.slice(1), ____sz = kirbystdlibref.count(GS__52), ____break = false; (!____break && GS__51 && (GS__53 < ____sz)); ++GS__53) {
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-ns] in file: compiler.ky, line: 1247
...
const sf_DASH_ns = function(ast, env) {
  ...
  let mobj = null;
  let pos = 2;
  let GS__54 = meta_QMRK__QMRK(ast[1], env);
  let attrs = kirbystdlibref.getIndex(GS__54, 0);
  let nsp = kirbystdlibref.getIndex(GS__54, 1);
  if ( (!symbol_QMRK(nsp)) ) {
  ...
  for (let GS__57 = 0, GS__55 = true, GS__56 = ast, ____sz = kirbystdlibref.count(GS__56), ____break = false; (!____break && GS__55 && (GS__57 < ____sz)); ++GS__57) {
    let e = GS__56[GS__57];
    if (pairs_QMRK(e)) {
      if ( ([e[0]].join("") == "require") ) {
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-comment] in file: compiler.ky, line: 1299
const sf_DASH_comment = function(ast, env) {
  return "";
};
SPEC_DASH_OPS["comment"] = sf_DASH_comment;
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-while] in file: compiler.ky, line: 1302
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-wloop] in file: compiler.ky, line: 1319
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-forxxx] in file: compiler.ky, line: 1334
//Generates native (js) for loop.
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-foop] in file: compiler.ky, line: 1350
//For loop implementation
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-jscode] in file: compiler.ky, line: 1421
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-macro] in file: compiler.ky, line: 1438
  ...
  for (let ____coll = args, i = 0, ____end = kirbystdlibref.count(____coll), ____break = false; ((!____break) && (i < ____end)); i = (i + 1)) {
    ...
    if ( (ev == "&") ) {
      if ( (Array.isArray(args[(i + 1)])) ) {
        ...
        e = args[(i + 1)]);
        ++i;
        for (let GS__60 = 0, GS__58 = true, GS__59 = e, ____sz = kirbystdlibref.count(GS__59), ____break = false; (!____break && GS__58 && (GS__60 < ____sz)); ++GS__60) {
          let x = GS__59[GS__60];
          if ( (!symbol_QMRK(x)) ) {
            error_BANG("syntax-error", ast);
          } else {
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-unary] in file: compiler.ky, line: 1489
//Special unary operators.
const sf_DASH_unary = function(ast, env) {
  assertArity((kirbystdlibref.count(ast) === 2), ast);
  let GS__61 = ast;
  let a0 = kirbystdlibref.getIndex(GS__61, 0);
  let a1 = kirbystdlibref.getIndex(GS__61, 1);
  let ret = node_QUOT(ast);
  if ( (a0 == "not") ) {
    (
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-listc] in file: compiler.ky, line: 1502
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-doseq] in file: compiler.ky, line: 1525
//Repeatedly executes body (presumably for side-effects) with
//bindings and filtering as provided by "for".  Does not retain
//the head of the sequence. Returns nil.
const sf_DASH_doseq = function(ast, env) {
  let GS__62 = Array.prototype.slice.call(arguments, 2);
  let capRes = kirbystdlibref.getIndex(GS__62, 0);
  let body = exprHint(xfi(ast, Array.prototype.slice.call(ast, 2)), false);
  ...
  let GS__63 = split_DASH_with(function() {
    let ____args = Array.prototype.slice.call(arguments);
    return (!keyword_QMRK(____args[0]));
  }, args);
  let x = kirbystdlibref.getIndex(GS__63, 0);
  let y = kirbystdlibref.getIndex(GS__63, 1);
...
////////////////////////////////////////////////////////////////////////////////
//fn: [doseq-binds] in file: compiler.ky, line: 1578
const doseq_DASH_binds = function(while_QUOT, ret, y, body, ast, env, capRes) {
  let patch = node_QUOT(ast);
  partition(2, y).forEach(function(GS__64) {
    let k = kirbystdlibref.getIndex(GS__64, 0);
    let expr = kirbystdlibref.getIndex(GS__64, 1);
    return ((k == "let") ?
...
////////////////////////////////////////////////////////////////////////////////
//fn: [getPrePost] in file: compiler.ky, line: 1602
...
////////////////////////////////////////////////////////////////////////////////
//fn: [xfi] in file: compiler.ky, line: 1615
...
////////////////////////////////////////////////////////////////////////////////
//fn: [spitMacros] in file: compiler.ky, line: 1629
const spitMacros = function() {
  return ((0 === kirbystdlibref.count(_STAR_macros_STAR)) ?
    "{}" :
    std.wrap_DASH_str((seq(_STAR_macros_STAR) || []).map(function(GS__65) {
      let k = kirbystdlibref.getIndex(GS__65, 0);
      let v = kirbystdlibref.getIndex(GS__65, 1);
      return [quote_DASH_str([k].join("")), ":", quote_DASH_str(v)].join("");
    }).join(",\n"), "{\n", "}\n"));
};
////////////////////////////////////////////////////////////////////////////////
//fn: [spitVars] in file: compiler.ky, line: 1639
...
////////////////////////////////////////////////////////////////////////////////
//fn: [spitExterns] in file: compiler.ky, line: 1647
...
const spitExterns = function() {
  ...
  if (not_DASH_empty(_STAR_externs_STAR)) {
    (
    s2 = [",\n", (seq(_STAR_externs_STAR) || []).map(function(GS__66) {
      let k = kirbystdlibref.getIndex(GS__66, 0);
      let v = kirbystdlibref.getIndex(GS__66, 1);
      return [k, ":", v].join("");
    }).join(",\n")].join(""));
  }
  return ["\n\nmodule.exports = {\n", s1, s2, "\n};\n"].join("");
...
////////////////////////////////////////////////////////////////////////////////
//fn: [banner] in file: compiler.ky, line: 1665
//Banner text for the target file
const banner = function() {
  let GS__67 = std.peekNSP();
  let id = kirbystdlibref.getProp(GS__67, "id");
  let meta = kirbystdlibref.getProp(GS__67, "meta");
  return ["/*", "Auto generated by Kirby v", MOD_DASH_VER, " - ", new Date(), "\n", "  ", id, "\n", (meta ?
    std.prn(meta, true) :
    ""), "\n", "*/\n\n"].join("");
};
////////////////////////////////////////////////////////////////////////////////
//fn: [cleanCode] in file: compiler.ky, line: 1673
...
////////////////////////////////////////////////////////////////////////////////
//fn: [transpile*] in file: compiler.ky, line: 1681
...
const transpile_STAR = function(source, fname, options) {
  let GS__68 = options;
  let source_DASH_map = kirbystdlibref.getProp(GS__68, "source-map");
  let no_DASH_format = kirbystdlibref.getProp(GS__68, "no-format");
  let verbose = kirbystdlibref.getProp(GS__68, "verbose");
...
////////////////////////////////////////////////////////////////////////////////
//fn: [dbgAST] in file: compiler.ky, line: 1739
//Dump AST to xml
