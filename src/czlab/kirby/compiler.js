/*Auto generated by Kirby v1.0.0 - Thu Mar 08 2018 11:31:37 GMT-0800 (PST)
...
////////////////////////////////////////////////////////////////////////////////
//fn: [destructMap] in file: compiler.ky, line: 193
...
////////////////////////////////////////////////////////////////////////////////
//fn: [simple?] in file: compiler.ky, line: 222
...
////////////////////////////////////////////////////////////////////////////////
//fn: [wrap] in file: compiler.ky, line: 226
...
////////////////////////////////////////////////////////////////////////////////
//fn: [exprHint] in file: compiler.ky, line: 231
...
////////////////////////////////////////////////////////////////////////////////
//fn: [stmt?] in file: compiler.ky, line: 237
...
////////////////////////////////////////////////////////////////////////////////
//fn: [error!] in file: compiler.ky, line: 241
...
////////////////////////////////////////////////////////////////////////////////
//fn: [testre?] in file: compiler.ky, line: 248
...
////////////////////////////////////////////////////////////////////////////////
//fn: [pad] in file: compiler.ky, line: 251
const pad = function(n) {
  return " ".repeat(n);
};
////////////////////////////////////////////////////////////////////////////////
//fn: [node'] in file: compiler.ky, line: 254
...
////////////////////////////////////////////////////////////////////////////////
//fn: [txTree] in file: compiler.ky, line: 262
...
////////////////////////////////////////////////////////////////////////////////
//fn: [txForm] in file: compiler.ky, line: 287
...
////////////////////////////////////////////////////////////////////////////////
//fn: [txAtom] in file: compiler.ky, line: 293
...
////////////////////////////////////////////////////////////////////////////////
//fn: [tx*] in file: compiler.ky, line: 315
...
////////////////////////////////////////////////////////////////////////////////
//fn: [gcmd] in file: compiler.ky, line: 319
...
////////////////////////////////////////////////////////////////////////////////
//fn: [quoteSingle] in file: compiler.ky, line: 329
...
////////////////////////////////////////////////////////////////////////////////
//fn: [quote!] in file: compiler.ky, line: 346
...
////////////////////////////////////////////////////////////////////////////////
//fn: [quoteMap] in file: compiler.ky, line: 355
...
////////////////////////////////////////////////////////////////////////////////
//fn: [quoteBlock] in file: compiler.ky, line: 368
...
////////////////////////////////////////////////////////////////////////////////
//fn: [spreadInfo] in file: compiler.ky, line: 377
...
////////////////////////////////////////////////////////////////////////////////
//fn: [txPairs] in file: compiler.ky, line: 389
...
////////////////////////////////////////////////////////////////////////////////
//fn: [writeDoc] in file: compiler.ky, line: 458
//Convert to jsdoc
...
////////////////////////////////////////////////////////////////////////////////
//fn: [txDo] in file: compiler.ky, line: 467
...
////////////////////////////////////////////////////////////////////////////////
//fn: [meta??] in file: compiler.ky, line: 485
...
////////////////////////////////////////////////////////////////////////////////
//fn: [fmtRegoSpecOps] in file: compiler.ky, line: 497
const fmtRegoSpecOps = function(alias, fname) {
  return [reader.jsid("SPEC-OPS"), "[\"", alias, "\"] = ", fname].join("");
};
////////////////////////////////////////////////////////////////////////////////
//fn: [fmtSpecOps] in file: compiler.ky, line: 501
...
////////////////////////////////////////////////////////////////////////////////
//fn: [writeFuncPre] in file: compiler.ky, line: 508
...
////////////////////////////////////////////////////////////////////////////////
//fn: [writeFuncInfo] in file: compiler.ky, line: 515
...
////////////////////////////////////////////////////////////////////////////////
//fn: [evalMeta] in file: compiler.ky, line: 526
...
////////////////////////////////////////////////////////////////////////////////
//fn: [stripStd] in file: compiler.ky, line: 541
...
////////////////////////////////////////////////////////////////////////////////
//fn: [assertArity] in file: compiler.ky, line: 549
...
////////////////////////////////////////////////////////////////////////////////
//fn: [assertInfo] in file: compiler.ky, line: 554
...
////////////////////////////////////////////////////////////////////////////////
//fn: [loadRLib] in file: compiler.ky, line: 562
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-juxt] in file: compiler.ky, line: 576
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-deref] in file: compiler.ky, line: 598
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-compose] in file: compiler.ky, line: 609
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-quote] in file: compiler.ky, line: 637
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-deftype] in file: compiler.ky, line: 645
//Define a JS Class
const sf_DASH_deftype = function(ast, env) {
  ...
  for (let GS__26 = 0, GS__25 = false, ____break = false; ((!____break) && ((!GS__25) && (GS__26 < GS__24.length))); GS__26 = (GS__26 + 1)) {
    let m = kirbystdlibref.getProp(GS__24, GS__26);
    null;
    if ( (!true) ) {
      (
      GS__25 = true);
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-do] in file: compiler.ky, line: 759
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-case] in file: compiler.ky, line: 777
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-vardefs] in file: compiler.ky, line: 826
...
const sf_DASH_vardefs = function(ast, env) {
  ...
  for (let i = 1, x = null, s = null, sz = kirbystdlibref.count(ast), ____break = false; ((!____break) && (i < sz)); i = (i + 1)) {
    ...
    (kirbystdlibref.assoc_BANG(keys, s, s));
    if ( (i > 1) ) {
      ret.add(",");
    }
    ret.add(s);
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-var] in file: compiler.ky, line: 853
...
const sf_DASH_var = function(ast, env) {
  ...
  if (pub_QMRK) {
    ...
    if (kirbystdlibref.object_QMRK(GS__31)) {
      let GS__33 = GS__31;
      Object.keys(GS__33).forEach(function(p) {
        return GS__32(kirbystdlibref.getProp(GS__33, p), p);
      });
    } else {
...
SPEC_DASH_OPS["local-vars"] = sf_DASH_var;
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-inst?] in file: compiler.ky, line: 894
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-delete] in file: compiler.ky, line: 907
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-dissoc!] in file: compiler.ky, line: 922
//Remove a key from Map.
const sf_DASH_dissoc_BANG = function(ast, env) {
  assertArity((kirbystdlibref.count(ast) === 3), ast);
  let ret = node_QUOT(ast);
  ret.add([stripStd([KBSTDLR, ".", tx_STAR(symbol("dissoc!"), env)].join("")), "(", tx_STAR(kirbystdlibref.getProp(ast, 1), env), ",", tx_STAR(ast[2], env), ")"]);
  return ret;
};
SPEC_DASH_OPS["dissoc!"] = sf_DASH_dissoc_BANG;
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-new] in file: compiler.ky, line: 938
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-throw] in file: compiler.ky, line: 952
//Throw an exception
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-x-opop] in file: compiler.ky, line: 968
...
SPEC_DASH_OPS["--$"] = sf_DASH_x_DASH_opop;
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-x-eq] in file: compiler.ky, line: 982
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-assoc!] in file: compiler.ky, line: 1014
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-assign!] in file: compiler.ky, line: 1031
//Object property assignment or array index setter.
...
SPEC_DASH_OPS["assign!"] = sf_DASH_assign_BANG;
SPEC_DASH_OPS["aset"] = sf_DASH_assign_BANG;
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-set] in file: compiler.ky, line: 1046
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-fn] in file: compiler.ky, line: 1063
//Defines an anonymous function. See defn.
//(fn attrs? [x y] ...)
const sf_DASH_fn = function(ast, env) {
  assertArity((kirbystdlibref.count(ast) >= 2), ast);
  let body = xfi(ast, Array.prototype.slice.call(ast, 2));
  let GS__35 = meta_QMRK__QMRK(kirbystdlibref.getProp(ast, 1), env);
  let args = kirbystdlibref.getIndex(GS__35, 1);
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-func] in file: compiler.ky, line: 1082
...
const sf_DASH_func = function(ast, env) {
  ...
  let GS__36 = (((typeof (kirbystdlibref.getProp(ast, 2)) === "string")) ?
    [kirbystdlibref.getProp(ast, 2), 3] :
    [null, 2]);
  let doc = kirbystdlibref.getIndex(GS__36, 0);
  let pargs = kirbystdlibref.getIndex(GS__36, 1);
  let body = xfi(ast, Array.prototype.slice.call(ast, (pargs + 1)));
  let b1 = kirbystdlibref.getProp(body, 0);
  let GS__37 = meta_QMRK__QMRK(kirbystdlibref.getProp(ast, pargs), env);
  let attrs = kirbystdlibref.getIndex(GS__37, 0);
  let args = kirbystdlibref.getIndex(GS__37, 1);
  if ( (!mtd_QMRK) ) {
...
SPEC_DASH_OPS["defn-"] = sf_DASH_func;
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-try] in file: compiler.ky, line: 1144
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-if] in file: compiler.ky, line: 1201
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-get] in file: compiler.ky, line: 1230
...
const sf_DASH_get = function(ast, env) {
  ...
  return ((a0 == "get") ?
    wrap(node_QUOT(ast), null, [cmd, "(", tx_STAR(xfi(ast, kirbystdlibref.getProp(ast, 1)), env), ",", tx_STAR(xfi(ast, kirbystdlibref.getProp(ast, 2)), env), ")"]) :
    wrap(node_QUOT(ast), null, [tx_STAR(xfi(ast, kirbystdlibref.getProp(ast, 1)), env), "[", tx_STAR(xfi(ast, kirbystdlibref.getProp(ast, 2)), env), "]"]));
};
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-array] in file: compiler.ky, line: 1254
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-objObj] in file: compiler.ky, line: 1279
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-mapObj] in file: compiler.ky, line: 1296
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-setObj] in file: compiler.ky, line: 1311
//Returns a new Set.
//(set 1 2 3)
...
////////////////////////////////////////////////////////////////////////////////
//fn: [require!] in file: compiler.ky, line: 1329
const require_BANG = function(path) {
  return require(path);
};
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-require] in file: compiler.ky, line: 1334
//Loads libs.
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-ns] in file: compiler.ky, line: 1425
...
const sf_DASH_ns = function(ast, env) {
  ...
  let mobj = null;
  let pos = 2;
  let GS__38 = meta_QMRK__QMRK(kirbystdlibref.getProp(ast, 1), env);
  let attrs = kirbystdlibref.getIndex(GS__38, 0);
  let nsp = kirbystdlibref.getIndex(GS__38, 1);
  if ( (!symbol_QMRK(nsp)) ) {
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-comment] in file: compiler.ky, line: 1479
const sf_DASH_comment = function(ast, env) {
  return "";
};
SPEC_DASH_OPS["comment"] = sf_DASH_comment;
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-for] in file: compiler.ky, line: 1482
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-floop] in file: compiler.ky, line: 1501
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-jscode] in file: compiler.ky, line: 1543
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-macro] in file: compiler.ky, line: 1560
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-unary] in file: compiler.ky, line: 1612
//Special unary operators.
const sf_DASH_unary = function(ast, env) {
  assertArity((kirbystdlibref.count(ast) === 2), ast);
  let GS__39 = ast;
  let a0 = kirbystdlibref.getIndex(GS__39, 0);
  let a1 = kirbystdlibref.getIndex(GS__39, 1);
  let ret = node_QUOT(ast);
  if ( (a0 == "not") ) {
    (
...
////////////////////////////////////////////////////////////////////////////////
//fn: [getPrePost] in file: compiler.ky, line: 1625
...
////////////////////////////////////////////////////////////////////////////////
//fn: [xfi] in file: compiler.ky, line: 1641
...
////////////////////////////////////////////////////////////////////////////////
//fn: [spitMacros] in file: compiler.ky, line: 1655
const spitMacros = function() {
  return ((0 === kirbystdlibref.count(_STAR_macros_STAR)) ?
    "" :
    std.wrap_DASH_str(seq(_STAR_macros_STAR).map(function(GS__40) {
      let k = kirbystdlibref.getIndex(GS__40, 0);
      let v = kirbystdlibref.getIndex(GS__40, 1);
      return [quote_DASH_str([k].join("")), ":", quote_DASH_str(v)].join("");
    }).join(",\n"), "const ____macros = {\n", "};\n"));
};
////////////////////////////////////////////////////////////////////////////////
//fn: [spitExterns] in file: compiler.ky, line: 1665
...
const spitExterns = function() {
  ...
  if (not_DASH_empty(_STAR_externs_STAR)) {
    (
    s2 = [",\n", seq(_STAR_externs_STAR).map(function(GS__41) {
      let k = kirbystdlibref.getIndex(GS__41, 0);
      let v = kirbystdlibref.getIndex(GS__41, 1);
      return [k, ":", v].join("");
    }).join(",\n")].join(""));
  }
  return ["\n\nmodule.exports = {\n", s1, s2, "\n};\n"].join("");
...
////////////////////////////////////////////////////////////////////////////////
//fn: [banner] in file: compiler.ky, line: 1681
//Banner text for the target file
const banner = function() {
  let GS__42 = std.peekNSP();
  let id = kirbystdlibref.getProp(GS__42, "id");
  let meta = kirbystdlibref.getProp(GS__42, "meta");
  return ["/*", "Auto generated by Kirby v", MOD_DASH_VER, " - ", new Date(), "\n", "  ", id, "\n", (meta ?
    std.prn(meta, true) :
    ""), "\n", "*/\n\n"].join("");
};
////////////////////////////////////////////////////////////////////////////////
//fn: [cleanCode] in file: compiler.ky, line: 1689
const cleanCode = function(code) {
  let tmp = null;
  let arr = [];
  let GS__43 = code.split("\n");
  for (let GS__45 = 0, GS__44 = false, ____break = false; ((!____break) && ((!GS__44) && (GS__45 < GS__43.length))); GS__45 = (GS__45 + 1)) {
    let s = kirbystdlibref.getProp(GS__43, GS__45);
    let tmp = s.trim();
    if ( (!true) ) {
      (
      GS__44 = true);
...
////////////////////////////////////////////////////////////////////////////////
//fn: [transpile*] in file: compiler.ky, line: 1698
...
const transpile_STAR = function(source, fname, options) {
  let GS__46 = options;
  let source_DASH_map = kirbystdlibref.getProp(GS__46, "source-map");
  let no_DASH_format = kirbystdlibref.getProp(GS__46, "no-format");
  let verbose = kirbystdlibref.getProp(GS__46, "verbose");
...
////////////////////////////////////////////////////////////////////////////////
//fn: [transpile] in file: compiler.ky, line: 1744
//Compile kirby file to target source
const transpile = function(code, file) {
  let GS__47 = Array.prototype.slice.call(arguments, 2);
  let options = kirbystdlibref.getIndex(GS__47, 0);
...
////////////////////////////////////////////////////////////////////////////////
//fn: [dbgAST] in file: compiler.ky, line: 1758
//Dump AST to xml
