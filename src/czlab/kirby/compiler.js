...
const kn = require("./kernel");
const lambda_DASH_arg_QUERY = kn["lambda_DASH_arg_QUERY"];
const primitive = kn["primitive"];
const primitive_QUERY = kn["primitive_QUERY"];
const symbol = kn["symbol"];
const keyword = kn["keyword"];
const symbol_QUERY = kn["symbol_QUERY"];
const keyword_QUERY = kn["keyword_QUERY"];
...
const doFuncArgs = function(args, env) {
  let e,
    ...
    out;
  let pms = [];
  let ret = [node_QUOTE(args), node_QUOTE(args)];
  let fargs = ret[0];
  let fdefs = ret[1];
...
////////////////////////////////////////////////////////////////////////////////
//fn: [destruct*] in file: compiler.ky, line: 127
//Decide on what the
...
////////////////////////////////////////////////////////////////////////////////
//fn: [destructMap] in file: compiler.ky, line: 187
...
////////////////////////////////////////////////////////////////////////////////
//fn: [simple?] in file: compiler.ky, line: 215
...
////////////////////////////////////////////////////////////////////////////////
//fn: [wrap] in file: compiler.ky, line: 219
...
////////////////////////////////////////////////////////////////////////////////
//fn: [exprHint] in file: compiler.ky, line: 224
...
////////////////////////////////////////////////////////////////////////////////
//fn: [stmt?] in file: compiler.ky, line: 228
...
////////////////////////////////////////////////////////////////////////////////
//fn: [error!] in file: compiler.ky, line: 232
...
////////////////////////////////////////////////////////////////////////////////
//fn: [testre?] in file: compiler.ky, line: 239
...
////////////////////////////////////////////////////////////////////////////////
//fn: [pad] in file: compiler.ky, line: 242
const pad = function(n) {
  return " ".repeat(n);
};
////////////////////////////////////////////////////////////////////////////////
//fn: [node'] in file: compiler.ky, line: 245
...
////////////////////////////////////////////////////////////////////////////////
//fn: [txTree] in file: compiler.ky, line: 253
const txTree = function(root, fname, env) {
  let ms = [];
  let os = [];
  ...
  conj_BANG(ms, n1);
  for (let i = 1, t = null, sz = kirbystdlibref.count(root), ____break = false; ((!____break) && (i < sz)); i = (i + 1)) {
    t = root[i];
    if ( ((Array.isArray(t)) && ("defmacro" == kirbystdlibref.getProp(t, 0))) ) {
      conj_BANG(ms, t);
    } else {
      conj_BANG(os, t);
    }
  ...
  let f = function(c) {
    return (function() {
      let GS__15 = c;
      for (let GS__17 = 0, GS__16 = false, ____break = false; ((!____break) && ((!GS__16) && (GS__17 < GS__15.length))); GS__17 = (GS__17 + 1)) {
        let r = kirbystdlibref.getProp(GS__15, GS__17);
        let t = tx_STAR(r, env);
        if ( (!true) ) {
          GS__16 = true;
        } else {
...
////////////////////////////////////////////////////////////////////////////////
//fn: [txForm] in file: compiler.ky, line: 277
...
////////////////////////////////////////////////////////////////////////////////
//fn: [txAtom] in file: compiler.ky, line: 283
...
////////////////////////////////////////////////////////////////////////////////
//fn: [tx*] in file: compiler.ky, line: 303
...
////////////////////////////////////////////////////////////////////////////////
//fn: [gcmd] in file: compiler.ky, line: 307
...
////////////////////////////////////////////////////////////////////////////////
//fn: [quoteSingle] in file: compiler.ky, line: 315
const quoteSingle = function(a) {
  return (keyword_QUERY(a) ?
    [maybeStripStdlib([KBSTDLR, ".keyword"].join("")), "(\":", a, "\")"].join("") :
    (symbol_QUERY(a) ?
      [maybeStripStdlib([KBSTDLR, ".symbol"].join("")), "(\"", a, "\")"].join("") :
      (primitive_QUERY(a) ?
        (function() {
          a = a.value;
          return (((typeof (a) === "string")) ?
...
////////////////////////////////////////////////////////////////////////////////
//fn: [quote!] in file: compiler.ky, line: 332
...
////////////////////////////////////////////////////////////////////////////////
//fn: [quoteMap] in file: compiler.ky, line: 341
...
////////////////////////////////////////////////////////////////////////////////
//fn: [quoteBlock] in file: compiler.ky, line: 353
...
////////////////////////////////////////////////////////////////////////////////
//fn: [spreadInfo] in file: compiler.ky, line: 362
...
////////////////////////////////////////////////////////////////////////////////
//fn: [txPairs] in file: compiler.ky, line: 374
const txPairs = function(ast, env) {
  ...
  xfi(e1, ast);
  if (mc) {
    (ast = rt.expand_QUERY__QUERY(ast, env, mc), ast = xfi(orig, exprHint(ast, (!stmtQ))));
    spreadInfo(orig, ast);
    cmd = gcmd(ast);
  }
  ...
  if ( (cmd == "with-meta") ) {
    ...
    if (cmd.startsWith(".-")) {
      ...
      if (cmd.startsWith(".@")) {
        ...
        if (cmd.startsWith(".")) {
          ret.add([tx_STAR(kirbystdlibref.getProp(ast, 1), env), cmd, "("]);
...
////////////////////////////////////////////////////////////////////////////////
//fn: [writeDoc] in file: compiler.ky, line: 443
//Convert to jsdoc
...
////////////////////////////////////////////////////////////////////////////////
//fn: [meta??] in file: compiler.ky, line: 470
const meta_QUERY__QUERY = function(obj, env) {
  let mobj = null;
  if ( ((Array.isArray(obj)) && (3 === kirbystdlibref.count(obj)) && ("with-meta" == [kirbystdlibref.getProp(obj, 0)].join(""))) ) {
...
////////////////////////////////////////////////////////////////////////////////
//fn: [fmtRegoSpecOps] in file: compiler.ky, line: 482
const fmtRegoSpecOps = function(alias, fname) {
  return [parser.jsid("SPEC-OPS"), "[\"", alias, "\"] = ", fname].join("");
};
////////////////////////////////////////////////////////////////////////////////
//fn: [fmtSpecOps] in file: compiler.ky, line: 486
...
////////////////////////////////////////////////////////////////////////////////
//fn: [writeFuncPre] in file: compiler.ky, line: 493
...
////////////////////////////////////////////////////////////////////////////////
//fn: [writeFuncInfo] in file: compiler.ky, line: 500
...
////////////////////////////////////////////////////////////////////////////////
//fn: [evalMeta] in file: compiler.ky, line: 512
...
////////////////////////////////////////////////////////////////////////////////
//fn: [maybeStripStdlib] in file: compiler.ky, line: 527
...
////////////////////////////////////////////////////////////////////////////////
//fn: [assertArity] in file: compiler.ky, line: 536
...
////////////////////////////////////////////////////////////////////////////////
//fn: [assertInfo] in file: compiler.ky, line: 541
...
////////////////////////////////////////////////////////////////////////////////
//fn: [loadRLib] in file: compiler.ky, line: 549
const loadRLib = function(info, env) {
  let GS__20 = info;
  let ns = GS__20["ns"];
  let macros = GS__20["macros"];
  let ast,
    s;
  let GS__21 = macros;
  Object.entries(GS__21).forEach(function(e) {
    return (function(v, k) {
      (ast = rt.readAST(v), s = std.symbol([ns, "/", [kirbystdlibref.getProp(ast, 1)].join("")].join("")));
      ast[1] = s;
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-juxt] in file: compiler.ky, line: 564
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-deref] in file: compiler.ky, line: 586
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-compose] in file: compiler.ky, line: 597
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-quote] in file: compiler.ky, line: 622
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-deftype] in file: compiler.ky, line: 630
//Define a JS Class
const sf_DASH_deftype = function(ast, env) {
  ...
  ret.add(" {\n");
  let GS__23 = mtds;
  for (let GS__25 = 0, GS__24 = false, ____break = false; ((!____break) && ((!GS__24) && (GS__25 < GS__23.length))); GS__25 = (GS__25 + 1)) {
    let m = kirbystdlibref.getProp(GS__23, GS__25);
    null;
    if ( (!true) ) {
      GS__24 = true;
    } else {
    ...
    if ( ((!GS__24) && true) ) {
      ...
      if ( (([m1].join("") == "constructor") && not_DASH_empty(czargs)) ) {
        ...
        m.splice(pos, 0, [kirbystdlibref.symbol("assoc!"), kirbystdlibref.symbol("this")].concat(czargs));
      }
      m.unshift(mtd);
      env.addVar(cn, {
        "ns": kn.peekNSP().id,
...
SPEC_DASH_OPS["<="] = sf_DASH_compOp;
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-arithOp] in file: compiler.ky, line: 708
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-do] in file: compiler.ky, line: 745
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-case] in file: compiler.ky, line: 763
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-vardefs] in file: compiler.ky, line: 812
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-var] in file: compiler.ky, line: 841
...
const sf_DASH_var = function(ast, env) {
  ...
  if ( (pub_QUERY && kn.peekNSP()) ) {
    let GS__28 = keys;
    Object.entries(GS__28).forEach(function(e) {
      return (function() {
        let ____args = Array.prototype.slice.call(arguments);
        return _STAR_externs_STAR[____args[1]] = ____args[0];
      })(kirbystdlibref.getProp(e, 1), kirbystdlibref.getProp(e, 0));
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-inst?] in file: compiler.ky, line: 882
//Evaluates x and tests if it is an instance of the class
//c. Returns true or false.
//(inst? c x)
const sf_DASH_inst_QUERY = function(ast, env) {
  assertArity((kirbystdlibref.count(ast) === 3), ast);
  return wrap(node_QUOTE(ast), null, ["(", tx_STAR(kirbystdlibref.getProp(ast, 2), env), " instanceof ", tx_STAR(kirbystdlibref.getProp(ast, 1), env), ")"]);
};
SPEC_DASH_OPS["inst?"] = sf_DASH_inst_QUERY;
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-delete] in file: compiler.ky, line: 895
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-new] in file: compiler.ky, line: 910
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-throw] in file: compiler.ky, line: 924
//Throw an exception
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-x-opop] in file: compiler.ky, line: 940
...
SPEC_DASH_OPS["--$"] = sf_DASH_x_DASH_opop;
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-x-eq] in file: compiler.ky, line: 954
//Compound assignment operators
const sf_DASH_x_DASH_eq = function(ast, env) {
  assertArity((kirbystdlibref.count(ast) === 3), ast);
  let cmd = (function() {
    let C__29;
    switch ([kirbystdlibref.getProp(ast, 0)].join("")) {
      case "bitwise-zrshift=":
        C__29 = ">>>=";
        break;
      case "bitwise-rshift=":
      ...
      case "exp=":
        ...
        break;
      default:
        C__29 = [kirbystdlibref.getProp(ast, 0)].join("");
        break;
    }
    return C__29;
  }).call(this);
  return wrap(node_QUOTE(ast), null, [tx_STAR(kirbystdlibref.getProp(ast, 1), env), " ", cmd, " ", tx_STAR(kirbystdlibref.getProp(ast, 2), env)]);
};
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-setin!] in file: compiler.ky, line: 987
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-set] in file: compiler.ky, line: 1007
...
const sf_DASH_fn = function(ast, env) {
  ...
  return wrap(node_QUOTE(ast), null, ["function (", kirbystdlibref.getProp(fargs, 0), ") {\n", kirbystdlibref.getProp(fargs, 1), txDo(body, env, true), "}"]);
};
SPEC_DASH_OPS["fn"] = sf_DASH_fn;
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-func] in file: compiler.ky, line: 1044
...
const sf_DASH_func = function(ast, env) {
  assertArity((kirbystdlibref.count(ast) >= 2), ast);
  let pub_QUERY = (![kirbystdlibref.getProp(ast, 0)].join("").endsWith("-"));
  let mtd_QUERY = ([kirbystdlibref.getProp(ast, 0)].join("") == "method");
  ...
  let GS__31 = (((typeof (kirbystdlibref.getProp(ast, 2)) === "string")) ?
  ...
  let GS__32 = meta_QUERY__QUERY(kirbystdlibref.getProp(ast, pargs), env);
  let attrs = GS__32[0];
  let args = GS__32[1];
  if ( (!mtd_QUERY) ) {
    env.addVar(fname0, {
  ...
  if ( (pub_QUERY && (!dot_QUERY) && (!mtd_QUERY) && kn.peekNSP()) ) {
...
SPEC_DASH_OPS["defn-"] = sf_DASH_func;
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-try] in file: compiler.ky, line: 1108
...
const sf_DASH_try = function(ast, env) {
  ...
  let t,
    ...
    c;
  f = last(ast);
  if ( ((Array.isArray(f)) && ("finally" == [kirbystdlibref.getProp(f, 0)].join(""))) ) {
    pop_BANG(ast);
  ...
  if ( ((Array.isArray(c)) && ("catch" == [kirbystdlibref.getProp(c, 0)].join(""))) ) {
...
const sf_DASH_get = function(ast, env) {
  assertArity((kirbystdlibref.count(ast) === 3), ast);
  let cmd = maybeStripStdlib([KBSTDLR, ".getProp"].join(""));
  return wrap(node_QUOTE(ast), null, [cmd, "(", tx_STAR(xfi(ast, kirbystdlibref.getProp(ast, 1)), env), ",", tx_STAR(xfi(ast, kirbystdlibref.getProp(ast, 2)), env), ")"]);
};
SPEC_DASH_OPS["nth"] = sf_DASH_get;
SPEC_DASH_OPS["get"] = sf_DASH_get;
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-array] in file: compiler.ky, line: 1214
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-object] in file: compiler.ky, line: 1239
...
////////////////////////////////////////////////////////////////////////////////
//fn: [require!] in file: compiler.ky, line: 1263
const require_BANG = function(path) {
  return require(path);
};
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-require] in file: compiler.ky, line: 1268
//Loads libs.
...
const sf_DASH_require = function(ast, env) {
  ...
  let rlib,
    ...
    refers,
    renames;
  let dirname = path.dirname(ast.source);
  let ret = node_QUOTE(ast);
  for (let i = 1, sz = kirbystdlibref.count(ast), ____break = false; ((!____break) && (i < sz)); i = (i + 1)) {
    (e = ast[i], as = [gensym("R__")].join(""), refer_none = false, refer_all = false, refers = null, renames = null);
    ...
    if ( (!refer_none) ) {
      ret.add(["const ", parser.jsid(as), "= require(", rpath, ");\n"]);
    } else {
      null;
    }
    ...
    mcs = (mcs || {});
    for (let i = 0, t = null, r = null, rs = null, f = null, m = null, sz = ((Array.isArray(refers)) ?
          kirbystdlibref.count(refers) :
          0), ____break = false; ((!____break) && (i < sz)); i = (i + 1)) {
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-ns] in file: compiler.ky, line: 1361
...
const sf_DASH_ns = function(ast, env) {
  ...
  let mobj = null;
  let pos = 2;
  let GS__33 = meta_QUERY__QUERY(kirbystdlibref.getProp(ast, 1), env);
  let attrs = GS__33[0];
  let nsp = GS__33[1];
  if ( (!symbol_QUERY(nsp)) ) {
  ...
  kn.pushNSP([nsp].join(""), attrs);
  println(["Processing namespace: ", [nsp].join("")].join(""));
  ast = xfi(ast, Array.prototype.slice.call(ast, pos));
  for (let i = 0, sz = kirbystdlibref.count(ast), ____break = false; ((!____break) && (i < sz)); i = (i + 1)) {
    e = ast[i];
    if (pairs_QUERY(e)) {
      if ( ("require" == [kirbystdlibref.getProp(e, 0)].join("")) ) {
  ...
  nsp = kn.peekNSP();
  if ( ((nsp.id === [KBPFX, "kernel"].join("")) || (nsp.id === [KBPFX, "macros"].join("")) || (nsp.id === [KBPFX, "stdlib"].join(""))) ) {
    null;
  } else {
    if (nsp.id.startsWith(KBPFX)) {
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-comment] in file: compiler.ky, line: 1413
const sf_DASH_comment = function(ast, env) {
  return "";
};
SPEC_DASH_OPS["comment"] = sf_DASH_comment;
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-for] in file: compiler.ky, line: 1416
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-floop] in file: compiler.ky, line: 1436
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-jscode] in file: compiler.ky, line: 1480
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-macro] in file: compiler.ky, line: 1497
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-unary] in file: compiler.ky, line: 1551
...
SPEC_DASH_OPS["!"] = sf_DASH_unary;
////////////////////////////////////////////////////////////////////////////////
//fn: [getPrePost] in file: compiler.ky, line: 1564
...
////////////////////////////////////////////////////////////////////////////////
//fn: [xfi] in file: compiler.ky, line: 1580
...
////////////////////////////////////////////////////////////////////////////////
//fn: [spitMacros] in file: compiler.ky, line: 1594
const spitMacros = function() {
  return ((0 === kirbystdlibref.count(_STAR_macros_STAR)) ?
    "" :
    std.wrap_DASH_str(seq(_STAR_macros_STAR).map(function(GS__35) {
      let k = GS__35[0];
      let v = GS__35[1];
...
////////////////////////////////////////////////////////////////////////////////
//fn: [spitExterns] in file: compiler.ky, line: 1604
...
const spitExterns = function() {
  let mc = ((0 === kirbystdlibref.count(_STAR_macros_STAR)) ?
    ...
    "____macros");
  let s2 = "";
  let s1 = [EXPKEY, ": { ns: ", quote_DASH_str(kn.peekNSP().id), ", macros: ", mc, " }"].join("");
  if (not_DASH_empty(_STAR_externs_STAR)) {
    s2 = [",\n", seq(_STAR_externs_STAR).map(function(GS__36) {
      let k = GS__36[0];
      let v = GS__36[1];
      return [k, ":", v].join("");
    }).join(",\n")].join("");
...
////////////////////////////////////////////////////////////////////////////////
//fn: [banner] in file: compiler.ky, line: 1621
//Banner text for the target file
const banner = function() {
  let GS__37 = kn.peekNSP();
  let id = GS__37["id"];
  let meta = GS__37["meta"];
  return ["/*", "Auto generated by Kirby v", MOD_DASH_VER, " - ", new Date(), "\n", "  ", id, "\n", (meta ?
    std.prn(meta, true) :
    ""), "\n", "*/\n\n"].join("");
};
////////////////////////////////////////////////////////////////////////////////
//fn: [cleanCode] in file: compiler.ky, line: 1629
const cleanCode = function(code) {
  let tmp = null;
  let arr = [];
  let GS__38 = code.split("\n");
  for (let GS__40 = 0, GS__39 = false, ____break = false; ((!____break) && ((!GS__39) && (GS__40 < GS__38.length))); GS__40 = (GS__40 + 1)) {
    let s = kirbystdlibref.getProp(GS__38, GS__40);
    let tmp = s.trim();
    if ( (!true) ) {
      GS__39 = true;
    } else {
...
////////////////////////////////////////////////////////////////////////////////
//fn: [transpile*] in file: compiler.ky, line: 1638
...
const transpile_STAR = function(source, fname, options) {
  (_STAR_externs_STAR = {}, _STAR_macros_STAR = {});
  let gv = rt.genv();
  let ret = txTree(parser.parse(source, fname), fname, gv);
  let GS__41 = options;
  let source_DASH_map = GS__41["source-map"];
  let format = GS__41["format"];
  let verbose = GS__41["verbose"];
  ...
  let lbs = Object.keys(kirbystdlibref.getProp(gv, "libs"));
  let vas = Object.keys(kirbystdlibref.getProp(gv, "vars"));
  if (verbose) {
    println("<macros>\n", std.prn(mcs, true));
    println("<libs>\n", std.prn(lbs, true));
...
const transpile = function(code, file) {
  let GS__42 = Array.prototype.slice.call(arguments, 2);
  let options = GS__42[0];
  return (function() {
    try {
...
////////////////////////////////////////////////////////////////////////////////
//fn: [dbgAST] in file: compiler.ky, line: 1695
//Dump AST to xml
