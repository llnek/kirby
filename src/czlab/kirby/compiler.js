/*Auto generated by Kirby v1.0.0 - Thu Mar 29 2018 17:43:40 GMT-0700 (PDT)
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-objObj] in file: compiler.ky, line: 1121
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-mapObj] in file: compiler.ky, line: 1137
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-setObj] in file: compiler.ky, line: 1151
//Returns a new Set.
//(set 1 2 3)
...
////////////////////////////////////////////////////////////////////////////////
//fn: [require!] in file: compiler.ky, line: 1168
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-require2] in file: compiler.ky, line: 1175
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-require] in file: compiler.ky, line: 1232
//Loads libs.
...
const sf_DASH_require = function(ast, env) {
  ...
  for (let GS__54 = 0, GS__52 = true, GS__53 = ast.slice(1), ____sz = kirbystdlibref.count(GS__53), ____break = false; (!____break && GS__52 && (GS__54 < ____sz)); ++GS__54) {
    let a_QUOT = GS__53[GS__54];
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-ns] in file: compiler.ky, line: 1252
...
const sf_DASH_ns = function(ast, env) {
  ...
  let mobj = null;
  let pos = 2;
  let GS__55 = meta_QMRK__QMRK(ast[1], env);
  let attrs = kirbystdlibref.getIndex(GS__55, 0);
  let nsp = kirbystdlibref.getIndex(GS__55, 1);
  if ( (!symbol_QMRK(nsp)) ) {
  ...
  for (let GS__58 = 0, GS__56 = true, GS__57 = ast, ____sz = kirbystdlibref.count(GS__57), ____break = false; (!____break && GS__56 && (GS__58 < ____sz)); ++GS__58) {
    let e = GS__57[GS__58];
    if (pairs_QMRK(e)) {
      if ( ([e[0]].join("") == "require") ) {
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-comment] in file: compiler.ky, line: 1304
const sf_DASH_comment = function(ast, env) {
  return "";
};
SPEC_DASH_OPS["comment"] = sf_DASH_comment;
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-while] in file: compiler.ky, line: 1307
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-wloop] in file: compiler.ky, line: 1321
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-forxxx] in file: compiler.ky, line: 1336
//Generates native for loop.
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-foop] in file: compiler.ky, line: 1352
//For loop implementation
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-jscode] in file: compiler.ky, line: 1422
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-macro] in file: compiler.ky, line: 1439
  ...
  for (let ____coll = args, i = 0, ____end = kirbystdlibref.count(____coll), ____break = false; ((!____break) && (i < ____end)); i = (i + 1)) {
    ...
    if ( (ev == "&") ) {
      if ( (Array.isArray(args[(i + 1)])) ) {
        ...
        e = args[(i + 1)]);
        ++i;
        for (let GS__61 = 0, GS__59 = true, GS__60 = e, ____sz = kirbystdlibref.count(GS__60), ____break = false; (!____break && GS__59 && (GS__61 < ____sz)); ++GS__61) {
          let x = GS__60[GS__61];
          if ( (!symbol_QMRK(x)) ) {
            error_BANG("syntax-error", ast);
          } else {
...
const sf_DASH_unary = function(ast, env) {
  assertArity((kirbystdlibref.count(ast) === 2), ast);
  let GS__62 = ast;
  let a0 = kirbystdlibref.getIndex(GS__62, 0);
  let a1 = kirbystdlibref.getIndex(GS__62, 1);
  if ( (a0 == "not") ) {
    (
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-listc] in file: compiler.ky, line: 1501
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-doseq] in file: compiler.ky, line: 1520
//Repeatedly executes body (presumably for side-effects) with
//bindings and filtering as provided by "for".  Does not retain
//the head of the sequence. Returns nil.
const sf_DASH_doseq = function(ast, env) {
  let GS__63 = Array.prototype.slice.call(arguments, 2);
  let capRes = kirbystdlibref.getIndex(GS__63, 0);
  let body = exprHint(xfi(ast, Array.prototype.slice.call(ast, 2)), false);
  ...
  let GS__64 = split_DASH_with(function() {
    let ____args = Array.prototype.slice.call(arguments);
    return (!keyword_QMRK(____args[0]));
  }, args);
  let x = kirbystdlibref.getIndex(GS__64, 0);
  let y = kirbystdlibref.getIndex(GS__64, 1);
...
////////////////////////////////////////////////////////////////////////////////
//fn: [xfi] in file: compiler.ky, line: 1591
...
////////////////////////////////////////////////////////////////////////////////
//fn: [spitMacros] in file: compiler.ky, line: 1602
//Dump all macros to string.
const spitMacros = function() {
  return ((0 === kirbystdlibref.count(_STAR_macros_STAR)) ?
    "{}" :
    std.wrap_DASH_str((seq(_STAR_macros_STAR) || []).map(function(GS__67) {
      let k = kirbystdlibref.getIndex(GS__67, 0);
      let v = kirbystdlibref.getIndex(GS__67, 1);
      return [quote_DASH_str([k].join("")), ":", quote_DASH_str(v)].join("");
    }).join(",\n"), "{\n", "}\n"));
};
////////////////////////////////////////////////////////////////////////////////
//fn: [spitVars] in file: compiler.ky, line: 1612
...
////////////////////////////////////////////////////////////////////////////////
//fn: [banner] in file: compiler.ky, line: 1630
//Banner text for the target file
const banner = function() {
  let GS__68 = std.peekNSP();
  let id = kirbystdlibref.getProp(GS__68, "id");
  let meta = kirbystdlibref.getProp(GS__68, "meta");
...
const cleanCode = function(code) {
  return ((code.split("\n") || []).map(function() {
    let ____args = Array.prototype.slice.call(arguments);
    return (function() {
      let GS__69 = ____args[0].trim();
      let s = GS__69;
      return ((kirbystdlibref.count(GS__69) > 0) ?
        ((s !== ";") ?
          ____args[0] :
          null) :
        null);
...
const transpile_STAR = function(source, fname, options) {
  ...
  let GS__70 = options;
  let source_DASH_map = kirbystdlibref.getProp(GS__70, "source-map");
  let no_DASH_format = kirbystdlibref.getProp(GS__70, "no-format");
  let verbose = kirbystdlibref.getProp(GS__70, "verbose");
  let err = undefined;
  let GS__71 = ([".js", ".map"] || []).map(function() {
    let ____args = Array.prototype.slice.call(arguments);
    return [path.basename(fname, ".ky"), ____args[0]].join("");
  });
  let fmap = kirbystdlibref.getIndex(GS__71, 0);
  let smap = kirbystdlibref.getIndex(GS__71, 1);
  if (source_DASH_map) {
...
////////////////////////////////////////////////////////////////////////////////
//fn: [transpile] in file: compiler.ky, line: 1678
//Compile kirby file to target source
const transpile = function(code, file) {
  let GS__72 = Array.prototype.slice.call(arguments, 2);
  let options = kirbystdlibref.getIndex(GS__72, 0);
  return (function() {
...
////////////////////////////////////////////////////////////////////////////////
//fn: [dbgAST] in file: compiler.ky, line: 1693
//Dump AST to xml
