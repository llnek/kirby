/*Auto generated by Kirby v1.0.0 - Sun Mar 18 2018 02:26:49 GMT-0700 (PDT)
      ...
      return (p1 ?
        (function() {
          ...
          if (fst) {
            (
            fst = false);
            doseq_DASH_binds(while_QUOT, ret, y, body, ast, env);
          } else {
            ret.add(inner);
          }
          ret.add("}\n");
...
////////////////////////////////////////////////////////////////////////////////
//fn: [doseq-binds] in file: compiler.ky, line: 1800
const doseq_DASH_binds = function(while_QUOT, ret, y, body, ast, env) {
  let patch = node_QUOT(ast);
  partition(2, y).forEach(function(GS__46) {
    let k = kirbystdlibref.getIndex(GS__46, 0);
