/*Auto generated by Kirby - v1.0.0 czlab.kirby.cg.transpiler Sat Nov 25 2017 06:40:21 GMT+1100 (AEDT)*/
...
////////////////////////////////////////////////////////////////////////////////
//name: [simpleton?] in file: transpiler.ky near line: 61
...
////////////////////////////////////////////////////////////////////////////////
//name: [exprHint] in file: transpiler.ky near line: 68
...
////////////////////////////////////////////////////////////////////////////////
//name: [stmt?] in file: transpiler.ky near line: 76
...
////////////////////////////////////////////////////////////////////////////////
//name: [error!] in file: transpiler.ky near line: 82
...
////////////////////////////////////////////////////////////////////////////////
//name: [syntax!] in file: transpiler.ky near line: 89
...
////////////////////////////////////////////////////////////////////////////////
//name: [pad] in file: transpiler.ky near line: 95
const pad = function(z) {
  return " ".repeat(z);
};
////////////////////////////////////////////////////////////////////////////////
//name: [testre?] in file: transpiler.ky near line: 98
...
////////////////////////////////////////////////////////////////////////////////
//name: [node'] in file: transpiler.ky near line: 101
...
////////////////////////////////////////////////////////////////////////////////
//name: [destructVec] in file: transpiler.ky near line: 109
...
////////////////////////////////////////////////////////////////////////////////
//name: [destructMap] in file: transpiler.ky near line: 134
...
////////////////////////////////////////////////////////////////////////////////
//name: [destruct1] in file: transpiler.ky near line: 155
...
////////////////////////////////////////////////////////////////////////////////
//name: [destruct0] in file: transpiler.ky near line: 168
...
////////////////////////////////////////////////////////////////////////////////
//name: [txTree] in file: transpiler.ky near line: 198
...
////////////////////////////////////////////////////////////////////////////////
//name: [txExpr] in file: transpiler.ky near line: 206
...
////////////////////////////////////////////////////////////////////////////////
//name: [txAtom] in file: transpiler.ky near line: 211
...
////////////////////////////////////////////////////////////////////////////////
//name: [tx*] in file: transpiler.ky near line: 229
...
////////////////////////////////////////////////////////////////////////////////
//name: [findCmd] in file: transpiler.ky near line: 239
...
////////////////////////////////////////////////////////////////////////////////
//name: [quoteSingle] in file: transpiler.ky near line: 251
...
////////////////////////////////////////////////////////////////////////////////
//name: [quote!] in file: transpiler.ky near line: 264
...
////////////////////////////////////////////////////////////////////////////////
//name: [quoteMap] in file: transpiler.ky near line: 272
...
////////////////////////////////////////////////////////////////////////////////
//name: [quoteBlock] in file: transpiler.ky near line: 285
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-quote] in file: transpiler.ky near line: 296
...
////////////////////////////////////////////////////////////////////////////////
//name: [txPairs] in file: transpiler.ky near line: 302
...
////////////////////////////////////////////////////////////////////////////////
//name: [writeDoc] in file: transpiler.ky near line: 375
//Convert to jsdoc
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-deftype] in file: transpiler.ky near line: 388
//Define a JS Class
...
SPEC_DASH_OPS["deftype-"] = sf_DASH_deftype;
////////////////////////////////////////////////////////////////////////////////
//name: [sf-compOp] in file: transpiler.ky near line: 432
...
SPEC_DASH_OPS["<="] = sf_DASH_compOp;
////////////////////////////////////////////////////////////////////////////////
//name: [sf-arithOp] in file: transpiler.ky near line: 455
...
SPEC_DASH_OPS[">>>"] = sf_DASH_arithOp;
////////////////////////////////////////////////////////////////////////////////
//name: [txDo] in file: transpiler.ky near line: 479
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-do] in file: transpiler.ky near line: 498
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-case] in file: transpiler.ky near line: 513
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-vardefs] in file: transpiler.ky near line: 553
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-const] in file: transpiler.ky near line: 578
...
SPEC_DASH_OPS["const-"] = sf_DASH_const;
////////////////////////////////////////////////////////////////////////////////
//name: [sf-var] in file: transpiler.ky near line: 609
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-inst?] in file: transpiler.ky near line: 643
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-delete] in file: transpiler.ky near line: 653
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-new] in file: transpiler.ky near line: 662
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-throw] in file: transpiler.ky near line: 670
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-x-opop] in file: transpiler.ky near line: 681
...
SPEC_DASH_OPS["--"] = sf_DASH_x_DASH_opop;
////////////////////////////////////////////////////////////////////////////////
//name: [sf-x-eq] in file: transpiler.ky near line: 688
...
SPEC_DASH_OPS["^="] = sf_DASH_x_DASH_eq;
////////////////////////////////////////////////////////////////////////////////
//name: [sf-set-in] in file: transpiler.ky near line: 699
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-set] in file: transpiler.ky near line: 719
...
////////////////////////////////////////////////////////////////////////////////
//name: [parseFuncArgs] in file: transpiler.ky near line: 738
...
////////////////////////////////////////////////////////////////////////////////
//name: [XXparseFuncArgs] in file: transpiler.ky near line: 774
...
////////////////////////////////////////////////////////////////////////////////
//name: [handleFuncArgs] in file: transpiler.ky near line: 804
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-fn] in file: transpiler.ky near line: 839
...
////////////////////////////////////////////////////////////////////////////////
//name: [fmtRegoSpecOps] in file: transpiler.ky near line: 857
const fmtRegoSpecOps = function(alias, fname) {
  return [rdr.jsid("SPEC-OPS"), "[\"", alias, "\"] = ", fname].join("");
};
////////////////////////////////////////////////////////////////////////////////
//name: [fmtSpecOps] in file: transpiler.ky near line: 863
...
////////////////////////////////////////////////////////////////////////////////
//name: [writeFuncInfo] in file: transpiler.ky near line: 871
const writeFuncInfo = function(fname, src) {
  let file = ast.source.slice((ast.source.lastIndexOf("/") + 1));
  let s = ["//name: [", fname, "] in file: ", file, " near line: ", ast.line, "\n"].join("");
  let len = s.length;
  if ( (len < 80) ) {
    len = 80;
  }
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-func] in file: transpiler.ky near line: 881
...
SPEC_DASH_OPS["defn-"] = sf_DASH_func;
////////////////////////////////////////////////////////////////////////////////
//name: [sf-try] in file: transpiler.ky near line: 935
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-if] in file: transpiler.ky near line: 977
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-nth] in file: transpiler.ky near line: 996
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-get] in file: transpiler.ky near line: 1005
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-array] in file: transpiler.ky near line: 1014
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-object] in file: transpiler.ky near line: 1032
...
var icache = [];
////////////////////////////////////////////////////////////////////////////////
//name: [includeFile] in file: transpiler.ky near line: 1053
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-include] in file: transpiler.ky near line: 1062
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-require] in file: transpiler.ky near line: 1086
...
////////////////////////////////////////////////////////////////////////////////
//name: [evalMeta] in file: transpiler.ky near line: 1127
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-ns] in file: transpiler.ky near line: 1143
...
////////////////////////////////////////////////////////////////////////////////
//name: [maybeStripStdlib] in file: transpiler.ky near line: 1179
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-comment] in file: transpiler.ky near line: 1189
const sf_DASH_comment = function(ast, env) {
  return node_QTE(tnode(), ast);
};
SPEC_DASH_OPS["comment"] = sf_DASH_comment;
////////////////////////////////////////////////////////////////////////////////
//name: [sf-for] in file: transpiler.ky near line: 1194
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-floop] in file: transpiler.ky near line: 1205
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-jscode] in file: transpiler.ky near line: 1249
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-macro] in file: transpiler.ky near line: 1256
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-unary] in file: transpiler.ky near line: 1300
...
SPEC_DASH_OPS["!"] = sf_DASH_unary;
////////////////////////////////////////////////////////////////////////////////
//name: [spitExterns] in file: transpiler.ky near line: 1310
...
////////////////////////////////////////////////////////////////////////////////
//name: [banner] in file: transpiler.ky near line: 1319
const banner = function() {
  return ["/*", "Auto generated by Kirby - v", MODULE_DASH_VERSION, " ", rt.globalEnv().firstNSP(), " - ", new Date(), "*/\n\n"].join("");
};
////////////////////////////////////////////////////////////////////////////////
//name: [cleanCode] in file: transpiler.ky near line: 1326
...
////////////////////////////////////////////////////////////////////////////////
//name: [transpileCode] in file: transpiler.ky near line: 1335
...
////////////////////////////////////////////////////////////////////////////////
//name: [transpileXXX] in file: transpiler.ky near line: 1363
...
////////////////////////////////////////////////////////////////////////////////
//name: [transpileWithSrcMap] in file: transpiler.ky near line: 1371
...
////////////////////////////////////////////////////////////////////////////////
//name: [transpile] in file: transpiler.ky near line: 1378
...
////////////////////////////////////////////////////////////////////////////////
//name: [parseWithSourceMap] in file: transpiler.ky near line: 1385
...
////////////////////////////////////////////////////////////////////////////////
//name: [processFuncArgs] in file: transpiler.ky near line: 1395
...
////////////////////////////////////////////////////////////////////////////////
//name: [destruct*] in file: transpiler.ky near line: 1433
...
////////////////////////////////////////////////////////////////////////////////
//name: [destruct-Vec] in file: transpiler.ky near line: 1450
...
////////////////////////////////////////////////////////////////////////////////
//name: [destruct-Map] in file: transpiler.ky near line: 1493
