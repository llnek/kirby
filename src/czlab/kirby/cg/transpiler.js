/*Auto generated by Kirby - v1.0.0 czlab.kirby.cg.transpiler Wed Nov 22 2017 10:44:17 GMT+1100 (AEDT)*/
...
const destruct_DASH_Map = function(src, coll) {
  ...
  for (let i = 0, sz = count(coll), ____break = false; ((!____break) && (i < sz)); i = (i + 1)) {
    ...
    if (keyword_QUERY(e)) {
      if ( ((e == "keys") || (e == "strs")) ) {
        let arr = coll[i + 1];
        for (let j = 0, sz = count(arr), ____break = false; ((!____break) && (i < sz)); j = (i + 1)) {
          e = arr[j];
