/*Auto generated by Kirby - v1.0.0 czlab.kirby.cg.transpiler Sun Oct 29 2017 16:05:20 GMT-0700 (PDT)*/
...
RESERVED = {
  ...
  "unary": ["not", "~", "!"],
  "assign": ["+=", "-=", "*=", "/=", "%=", "<<=", ">>=", ">>>=", "&=", "|=", "^="],
  "builtin": ["quote", "syntax-quote", "quasi-quote", "backtick", "unquote", "unquote-splice", "repeat-n", "do", "doto", "case", "apply", "range", "def-", "def", "var", "forlet", "new", "throw", "while", "lambda", "inst?", "delete!", "aset", "set!", "fn", "def!", "defn-", "defn", "try", "if", "get", "aget", "str", "list", "[", "vec", "{", "hash-map", "ns", "comment", "for", "cons", "js#", "macro", "defmacro"]
};
;
let MODULE_VERSION,
  nosemi_QUERY,
  ...
  (types.vector_QUERY(lhs) ?
    ...
    (types.map_QUERY(lhs) ?
          ...
          types.keyword_QUERY(e) ?
            (((ev === "keys") || (ev === "strs")) ?
              ...
              ((ev === "as") ?
                ...
                null)) :
            (function() {
              throw new Error(["bad destruct field: ", types.obj_type(e)].join(""));
            }).call(this));
          ;
        }
      }).call(this) :
      (types.symbol_QUERY(lhs) ?
        ...
        (true ?
          (function() {
            throw new Error(["cant destruct with: ", types.obj_type(lhs)].join(""));
          }).call(this) :
          null))));
  return [as, keys];
}
...
function sf_lambda(ast, env) {
  ...
  (0 !== _lambdaFuncCount) ?
    (function() {
      throw new Error(["Cant nest lambdas"].join(""));
    }).call(this) :
    ++_lambdaFuncCount);
  let x,
    body;
    ...
    (function() {
      ...
      for (let i = 0, e = null, ev = null; (!____break && (i < args.length)); i = (i + 1)) {
        ...
        types.symbol_QUERY(e) ?
          ...
          (types.keyword_QUERY(e) ?
            (function() {
              throw new Error(["bad function args destructure: ", types.obj_type(e)].join(""));
            }).call(this) :
            (Array.isArray(e) ?
            ...
            return (function() {
              ...
              for (let j = 0, x = null; (!____break && (j < e.length)); j = (j + 1)) {
                ...
                (!types.symbol_QUERY(x)) ?
                  (function() {
                    throw new Error(["Bad optional arg for macro"].join(""));
                  }).call(this) :
                  null);
                pms.push(x);
                ;
