/*Auto generated by Kirby - v1.0.0 czlab.kirby.cg.transpiler Sun Nov 05 2017 01:35:23 GMT-0800 (PST)*/
...
var tnode=psr["tnode"];
var tnodeEx=psr["tnodeEx"];
var rt= require("../rt/runtime");
var tnode=rt["tnode"];
var tnodeEx=rt["tnodeEx"];
var fs= require("fs");
...
(function() {
for (let i=0,e=null,ev=null,____break=false; ((!____break)&&(i < lhs.length)); ){
...
null)) :
(function (){ throw new Error([ "bad destruct field: ",std.typeid(e) ].join("")); }).call(this));
}
})(this);
...
(true ?
(function (){ throw new Error([ "cant destruct with: ",std.typeid(lhs) ].join("")); }).call(this) :
null))));
return std.vector(as,keys);
}
...
((0 !== _lambdaFuncCount) ?
(function (){ throw new Error("Can't nest lambdas"); }).call(this) :
++_lambdaFuncCount);
let x,body;
x= [ std.symbol("fn"),std.vector(),[ std.symbol("var"),std.symbol("____args"),[ std.symbol("slice"),std.symbol("arguments") ] ] ];
body= ast[1];
...
(function() {
for (let i=0,____break=false; ((!____break)&&(i < end)); ){
e=ast[i];
...
null);
(function() {
for (let i=2,____break=false; ((!____break)&&(i < ast.length)); ){
c=ast[(i+1)];
e=ast[i];
(std.list_QUERY(e) ?
(function() {
...
((0 === (ast.length%2)) ?
true :
(function (){ throw new Error("set-in: bad arg count"); }).call(this));
return (function() {
let ret;
ret= nodeTag(tnode(),ast);
...
((!(0 === (ast.length%2))) ?
true :
(function (){ throw new Error("set: bad arg count"); }).call(this));
return (function() {
let ret;
ret= nodeTag(tnode(),ast);
...
null)))) :
(std.keyword_QUERY(e) ?
(function (){ throw new Error([ "bad function args destructure: ",std.typeid(e) ].join("")); }).call(this) :
(Array.isArray(e) ?
...
ret.add("{\n");
(function() {
for (let i=0,____break=false; ((!____break)&&(i < ast.length)); ){
((i > 0) ?
ret.add(",\n") :
null);
...
(function() {
for (let i=1,e=null,____break=false; ((!____break)&&(i < ast.length)); ){
e=ast[i];
...
(function() {
for (let i=1,____break=false; ((!____break)&&(i < ast.length)); ){
e=ast[i],as=gensym();
...
(true ?
(function (){ throw new Error([ "Bad meta value",std.prn(ast) ].join("")); }).call(this) :
null))));
}
...
ast=ast.slice(2);
(function() {
for (let i=0,e=null,____break=false; (!____break); i=(i+1),e="while",undefined=(i < ast.length)){
e=ast[i];
...
null);
(function() {
for (let i=0,e=null,ev=null,____break=false; ((!____break)&&(i < args.length)); ){
e=args[i],ev=e.toString();
((ev === "&") ?
...
x=e[j];
((!std.symbol_QUERY(x)) ?
(function (){ throw new Error("Bad optional arg for macro"); }).call(this) :
null);
std.conj_BANG(pms,x);
}
})(this);
