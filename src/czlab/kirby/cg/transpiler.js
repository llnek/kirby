/*Auto generated by Kirby - v1.0.0 czlab.kirby.cg.transpiler Mon Oct 30 2017 18:39:18 GMT-0700 (PDT)*/
...
null);
(function () {let ____break=false;
for (let i = 1,s = null; (!____break && (i < ast.length)); i = (i+1)) {
...
path = e[0];
(function () {let ____break=false;
for (let j = 1; (!____break && (j < e.length)); j = (j+1)) {
v = e[j];
((v == "as") ?
(function() {
as = e[(j+1)].toString();
...
(function () {let ____break=false;
for (let i = 0; (!____break && (refers&&(i < refers.length))); i = (i+1)) {
...
(function () {let ____break=false;
for (let i = 0; (!____break && (renames&&(i < renames.length))); i = (i+2)) {
