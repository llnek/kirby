/*Auto generated by Kirby - v1.0.0 czlab.kirby.cg.transpiler Mon Nov 06 2017 15:09:31 GMT-0800 (PST)*/
...
let body,internal_QUERY;
body= ast.slice(2);
internal_QUERY= ("floop" == ast[0]);

((0 === kirbystdlibref.count(body)) ?
tnode() :
sf_floop(ret,ast[1],body,env,internal_QUERY));
return ret;
}).call(this);
}
SPEC_OPS["for"] = sf_for;
SPEC_OPS["floop"] = sf_for;

//
function sf_floop(ret,args,body,env,internal_QUERY) {
let vars,recurs;
vars= [];
recurs= [];
