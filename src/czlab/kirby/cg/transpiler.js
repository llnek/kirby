/*Auto generated by Kirby - v1.0.0 czlab.kirby.cg.transpiler Tue Oct 31 2017 15:59:32 GMT-0700 (PDT)*/
...
for (leti = 0,e = null,ev = null; (!____break && (i < lhs.length)); i = (i+1)) {
e = lhs[i];
ev = e.value;
...
for (letj = 0; (!____break && (j < ks.length)); j = (j+1)) {
...
ret.add([ cmd,"(" ]);
(function () {let ____break=false;
for (letn = 2; (!____break && (n < ast.length)); n = (n+1)) {
((n !== 2) ?
ret.add(",") :
null);
...
(function () {let ____break=false;
for (leti = 0; (!____break && (i < args.length)); i = (i+1)) {
...
transpileAtoms(ast,env);
(function () {let ____break=false;
for (leti = 0,op = ast.shift(); (!____break && (i < (ast.length-1))); i = (i+1)) {
...
transpileAtoms(ast,env);
(function () {let ____break=false;
for (leti = 0,end = parseInt(ast[1]); (!____break && (i < end)); i = (i+1)) {
((i !== 0) ?
ret.add(",") :
null);
ret.add(ast[2]);
...
(function () {let ____break=false;
for (leti = 0; (!____break && (i < end)); i = (i+1)) {
e = ast[i];
...
null);
(function () {let ____break=false;
for (leti = 2; (!____break && (i < ast.length)); i = (i+2)) {
c = ast[(i+1)];
e = ast[i];
(types.list_QUERY(e) ?
(function () {let ____break=false;
for (letj = 0; (!____break && (j < e.length)); i = (null+1)) {
...
null);
(function () {let ____break=false;
for (leti = start; (!____break && (i < end)); i = (i+step)) {
((i !== start) ?
ret.add(",") :
null);
ret.add(i.toString());
...
null);
(function () {let ____break=false;
for (leti = 1,s = null; (!____break && (i < ast.length)); i = (i+1)) {
...
null);
(function () {let ____break=false;
for (leti = 0; (!____break && (i < ast.length)); i = (i+2)) {
...
null);
(function () {let ____break=false;
for (letrc = null,i = 0,lhs = null,rhs = null; (!____break && (i < ast.length)); i = (i+2)) {
rhs = ast[(i+1)];
lhs = ast[i];
(types.symbol_QUERY(lhs) ?
...
(function () {let ____break=false;
for (leti = 0,e = null,ev = null; (!____break && (i < args.length)); i = (i+1)) {
e = args[i];
ev = e.value;
(types.symbol_QUERY(e) ?
((ev === "_") ?
...
ret.add(["[\n",p].join(""));
(function () {let ____break=false;
for (leti = 0; (!____break && (i < ast.length)); i = (i+1)) {
((i > 0) ?
ret.add([",\n",p].join("")) :
null);
ret.add(ast[i]);
...
(function () {let ____break=false;
for (leti = 1,e = null; (!____break && (i < ast.length)); i = (i+1)) {
e = ast[i];
...
(function () {let ____break=false;
for (leti = 1; (!____break && (i < ast.length)); i = (i+1)) {
e = ast[i];
...
path = e[0];
(function () {let ____break=false;
for (letj = 1; (!____break && (j < e.length)); j = (j+1)) {
v = e[j];
((v == "as") ?
(function() {
as = e[(j+1)].toString();
...
(function () {let ____break=false;
for (leti = 0; (!____break && (refers&&(i < refers.length))); i = (i+1)) {
...
(function () {let ____break=false;
for (leti = 0; (!____break && (renames&&(i < renames.length))); i = (i+2)) {
...
(function () {let ____break=false;
for (leti = 1,e = null,nsp = null; (!____break && (i < ast.length)); i = (i+1)) {
e = ast[i];
(types.symbol_QUERY(e) ?
(nsp ?
syntax_BANG("e0",ast) :
...
(Array.isArray(c3) ?
(function () {let ____break=false;
for (leti = 0; (!____break && (i < c3.length)); i = (i+2)) {
((i > 0) ?
ret.add(",") :
null);
...
++i;
return (function () {let ____break=false;
for (letj = 0,x = null; (!____break && (j < e.length)); j = (j+1)) {
x = e[j];
...
(function () {let ____break=false;
for (leti = 2,v = null,ev = null; (!____break && (i < args.length)); i = (i+1)) {
v = args[i];
ev = v.value;
((ev === "while") ?
...
G__7.add([ "if (!",escvar,") {\n" ]);
G__7.add([ "if (! ",transpile_STAR(args[(i+1)],env),") {continue;}\n" ]);
G__7.add("}\n");
return G__7;
}).call(this) :
((ev === "let") ?
