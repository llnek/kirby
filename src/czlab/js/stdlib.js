/*Auto generated by Kirby v1.0.0 - Wed Jun 30 2021 23:09:40 GMT-0700 (Pacific Daylight Time)
  czlab.kirby.stdlib
...
module.exports = {
  da57bc0172fb42438a11e6e8778f36fb: {
    ...
    macros: {
      ...
      "loop": "(macro* loop (bindings & more) (let* [es (evens* bindings) os (odds* bindings)] (syntax-quote ((fn [] (with-local-vars [_x_ nil recur nil _zz_ (kirbyref/JSSymbol \"!\") _f_ (fn [(splice-unquote es)] (splice-unquote more)) _r_ _f_]) (set! recur (fn [] (set! _x_ arguments) (raw# \"if (_r_ !== _zz_){for(_r_=_zz_;_r_===_zz_;){_r_=_f_.apply(this,_x_)} return _r_}\") _zz_)) (recur (splice-unquote os))) this))))",
