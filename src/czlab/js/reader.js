...
;(function(gscope,UNDEF){
  ...
  function _module(){
    ...
    function lexer(source, fname){
      ...
      let col = 0, pos = 0, tree = [];
      let tcol = col, tline = line, len = source ? source.length : 0;
      ///
      const consec3=(t)=> ch == t && nx == t && source.charAt(pos+1) == t;
      const consec2=(t)=> ch == t && nx == t;
      const multi=(line,col, ...ts)=> ts.forEach(t=> toke(line,col,t,true));
      ///
