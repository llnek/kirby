/*Auto generated by Kirby v1.0.0 - Fri Jan 19 2018 02:32:21 GMT-0800 (PST)
...
const setnsp_BANG = std["setnsp_BANG"];
const getnsp = std["getnsp"];
...
const sf_DASH_ns = function(ast, env) {
  ...
  setnsp_BANG([nsp].join(""));
  println(["Processing namespace: ", getnsp()].join(""));
...
const spitExterns = function() {
  let mc = ((0 === kirbystdlibref.count(_STAR_macros_STAR)) ?
    ...
    "____macros");
  let s2 = "";
  let s1 = [EXPKEY, ": { ns: ", quote_DASH_str(getnsp()), ", macros: ", mc, " }"].join("");
...
////////////////////////////////////////////////////////////////////////////////
//fn: [transpile] in file: compiler.ky, line: 1668
...
////////////////////////////////////////////////////////////////////////////////
//fn: [dbgAST] in file: compiler.ky, line: 1678
//Dump AST to xml
