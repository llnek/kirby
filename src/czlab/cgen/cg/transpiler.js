/*Auto generated by Kirby - v1.0.0 Thu Oct 12 2017 20:09:45 GMT-0700 (PDT)*/
...
for (var i = 1; (i < ast.length); i = (i+1)) {
  ...
  ((nm == "with-meta") ?
    ...
    (types.symbol_QUERY(e) ?
      ...
      ((types.list_QUERY(e)&&("include" == nm)) ?
        ret.push(sf_include(e)) :
        ((types.list_QUERY(e)&&("require" == nm)) ?
          ret.push(sf_require(e)) :
          ((types.list_QUERY(e)&&("with-meta" == nm)) ?
            null :
            null)))));
;
}
...
//
function banner() {
return ["/*","Auto generated by Kirby - v",MODULE_VERSION," ",new Date(),"*/\n\n"].join("");
}
