/*Auto generated by Kirby v1.0.0 - Mon Jan 22 2018 03:16:57 GMT-0800 (PST)
...
var TMPVAR = null;
////////////////////////////////////////////////////////////////////////////////
//fn: [mult3] in file: test.ky, line: 19
const mult3 = function(x) {
  return (3 * x);
};
////////////////////////////////////////////////////////////////////////////////
//fn: [add2] in file: test.ky, line: 20
const add2 = function(x) {
  return (2 + x);
};
////////////////////////////////////////////////////////////////////////////////
//fn: [exlog] in file: test.ky, line: 23
...
const test_DASH_stdlib = function() {
  ...
  return [kirbystdlibref.ensureTest((!(0 === kirbystdlibref.count([1]))), "not empty?"), kirbystdlibref.ensureTest((0 === kirbystdlibref.count([])), "empty?"), kirbystdlibref.ensureTest("abc".startsWith("a"), "string starts?"), kirbystdlibref.ensureTest("abc".endsWith("c"), "string ends?"), kirbystdlibref.ensureTest((3 === kirbystdlibref.count([1, 2, 3])), "n#"), kirbystdlibref.ensureTest((1 === kirbystdlibref.getProp([1, 2], 0)), "1st"), kirbystdlibref.ensureTest((2 === kirbystdlibref.getProp([1, 2], 1)), "2nd"), kirbystdlibref.ensureTest((3 === kirbystdlibref.getProp([1, 2, 3], 2)), "3rd"), kirbystdlibref.ensureTest((1 === kirbystdlibref.getProp(Array.prototype.slice.call([1, 2], 0, -1), 0)), "slice,a,b"), kirbystdlibref.ensureTest((2 === kirbystdlibref.getProp(Array.prototype.slice.call([1, 2], 1), 0)), "slice,a"), kirbystdlibref.ensureTest((parseFloat("1.2") === 1.2), "float"), kirbystdlibref.ensureTest((parseInt("12") === 12), "int"), kirbystdlibref.ensureTest((function() {
    ...
    (function() {
      ...
      let outer = 0;
      for (let x = 0, GS__7 = 10, ____break = false; ((!____break) && (x < GS__7)); x = (x + 1)) {
        outer += x;
      }
      return outer;
    ...
    return ((5 === kirbystdlibref.count(x)) && ("a" === std.last(x)));
      ...
      for (let GS__10 = 0, GS__9 = false, ____break = false; ((!____break) && ((!GS__9) && (GS__10 < GS__8.length))); GS__10 = (GS__10 + 1)) {
        let x = kirbystdlibref.getProp(GS__8, GS__10);
        let y = (x + 1);
        let z = y;
        if ( (!(x < 7)) ) {
          GS__9 = true;
    ...
    let v = k.toString();
    console.log(v);
    return (s.keyword_QUERY(k) && (v === "czlab.kirby.test.stdlib/hello"));
    ...
    let GS__24 = s.split_DASH_seq([1, 2, 3, 4, 5], 3);
    let x = GS__24[0];
    let y = GS__24[1];
    ...
    }, ["a", 2, "c"])), "get-in"), kirbystdlibref.ensureTest(s.eq_QUERY({
    "a": 1,
    "b": 2
  }, s.merge({
    "a": 1
    ...
    let F__25 = function(a) {
      return (1 + a);
    };
    ret.push(F__25.apply(this, ____args));
    let F__26 = function(b) {
      return (2 + b);
    };
    ...
    return ret;
      ...
      let ____args = Array.prototype.slice.call(arguments);
      let F__27 = function(b, c) {
        return (b + c);
      };
      let R__28 = F__27.apply(this, ____args);
      let F__29 = function(a) {
        return (1 + a);
      };
      let R__30 = F__29(R__28);
      return R__30;
    })(3, 10)), "comp"), kirbystdlibref.ensureTest(s.eq_QUERY([1, 2, "3"], [1, 2, "3"]), "quote"), kirbystdlibref.ensureTest((3 === s.find([2, 4, 8, 3, 6, 7], function() {
      let ____args = Array.prototype.slice.call(arguments);
      return ((!((0 === kirbystdlibref.modulo(____args[0], 2)))));
    })), "find"), kirbystdlibref.ensureTest(s.eq_QUERY([2, 3, 4, 9], s.sort_BANG([3, 9, 4, 2])), "simple sort!"), kirbystdlibref.ensureTest(s.eq_QUERY([{
    "a": 2
  }, {
    "a": 3
  }, {
    ...
    "a": 2
  }])), "object sort!"), kirbystdlibref.ensureTest(s.eq_QUERY([[1, 2, 3], [4, 5, 6], [7, 8]], s.partition(3, [1, 2, 3, 4, 5, 6, 7, 8])), "partition"), kirbystdlibref.ensureTest(s.eq_QUERY(["123", "456", "78"], s.split_DASH_str(3, "12345678")), "split-str"), kirbystdlibref.ensureTest((3 === (function(mo) {
      let bind = mo["bind"];
      let unit = mo["unit"];
      let zero = mo["zero"];
      let ret = function() {
