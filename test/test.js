/*Auto generated by Kirby v1.0.0 - Wed Feb 14 2018 22:47:15 GMT-0800 (PST)
...
var TMPVAR = null;
////////////////////////////////////////////////////////////////////////////////
//fn: [mult3] in file: test.ky, line: 22
const mult3 = function(x) {
  return (3 * x);
};
////////////////////////////////////////////////////////////////////////////////
//fn: [add2] in file: test.ky, line: 23
const add2 = function(x) {
  return (2 + x);
};
////////////////////////////////////////////////////////////////////////////////
//fn: [exlog] in file: test.ky, line: 26
...
const test_DASH_stdlib = function() {
  ...
  return [kirbystdlibref.ensureTest((!(0 === kirbystdlibref.count([1]))), "not empty?"), kirbystdlibref.ensureTest((0 === kirbystdlibref.count([])), "empty?"), kirbystdlibref.ensureTest("abc".startsWith("a"), "string starts?"), kirbystdlibref.ensureTest("abc".endsWith("c"), "string ends?"), kirbystdlibref.ensureTest((3 === kirbystdlibref.count([1, 2, 3])), "n#"), kirbystdlibref.ensureTest((1 === kirbystdlibref.getProp([1, 2], 0)), "1st"), kirbystdlibref.ensureTest((2 === kirbystdlibref.getProp([1, 2], 1)), "2nd"), kirbystdlibref.ensureTest((3 === kirbystdlibref.getProp([1, 2, 3], 2)), "3rd"), kirbystdlibref.ensureTest((1 === kirbystdlibref.getProp(Array.prototype.slice.call([1, 2], 0, -1), 0)), "slice,a,b"), kirbystdlibref.ensureTest((2 === kirbystdlibref.getProp(Array.prototype.slice.call([1, 2], 1), 0)), "slice,a"), kirbystdlibref.ensureTest((parseFloat("1.2") === 1.2), "float"), kirbystdlibref.ensureTest((parseInt("12") === 12), "int"), kirbystdlibref.ensureTest((!std.eq_QMRK(s.keyword(":aaa"), "aaa")), "!eq? keywords"), kirbystdlibref.ensureTest((s.keyword(":aaa") == "aaa"), "match keywords"), kirbystdlibref.ensureTest(("aaa" == "aaa"), "match both keywords"), kirbystdlibref.ensureTest(std.eq_QMRK("aaa", "aaa"), "eq? both keywords"), kirbystdlibref.ensureTest((1 !== 2), "not="), kirbystdlibref.ensureTest((3 != 4), "!="), kirbystdlibref.ensureTest((7 == 7), "=="), kirbystdlibref.ensureTest((8 === 8), "="), kirbystdlibref.ensureTest((4 > 3), ">"), kirbystdlibref.ensureTest((5 >= 5), ">="), kirbystdlibref.ensureTest((4 < 7), "<"), kirbystdlibref.ensureTest((9 <= 9), "<="), kirbystdlibref.ensureTest((3200 === (100 << 2 << 3)), "<<"), kirbystdlibref.ensureTest((40 === (10 << 2)), "<<"), kirbystdlibref.ensureTest((2 === (10 >> 2)), ">>"), kirbystdlibref.ensureTest((6 === (54 >>> 3)), ">>>"), kirbystdlibref.ensureTest((6 === (2 + 2 + 2)), "+"), kirbystdlibref.ensureTest((6 === (12 - 3 - 2 - 1)), "-"), kirbystdlibref.ensureTest((-1 === (-1 * 1)), "-"), kirbystdlibref.ensureTest((1 === (-1 - -2)), "-"), kirbystdlibref.ensureTest((24 === (2 * 3 * 4)), "*"), kirbystdlibref.ensureTest((2 === (12 / 3 / 2)), "/"), kirbystdlibref.ensureTest((2 === (12 / 3 / 2)), "div"), kirbystdlibref.ensureTest((2 === (kirbystdlibref.modulo(-10, 3))), "mod"), kirbystdlibref.ensureTest((1 === (kirbystdlibref.modulo(10, 3))), "mod"), kirbystdlibref.ensureTest((true === (false || false || true)), "or"), kirbystdlibref.ensureTest((false === (true && true && false)), "and"), kirbystdlibref.ensureTest((true === (true && true && true)), "and"), kirbystdlibref.ensureTest((8 === (2 ** 3)), "exp"), kirbystdlibref.ensureTest((1 === (10 % 3)), "rem"), kirbystdlibref.ensureTest((2 === (10 & 3)), "&"), kirbystdlibref.ensureTest((11 === (10 | 3)), "|"), kirbystdlibref.ensureTest((-11 === (~10)), "~"), kirbystdlibref.ensureTest((9 === (10 ^ 3)), "^"), kirbystdlibref.ensureTest(s.eq_QMRK([4, 3], (function() {
    ...
    (function() {
      ...
      let outer = 0;
      for (let x = 0, GS__13 = 10, ____break = false; ((!____break) && (x < GS__13)); x = (x + 1)) {
        (
        outer += x);
      }
      return outer;
    ...
    return ((5 === kirbystdlibref.count(x)) && ("a" === std.last(x)));
      ...
      for (let GS__16 = 0, GS__15 = false, ____break = false; ((!____break) && ((!GS__15) && (GS__16 < GS__14.length))); GS__16 = (GS__16 + 1)) {
        let x = kirbystdlibref.getProp(GS__14, GS__16);
        let y = inc(x);
        let z = y;
        if ( (!(x < 7)) ) {
          (
      ...
      let GS__17 = "hello".slice(0);
      let s = GS__17;
      return ((kirbystdlibref.count(GS__17) > 0) ?
        [s, "!"].join("") :
        null);
    }).call(this)), "if-some+"), kirbystdlibref.ensureTest(("ab" === (function() {
      let GS__18 = "hello".slice(5);
      let s = GS__18;
      return ((kirbystdlibref.count(GS__18) > 0) ?
        [s, "!"].join("") :
        ["ab"].join(""));
      ...
      let GS__23 = "hello".slice(2);
      let s = GS__23;
      return ((kirbystdlibref.count(GS__23) > 0) ?
        (function() {
    ...
    let GS__26 = (new Set([1]));
    std.conj_BANG(GS__26, 2);
    return GS__26;
  }).call(this)), "conj!,set"), kirbystdlibref.ensureTest((2 === kirbystdlibref.count((function() {
      let GS__27 = [];
      std.conj_BANG(GS__27, 1);
      std.conj_BANG(GS__27, 2);
      return GS__27;
    }).call(this))), "doto,conj!"), kirbystdlibref.ensureTest(s.eq_QMRK((new Set([1])), (function() {
    let GS__28 = (new Set([1, 2, 3]));
    std.disj_BANG(GS__28, 2, 3);
    return GS__28;
  }).call(this)), "disj!,set"), kirbystdlibref.ensureTest((2 === kirbystdlibref.getProp([1, 2].map(function() {
      let ____args = Array.prototype.slice.call(arguments);
    ...
    return ((2 === kirbystdlibref.count(x)) && (5 === std.last(x)));
      ...
      (
      TMPVAR = 0);
      let GS__29 = (new Map([["a", 1], ["b", 2], ["c", 3]]));
      let GS__30 = function() {
        let ____args = Array.prototype.slice.call(arguments);
        return (TMPVAR += ____args[0]);
      };
      if (kirbystdlibref.object_QMRK(GS__29)) {
        let GS__31 = GS__29;
        Object.keys(GS__31).forEach(function(p) {
          return GS__30(kirbystdlibref.getProp(GS__31, p), p);
        });
      } else {
        GS__29.forEach(GS__30);
      }
      return TMPVAR;
    ...
    let c = [9, 8, 7];
    let GS__32 = s.pop_BANG(c);
    let a = kirbystdlibref.getIndex(GS__32, 0);
    let b = kirbystdlibref.getIndex(GS__32, 1);
    return ((7 === a) && (2 === kirbystdlibref.count(c)));
  }).call(this), "pop!"), kirbystdlibref.ensureTest((function() {
    let c = [9, 8, 7];
    let GS__33 = s.pop(c);
    let a = kirbystdlibref.getIndex(GS__33, 0);
    let b = kirbystdlibref.getIndex(GS__33, 1);
    ...
    let GS__34 = s.split_DASH_seq([1, 2, 3, 4, 5], 3);
    let x = kirbystdlibref.getIndex(GS__34, 0);
    let y = kirbystdlibref.getIndex(GS__34, 1);
    ...
    let ____args = Array.prototype.slice.call(arguments);
    return ____args[0];
  })), "fillArray,function"), kirbystdlibref.ensureTest(s.eq_QMRK([3, 4], s.copyArray([3, 4, 5, 7], [0, 0])), "copyArray,value"), kirbystdlibref.ensureTest(s.eq_QMRK([2, 5, 7, 6], s.copyArray([2, 5, 7], [3, 4, 9, 6])), "copyArray,value"), kirbystdlibref.ensureTest(s.eq_QMRK((new Map([["a", 1], ["b", 2]])), s.merge((new Map([["a", 1]])), (new Map([["b", 2]])))), "merge"), kirbystdlibref.ensureTest(s.eq_QMRK([1, 2, 4], s.difference([1, 2, 3, 4, 5], [3, 5])), "difference"), kirbystdlibref.ensureTest((50 === s.percent(20, 40)), "percent"), kirbystdlibref.ensureTest(("3.333" === s.toFixed((10 / 3), 3)), "toFixed"), kirbystdlibref.ensureTest(s.eq_QMRK(["aa", "bb", "cc", "dd", "ee", "ff"], s.mapcat(function() {
    let ____args = Array.prototype.slice.call(arguments);
    ...
    let F__35 = function(a) {
      return (1 + a);
    };
    ret.push(F__35.apply(this, ____args));
    let F__36 = function(b) {
      return (2 + b);
    };
    ret.push(F__36.apply(this, ____args));
    return ret;
  })(3)), "juxt"), kirbystdlibref.ensureTest((14 === (function() {
      let ____args = Array.prototype.slice.call(arguments);
      let F__37 = function(b, c) {
        return (b + c);
      };
      let R__38 = F__37.apply(this, ____args);
      let F__39 = function(a) {
        return (1 + a);
      };
      let R__40 = F__39(R__38);
      return R__40;
...
////////////////////////////////////////////////////////////////////////////////
//fn: [xxx] in file: test.ky, line: 553
const xxx = function() {
  return (function() {
    (4 * 5);
    fpp(5);
