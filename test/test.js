/*Auto generated by Kirby v1.5.0 - Mon Mar 24 2025 02:25:56 GMT-0700 (Pacific Daylight Time)
  czlab.kirby.test.stdlib
{"doc" "" "author" "Kenneth Leung"}
*/

const __module_namespace__ = "czlab.kirby.test.stdlib";
const kirbyref = require("@czlab/kirby");
const std = require("@czlab/kirby");
...
const test_DASH_stdlib = function() {
  return kirbyref.vector(kirbyref.ensure_DASH_test((!(0 == kirbyref.count(kirbyref.vec(1)))), "not empty?"), kirbyref.ensure_DASH_test((0 == kirbyref.count(kirbyref.hash_DASH_set())), "empty?"), kirbyref.ensure_DASH_test("abc".startsWith("a"), "string starts?"), kirbyref.ensure_DASH_test("abc".endsWith("c"), "string ends?"), kirbyref.ensure_DASH_test((3 === kirbyref.count(kirbyref.vec(1, 2, 3))), "n#"), kirbyref.ensure_DASH_test((1 === kirbyref.vec(1, 2)[0]), "first"), kirbyref.ensure_DASH_test((2 === kirbyref.vec(1, 2)[1]), "_2"), kirbyref.ensure_DASH_test((3 === kirbyref.vec(1, 2, 3)[2]), "_3"), kirbyref.ensure_DASH_test((1 === kirbyref.getProp(Array.prototype.slice.call(kirbyref.vec(1, 2), 0, -1), 0)), "slice,a,b"), kirbyref.ensure_DASH_test((2 === kirbyref.getProp(Array.prototype.slice.call(kirbyref.vec(1, 2), 1), 0)), "slice,a"), kirbyref.ensure_DASH_test((parseFloat("1.2") === 1.2), "float"), kirbyref.ensure_DASH_test((parseInt("12") === 12), "int"), kirbyref.ensure_DASH_test((!std.eq_QMRK_(s.keyword(":aaa"), "aaa")), "!eq? keywords"), kirbyref.ensure_DASH_test((s.keyword(":aaa") == "aaa"), "match keywords"), kirbyref.ensure_DASH_test(("aaa" == "aaa"), "match both keywords"), kirbyref.ensure_DASH_test(std.eq_QMRK_("aaa", "aaa"), "eq? both keywords"), kirbyref.ensure_DASH_test((1 !== 2), "not="), kirbyref.ensure_DASH_test((3 != 4), "!="), kirbyref.ensure_DASH_test((7 == 7), "=="), kirbyref.ensure_DASH_test((8 === 8), "="), kirbyref.ensure_DASH_test((4 > 3), ">"), kirbyref.ensure_DASH_test((5 >= 5), ">="), kirbyref.ensure_DASH_test((4 < 7), "<"), kirbyref.ensure_DASH_test((9 <= 9), "<="), kirbyref.ensure_DASH_test((3200 === (100 << 2 << 3)), "<<"), kirbyref.ensure_DASH_test((40 === (10 << 2)), "<<"), kirbyref.ensure_DASH_test((2 === (10 >> 2)), ">>"), kirbyref.ensure_DASH_test((6 === (54 >>> 3)), ">>>"), kirbyref.ensure_DASH_test((6 === (2 + 2 + 2)), "+"), kirbyref.ensure_DASH_test((6 === (12 - 3 - 2 - 1)), "-"), kirbyref.ensure_DASH_test((-1 === (-1 * 1)), "-"), kirbyref.ensure_DASH_test((1 === (-1 - -2)), "-"), kirbyref.ensure_DASH_test((24 === (2 * 3 * 4)), "*"), kirbyref.ensure_DASH_test((2 === (12 / 3 / 2)), "/"), kirbyref.ensure_DASH_test((2 === (12 / 3 / 2)), "div"), kirbyref.ensure_DASH_test((2 === (kirbyref.mod(-10, 3))), "mod"), kirbyref.ensure_DASH_test((1 === (kirbyref.mod(10, 3))), "mod"), kirbyref.ensure_DASH_test((true === (false || false || true)), "or"), kirbyref.ensure_DASH_test((false === (true && true && false)), "and"), kirbyref.ensure_DASH_test((true === (true && true && true)), "and"), kirbyref.ensure_DASH_test((8 === (2 ** 3)), "exp"), kirbyref.ensure_DASH_test((1 === (10 % 3)), "rem"), kirbyref.ensure_DASH_test((2 === (10 & 3)), "&"), kirbyref.ensure_DASH_test((11 === (10 | 3)), "|"), kirbyref.ensure_DASH_test((-11 === (~10)), "~"), kirbyref.ensure_DASH_test((9 === (10 ^ 3)), "^"), kirbyref.ensure_DASH_test(s.eq_QMRK_(kirbyref.vec(4, 3), (function() {
    ...
    let GS__21 = kirbyref.vec(3, 4);
    let a = kirbyref.getIndex(GS__21, 0);
    let b = kirbyref.getIndex(GS__21, 1);
    return ((3 === a) && (4 === b));
  }).call(this), "destruct vec"), kirbyref.ensure_DASH_test((function() {
    let GS__22 = kirbyref.vec(3, 4, kirbyref.vec(5, 6));
    let a = kirbyref.getIndex(GS__22, 0);
    let b = kirbyref.getIndex(GS__22, 1);
    let GS__23 = GS__22[2];
    let c = kirbyref.getIndex(GS__23, 0);
    let d = kirbyref.getIndex(GS__23, 1);
    return ((5 === c) && (6 === d));
  }).call(this), "destruct vec,2"), kirbyref.ensure_DASH_test((function() {
    let GS__24 = kirbyref.object("a", 3, "b", 4);
    let a = kirbyref.getProp(GS__24, "a");
    let b = kirbyref.getProp(GS__24, "b");
    return ((3 === a) && (4 === b));
  }).call(this), "destruct obj"), kirbyref.ensure_DASH_test((function() {
    let GS__25 = kirbyref.hash_DASH_map("a", 3, "b", 4);
    let a = kirbyref.getProp(GS__25, "a");
    let b = kirbyref.getProp(GS__25, "b");
    return ((3 === a) && (4 === b));
  }).call(this), "destruct map"), kirbyref.ensure_DASH_test(s.eq_QMRK_(kirbyref.vec(1, 2, 3, 4, 5), (function(a, GS__26, GS__27) {
    let b = kirbyref.getIndex(GS__26, 0);
    let c = kirbyref.getIndex(GS__26, 1);
    let d = kirbyref.getProp(GS__27, "d");
    let e = kirbyref.getProp(GS__27, "e");
    ...
    return ((5 === kirbyref.count(x)) && ("a" === std.last(x)));
      ...
      (
      TMPVAR = 0);
      for (let GS__34 = 0, GS__32 = true, GS__33 = (function() {
            let ret = kirbyref.list();
            for (let ____coll = null, i = 0, ____end = 10, ____break = false; ((!____break) && (i < ____end)); i = (i + 1)) {
              ret.push(i);
            }
            return ret;
          }).call(this), ____sz = kirbyref.count(GS__33), ____break = false; (!____break && GS__32 && (GS__34 < ____sz)); ++GS__34) {
        let x = GS__33[GS__34];
        let y = (1 + x);
        let z = y;
        if (!((x < 7))) {
    ...
    (
    TMPVAR = kirbyref.vec());
    for (let GS__41 = 0, GS__35 = true, GS__40 = kirbyref.vec(1, 2), ____sz = kirbyref.count(GS__40); (GS__35 && (GS__41 < ____sz)); ++GS__41) {
      let x = GS__40[GS__41];
      for (let GS__39 = 0, GS__38 = kirbyref.vec(3, 1), ____sz = kirbyref.count(GS__38); (GS__35 && (GS__39 < ____sz)); ++GS__39) {
        let y = GS__38[GS__39];
        for (let GS__37 = 0, GS__36 = kirbyref.vec(7), ____sz = kirbyref.count(GS__36), ____break = false; (!____break && GS__35 && (GS__37 < ____sz)); ++GS__37) {
          let z = GS__36[GS__37];
    ...
    let GS__42 = [];
    for (let GS__49 = 0, GS__43 = true, GS__48 = kirbyref.vec(1, 2), ____sz = kirbyref.count(GS__48); (GS__43 && (GS__49 < ____sz)); ++GS__49) {
      let x = GS__48[GS__49];
      for (let GS__47 = 0, GS__46 = kirbyref.vec(3, 1), ____sz = kirbyref.count(GS__46); (GS__43 && (GS__47 < ____sz)); ++GS__47) {
        let y = GS__46[GS__47];
        for (let GS__45 = 0, GS__44 = kirbyref.vec(7), ____sz = kirbyref.count(GS__44), ____break = false; (!____break && GS__43 && (GS__45 < ____sz)); ++GS__45) {
          let z = GS__44[GS__45];
          GS__42.push((function() {
    ...
    return GS__42;
      ...
      let GS__56 = "hello".slice(2);
      let s = GS__56;
      return ((kirbyref.count(GS__56) > 0) ?
        (function() {
          kirbyref.count(s);
      ...
      let GS__57 = "hello";
      let s = GS__57;
      return ((!((typeof (GS__57) == "undefined") || (GS__57 === null))) ?
        (function() {
          kirbyref.count(s);
          return kirbyref.vector("he", s).join("");
        }).call(this) :
    ...
    let GS__59 = kirbyref.hash_DASH_set(1);
    std.conj_BANG_(GS__59, 2);
    return GS__59;
  }).call(this)), "conj!,set"), kirbyref.ensure_DASH_test((2 === kirbyref.count((function() {
      let GS__60 = kirbyref.vec();
      std.conj_BANG_(GS__60, 1);
      std.conj_BANG_(GS__60, 2);
      return GS__60;
    }).call(this))), "doto,conj!"), kirbyref.ensure_DASH_test(s.eq_QMRK_(kirbyref.hash_DASH_set(1), (function() {
    let GS__61 = kirbyref.hash_DASH_set(1, 2, 3);
    std.disj_BANG_(GS__61, 2, 3);
    return GS__61;
  }).call(this)), "disj!,set"), kirbyref.ensure_DASH_test((2 === (kirbyref.vec(1, 2) || kirbyref.vector()).map(function(GS__3__1) {
      return (1 + GS__3__1);
    })[0]), "map"), kirbyref.ensure_DASH_test((2 === kirbyref.count((kirbyref.vec(1, 2, 8) || kirbyref.vector()).filter(function(GS__4__1) {
      return (0 == kirbyref.mod(GS__4__1, 2));
    }))), "filter"), kirbyref.ensure_DASH_test((true === (kirbyref.vec(1, 2, 8) || kirbyref.vector()).some(function(GS__5__1) {
      return (0 != kirbyref.mod(GS__5__1, 2));
    ...
    return ((2 === kirbyref.count(x)) && (5 === std.last(x)));
      ...
      (
      TMPVAR = 0);
      kirbyref.vec(1, 2, 3).forEach(function(GS__6__1) {
        return (TMPVAR += GS__6__1);
      });
      return TMPVAR;
      ...
      TMPVAR = 0);
      if (true) {
        let GS__62 = kirbyref.hash_DASH_map("a", 1, "b", 2, "c", 3);
        let GS__63 = function(GS__7__1) {
          return (TMPVAR += GS__7__1);
        };
        if (kirbyref.object_QMRK_(GS__62)) {
          if (true) {
            let GS__64 = GS__62;
            Object.keys(GS__64).forEach(function(p) {
              return GS__63(kirbyref.getProp(GS__64, p), p);
            });
          }
        } else {
          GS__62.forEach(GS__63)
        }
      }
      return TMPVAR;
    ...
    let GS__65 = s.pop_BANG_(c);
    let a = kirbyref.getIndex(GS__65, 0);
    let b = kirbyref.getIndex(GS__65, 1);
    return ((7 === a) && (2 === kirbyref.count(c)));
  }).call(this), "pop!"), kirbyref.ensure_DASH_test((function() {
    let c = kirbyref.vec(9, 8, 7);
    let GS__66 = s.pop(c);
    let a = kirbyref.getIndex(GS__66, 0);
    let b = kirbyref.getIndex(GS__66, 1);
    ...
    let GS__67 = s.split_DASH_seq(kirbyref.vec(1, 2, 3, 4, 5), 3);
    let x = kirbyref.getIndex(GS__67, 0);
    let y = kirbyref.getIndex(GS__67, 1);
    ...
    return (old + n);
  }, 5)), "update-in"), kirbyref.ensure_DASH_test((4 === s.get_DASH_in(kirbyref.hash_DASH_map("a", kirbyref.vec(2, 4, kirbyref.hash_DASH_map("c", 4))), kirbyref.vec("a", 2, "c"))), "get-in"), kirbyref.ensure_DASH_test(s.eq_QMRK_(kirbyref.vec(7, 7, 7), s.fill_DASH_array(3, 7)), "fill-array,value"), kirbyref.ensure_DASH_test(s.eq_QMRK_(kirbyref.vec(0, 1, 2), s.fill_DASH_array(3, function(GS__8__1) {
    return kirbyref.identity(GS__8__1);
    ...
    })(3, 10)), "comp"), kirbyref.ensure_DASH_test(s.eq_QMRK_(kirbyref.vec(1, 2, "3"), kirbyref.vector(1, 2, "3")), "quote"), kirbyref.ensure_DASH_test((3 === (kirbyref.vec(2, 4, 8, 3, 6, 7) || kirbyref.vector()).find(function(GS__11__1) {
      return (0 != kirbyref.mod(GS__11__1, 2));
  ...
  }).call(this), "object,Map"), kirbyref.ensure_DASH_test((698 === s.max_DASH_by(s.identity, kirbyref.vec(78, 7, 698, 4, 5, 2, -1))), "max-by"), kirbyref.ensure_DASH_test((-1 === s.min_DASH_by(s.identity, kirbyref.vec(78, 7, 6, 4, 5, 2, -1))), "min-by"), kirbyref.ensure_DASH_test(s.eq_QMRK_(kirbyref.vec(-2, -1), take_DASH_while(function(GS__12__1) {
    return (GS__12__1 < 0);
  }, kirbyref.vec(-2, -1, 0, 1, 2, 3))), "take-while"), kirbyref.ensure_DASH_test(s.eq_QMRK_(kirbyref.vec(), take_DASH_while(function(GS__13__1) {
    return (GS__13__1 < 0);
  }, kirbyref.vec(0, 1, 2, 3))), "take-while"), kirbyref.ensure_DASH_test(s.eq_QMRK_(kirbyref.vec(3, 4, 5, 6), drop_DASH_while(function(GS__14__1) {
    return (3 > GS__14__1);
  }, kirbyref.vec(1, 2, 3, 4, 5, 6))), "drop-while"), kirbyref.ensure_DASH_test(s.eq_QMRK_(kirbyref.vec(4, 5, 6), drop_DASH_while(function(GS__15__1) {
    return (3 >= GS__15__1);
  }, kirbyref.vec(1, 2, 3, 4, 5, 6))), "drop-while"), kirbyref.ensure_DASH_test(s.eq_QMRK_(kirbyref.vec(kirbyref.vec(1, 2, 3), kirbyref.vec(4, 5)), split_DASH_with(function(GS__16__1) {
    return (3 >= GS__16__1);
  }, kirbyref.vec(1, 2, 3, 4, 5))), "split-with"), kirbyref.ensure_DASH_test(s.eq_QMRK_(kirbyref.vec(kirbyref.vec(1, 2), kirbyref.vec(3, 2, 1)), split_DASH_with(function(GS__17__1) {
    return (3 > GS__17__1);
  }, kirbyref.vec(1, 2, 3, 2, 1))), "split-with"), kirbyref.ensure_DASH_test(s.eq_QMRK_(kirbyref.vec(kirbyref.vec(1, 2, 3, 2, 1), kirbyref.vec()), split_DASH_with(function(GS__18__1) {
    return (10 > GS__18__1);
      ...
      let unit = mo.unit;
      let zero = mo.zero;
      let ret = function(GS__1__1) {
        return ((kirbyref.nichts_QMRK_(GS__1__1) && kirbyref.some_QMRK_(zero)) ?
          zero :
          unit(GS__1__1));
      };
