/*Auto generated by Kirby v1.0.0 - Tue Jan 23 2018 02:38:03 GMT-0800 (PST)
...
const test_DASH_stdlib = function() {
  ...
  return [kirbystdlibref.ensureTest((!(0 === kirbystdlibref.count([1]))), "not empty?"), kirbystdlibref.ensureTest((0 === kirbystdlibref.count([])), "empty?"), kirbystdlibref.ensureTest("abc".startsWith("a"), "string starts?"), kirbystdlibref.ensureTest("abc".endsWith("c"), "string ends?"), kirbystdlibref.ensureTest((3 === kirbystdlibref.count([1, 2, 3])), "n#"), kirbystdlibref.ensureTest((1 === kirbystdlibref.getProp([1, 2], 0)), "1st"), kirbystdlibref.ensureTest((2 === kirbystdlibref.getProp([1, 2], 1)), "2nd"), kirbystdlibref.ensureTest((3 === kirbystdlibref.getProp([1, 2, 3], 2)), "3rd"), kirbystdlibref.ensureTest((1 === kirbystdlibref.getProp(Array.prototype.slice.call([1, 2], 0, -1), 0)), "slice,a,b"), kirbystdlibref.ensureTest((2 === kirbystdlibref.getProp(Array.prototype.slice.call([1, 2], 1), 0)), "slice,a"), kirbystdlibref.ensureTest((parseFloat("1.2") === 1.2), "float"), kirbystdlibref.ensureTest((parseInt("12") === 12), "int"), kirbystdlibref.ensureTest((!std.eq_QMRK(s.keyword(":aaa"), "aaa")), "!eq? keywords"), kirbystdlibref.ensureTest((s.keyword(":aaa") == "aaa"), "match keywords"), kirbystdlibref.ensureTest(("aaa" == "aaa"), "match both keywords"), kirbystdlibref.ensureTest(std.eq_QMRK("aaa", "aaa"), "eq? both keywords"), kirbystdlibref.ensureTest((function() {
    ...
    }, ["a", 2, "c"])), "get-in"), kirbystdlibref.ensureTest(s.eq_QMRK({
    "a": 1,
    "b": 2
  }, s.merge({
    "a": 1
    ...
    "a": 2
  }])), "object sort!"), kirbystdlibref.ensureTest(s.eq_QMRK([[1, 2, 3], [4, 5, 6], [7, 8]], s.partition(3, [1, 2, 3, 4, 5, 6, 7, 8])), "partition"), kirbystdlibref.ensureTest(s.eq_QMRK(["123", "456", "78"], s.split_DASH_str(3, "12345678")), "split-str"), kirbystdlibref.ensureTest((3 === (function(mo) {
      let bind = mo["bind"];
      let unit = mo["unit"];
      let zero = mo["zero"];
      let ret = function() {
...
class POO_BANG {
  ////////////////////////////////////////////////////////////////////////////////
  //fn: [yoo?] in file: test.ky, line: 450
  yoo_QMRK() {
    return null;
  }
}
