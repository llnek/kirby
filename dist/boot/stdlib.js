/*Auto generated by Kirby - v1.0.0 czlab.kirby.stdlib Wed Dec 13 2017 23:11:20 GMT-0800 (PST)*/
  ...
  return (function() {
    ...
    switch (typeid(obj)) {
      case "lambda-arg":
        ...
        break;
      case "atom":
        S____2 = ["(atom ", prn(obj.value), ")"].join("");
        break;
      case "keyword":
...
class Keyword {
  ////////////////////////////////////////////////////////////////////////////////
  //name: [constructor] in file: stdlib.ky near line: 129
  constructor(name) {
    this["value"] = "";
  ...
  ////////////////////////////////////////////////////////////////////////////////
  //name: [toString] in file: stdlib.ky near line: 131
  toString() {
    return this.value;
  }
}
...
class Symbol {
  ////////////////////////////////////////////////////////////////////////////////
  //name: [constructor] in file: stdlib.ky near line: 136
  constructor(name) {
    this["value"] = "";
    this.value = name;
    return this;
  ...
  ////////////////////////////////////////////////////////////////////////////////
  //name: [toString] in file: stdlib.ky near line: 138
  toString() {
    return this.value;
  }
}
////////////////////////////////////////////////////////////////////////////////
//name: [primitive?] in file: stdlib.ky near line: 141
//Returns true if primitive
const primitive_QUERY = function(obj) {
  return (obj instanceof Primitive);
};
////////////////////////////////////////////////////////////////////////////////
//name: [primitive] in file: stdlib.ky near line: 145
//Create a Primitive
const primitive = function(v) {
  return new Primitive(v);
};
////////////////////////////////////////////////////////////////////////////////
//name: [symbol?] in file: stdlib.ky near line: 149
//Returns true if a symbol
const symbol_QUERY = function(obj) {
  return (obj instanceof Symbol);
};
////////////////////////////////////////////////////////////////////////////////
//name: [symbol] in file: stdlib.ky near line: 153
//Create a new Symbol
const symbol = function(name) {
  return new Symbol(name);
};
////////////////////////////////////////////////////////////////////////////////
//name: [keyword?] in file: stdlib.ky near line: 157
//Returns true if a keyword
const keyword_QUERY = function(obj) {
  return (obj instanceof Keyword);
};
////////////////////////////////////////////////////////////////////////////////
//name: [keyword] in file: stdlib.ky near line: 161
//Create a new Keyword
const keyword = function(name) {
  return new Keyword(name);
};
////////////////////////////////////////////////////////////////////////////////
//name: [lambda-arg?] in file: stdlib.ky near line: 165
//Returns true if a Lambda Arg
const lambda_DASH_arg_QUERY = function(obj) {
  return (obj instanceof LambdaArg);
};
////////////////////////////////////////////////////////////////////////////////
//name: [lambda-arg] in file: stdlib.ky near line: 169
...
class Atom {
  ////////////////////////////////////////////////////////////////////////////////
  //name: [constructor] in file: stdlib.ky near line: 175
  constructor(val) {
    this["value"] = null;
    this.value = val;
    return this;
...
////////////////////////////////////////////////////////////////////////////////
//name: [atom?] in file: stdlib.ky near line: 178
//Returns true if an Atom
const atom_QUERY = function(atm) {
  return (atm instanceof Atom);
};
////////////////////////////////////////////////////////////////////////////////
//name: [atom] in file: stdlib.ky near line: 182
//Create a new Atom
const atom = function(val) {
  return new Atom(val);
};
////////////////////////////////////////////////////////////////////////////////
//name: [reset!] in file: stdlib.ky near line: 186
//Set a new value to the Atom
const reset_BANG = function(a, v) {
  return a.value = v;
};
////////////////////////////////////////////////////////////////////////////////
//name: [deref] in file: stdlib.ky near line: 190
//Get value inside the Atom
const deref = function(a) {
  return a.value;
};
////////////////////////////////////////////////////////////////////////////////
//name: [swap!] in file: stdlib.ky near line: 194
...
////////////////////////////////////////////////////////////////////////////////
//name: [typeid] in file: stdlib.ky near line: 202
//Returns the type-id
//of this object
...
////////////////////////////////////////////////////////////////////////////////
//name: [value?] in file: stdlib.ky near line: 225
//Returns true
//if a simple value
...
////////////////////////////////////////////////////////////////////////////////
//name: [sequential?] in file: stdlib.ky near line: 238
...
////////////////////////////////////////////////////////////////////////////////
//name: [eq?] in file: stdlib.ky near line: 244
...
////////////////////////////////////////////////////////////////////////////////
//name: [object?] in file: stdlib.ky near line: 281
//Returns true
//if a js object
...
////////////////////////////////////////////////////////////////////////////////
//name: [last] in file: stdlib.ky near line: 288
...
////////////////////////////////////////////////////////////////////////////////
//name: [into!] in file: stdlib.ky near line: 294
...
////////////////////////////////////////////////////////////////////////////////
//name: [into] in file: stdlib.ky near line: 305
//Like into! but
...
////////////////////////////////////////////////////////////////////////////////
//name: [pairs?] in file: stdlib.ky near line: 311
//Returns true if
...
////////////////////////////////////////////////////////////////////////////////
//name: [seq] in file: stdlib.ky near line: 346
//Returns a sequence
...
////////////////////////////////////////////////////////////////////////////////
//name: [contains?] in file: stdlib.ky near line: 354
//Returns true
//if item is inside
...
////////////////////////////////////////////////////////////////////////////////
//name: [nichts?] in file: stdlib.ky near line: 364
...
////////////////////////////////////////////////////////////////////////////////
//name: [some?] in file: stdlib.ky near line: 369
//Returns true if object is
...
////////////////////////////////////////////////////////////////////////////////
//name: [count] in file: stdlib.ky near line: 374
...
////////////////////////////////////////////////////////////////////////////////
//name: [concat*] in file: stdlib.ky near line: 381
...
////////////////////////////////////////////////////////////////////////////////
//name: [every] in file: stdlib.ky near line: 386
...
////////////////////////////////////////////////////////////////////////////////
//name: [evens] in file: stdlib.ky near line: 394
//Collect every
...
////////////////////////////////////////////////////////////////////////////////
//name: [odds] in file: stdlib.ky near line: 399
//Collect every
...
////////////////////////////////////////////////////////////////////////////////
//name: [modulo] in file: stdlib.ky near line: 404
//Modulo
...
////////////////////////////////////////////////////////////////////////////////
//name: [interleave] in file: stdlib.ky near line: 412
...
////////////////////////////////////////////////////////////////////////////////
//name: [zipmap] in file: stdlib.ky near line: 425
...
////////////////////////////////////////////////////////////////////////////////
//name: [extendAttr] in file: stdlib.ky near line: 439
...
////////////////////////////////////////////////////////////////////////////////
//name: [gensym] in file: stdlib.ky near line: 448
//Generates next random symbol
const gensym = function() {
  let G____6 = Array.prototype.slice.call(arguments, 0);
  let pfx = G____6[0];
...
////////////////////////////////////////////////////////////////////////////////
//name: [slice] in file: stdlib.ky near line: 455
const slice = function(coll) {
  let G____7 = Array.prototype.slice.call(arguments, 1);
  let start = G____7[0];
  let end = G____7[1];
...
////////////////////////////////////////////////////////////////////////////////
//name: [assoc!] in file: stdlib.ky near line: 463
...
////////////////////////////////////////////////////////////////////////////////
//name: [dissoc!] in file: stdlib.ky near line: 472
...
////////////////////////////////////////////////////////////////////////////////
//name: [wrap-str] in file: stdlib.ky near line: 523
...
////////////////////////////////////////////////////////////////////////////////
//name: [unwrap-str] in file: stdlib.ky near line: 540
...
////////////////////////////////////////////////////////////////////////////////
//name: [escXml] in file: stdlib.ky near line: 564
