/*Auto generated by Kirby - v1.0.0 czlab.kirby.compiler Mon Dec 18 2017 23:59:25 GMT-0800 (PST)*/
      ...
      if (cmd.startsWith(".@")) {
        ...
        if (cmd.startsWith(".")) {
          ...
          if (some_QUERY(op)) {
            ...
            if ( (((cmd == "splice-unquote") || (cmd == "unquote") || (cmd == "syntax-quote")) && (!nsp.startsWith("czlab.kirby."))) ) {
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-deref] in file: compiler.ky near line: 536
const sf_DASH_deref = function(ast, env) {
  assertArity((kirbystdlibref.count(ast) === 2), ast);
  let ret = node_QTE(ast);
  ret.add([tx_STAR(ast[1], env), ".value"]);
  return ret;
};
SPEC_DASH_OPS["deref"] = sf_DASH_deref;
////////////////////////////////////////////////////////////////////////////////
//name: [sf-compose] in file: compiler.ky near line: 544
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-quote] in file: compiler.ky near line: 563
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-deftype] in file: compiler.ky near line: 570
//Define a JS Class
...
SPEC_DASH_OPS["deftype-"] = sf_DASH_deftype;
////////////////////////////////////////////////////////////////////////////////
//name: [sf-compOp] in file: compiler.ky near line: 612
...
SPEC_DASH_OPS["<="] = sf_DASH_compOp;
////////////////////////////////////////////////////////////////////////////////
//name: [sf-arithOp] in file: compiler.ky near line: 630
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-do] in file: compiler.ky near line: 663
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-case] in file: compiler.ky near line: 676
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-vardefs] in file: compiler.ky near line: 710
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-var] in file: compiler.ky near line: 733
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-inst?] in file: compiler.ky near line: 771
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-delete] in file: compiler.ky near line: 779
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-new] in file: compiler.ky near line: 790
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-throw] in file: compiler.ky near line: 797
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-x-opop] in file: compiler.ky near line: 809
...
SPEC_DASH_OPS["--$"] = sf_DASH_x_DASH_opop;
////////////////////////////////////////////////////////////////////////////////
//name: [sf-x-eq] in file: compiler.ky near line: 820
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-assoc!] in file: compiler.ky near line: 851
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-set] in file: compiler.ky near line: 868
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-fn] in file: compiler.ky near line: 883
//(fn [x y] ...)
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-func] in file: compiler.ky near line: 900
...
SPEC_DASH_OPS["defn-"] = sf_DASH_func;
////////////////////////////////////////////////////////////////////////////////
//name: [sf-try] in file: compiler.ky near line: 945
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-if] in file: compiler.ky near line: 989
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-get] in file: compiler.ky near line: 1009
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-array] in file: compiler.ky near line: 1017
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-object] in file: compiler.ky near line: 1033
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-include] in file: compiler.ky near line: 1050
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-require] in file: compiler.ky near line: 1078
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-ns] in file: compiler.ky near line: 1116
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-comment] in file: compiler.ky near line: 1147
const sf_DASH_comment = function(ast, env) {
  return "";
};
SPEC_DASH_OPS["comment"] = sf_DASH_comment;
////////////////////////////////////////////////////////////////////////////////
//name: [sf-for] in file: compiler.ky near line: 1150
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-floop] in file: compiler.ky near line: 1162
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-jscode] in file: compiler.ky near line: 1202
...
////////////////////////////////////////////////////////////////////////////////
//name: [sf-macro] in file: compiler.ky near line: 1212
const sf_DASH_macro = function(ast, env) {
  ...
  eng.compute([kirbystdlibref.symbol("macro*"), ast[1], pms, body[0]], env);
  return "";
};
SPEC_DASH_OPS["defmacro"] = sf_DASH_macro;
////////////////////////////////////////////////////////////////////////////////
//name: [sf-unary] in file: compiler.ky near line: 1241
...
SPEC_DASH_OPS["!"] = sf_DASH_unary;
////////////////////////////////////////////////////////////////////////////////
//name: [xfi] in file: compiler.ky near line: 1250
...
////////////////////////////////////////////////////////////////////////////////
//name: [spitExterns] in file: compiler.ky near line: 1264
...
////////////////////////////////////////////////////////////////////////////////
//name: [banner] in file: compiler.ky near line: 1271
const banner = function() {
  return ["/*", "Auto generated by Kirby - v", MODULE_DASH_VERSION, " ", eng.globalEnv().firstNSP(), " - ", new Date(), "*/\n\n"].join("");
};
////////////////////////////////////////////////////////////////////////////////
//name: [cleanCode] in file: compiler.ky near line: 1277
...
////////////////////////////////////////////////////////////////////////////////
//name: [transpile*] in file: compiler.ky near line: 1286
...
////////////////////////////////////////////////////////////////////////////////
//name: [transpile] in file: compiler.ky near line: 1316
...
////////////////////////////////////////////////////////////////////////////////
//name: [dbgAST] in file: compiler.ky near line: 1323
