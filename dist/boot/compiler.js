/*Auto generated by Kirby - v1.0.0 czlab.kirby.compiler Sat Dec 16 2017 22:57:09 GMT-0800 (PST)*/
...
const txPairs = function(ast, env) {
  ...
  xfi(e1, ast);
  if (mc) {
    (ast = eng.inflateMacro(ast, env, mc), ast = xfi(orig, exprHint(ast, (!stmtQ))));
    spreadInfo(orig, ast);
    cmd = gcmd(ast);
  }
