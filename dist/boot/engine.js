/*Auto generated by Kirby - v1.0.0 czlab.kirby.engine Sun Dec 17 2017 03:04:50 GMT-0800 (PST)*/
...
////////////////////////////////////////////////////////////////////////////////
//name: [expand??] in file: engine.ky near line: 394
...
////////////////////////////////////////////////////////////////////////////////
//name: [doAND] in file: engine.ky near line: 436
...
////////////////////////////////////////////////////////////////////////////////
//name: [doOR] in file: engine.ky near line: 444
...
////////////////////////////////////////////////////////////////////////////////
//name: [doLET] in file: engine.ky near line: 452
...
////////////////////////////////////////////////////////////////////////////////
//name: [doMACRO] in file: engine.ky near line: 462
...
////////////////////////////////////////////////////////////////////////////////
//name: [doTRY] in file: engine.ky near line: 474
...
////////////////////////////////////////////////////////////////////////////////
//name: [doIF] in file: engine.ky near line: 490
...
////////////////////////////////////////////////////////////////////////////////
//name: [form*] in file: engine.ky near line: 499
...
////////////////////////////////////////////////////////////////////////////////
//name: [fn->raw] in file: engine.ky near line: 514
...
////////////////////////////////////////////////////////////////////////////////
//name: [compute] in file: engine.ky near line: 537
...
const compute = function(expr, cenv) {
  ...
  let ret = (function() {
    ...
    let _f_ = function(ast) {
      let cmd = [g1(ast)].join("");
      let fc = _STAR_spec_DASH_forms_STAR[cmd];
      let res = ((!Array.isArray(ast)) ?
        ...
        ((0 === kirbystdlibref.count(ast)) ?
          ...
          ((typeof (fc) === "function") ?
            fc(ast, env) :
            (true ?
              atom(form_STAR(ast, env)) :
              null))));
      return (atom_QUERY(res) ?
        res :
        (function() {
          env = res[1];
          return recur(expand_QUERY__QUERY(res[0], env));
        }).call(this));
    };
    let _r_ = _f_;
    recur = function() {
...
////////////////////////////////////////////////////////////////////////////////
//name: [newEnv] in file: engine.ky near line: 559
...
////////////////////////////////////////////////////////////////////////////////
//name: [runRepl] in file: engine.ky near line: 565
...
////////////////////////////////////////////////////////////////////////////////
//name: [reval] in file: engine.ky near line: 581
...
var g_env = null;
////////////////////////////////////////////////////////////////////////////////
//name: [init] in file: engine.ky near line: 590
...
////////////////////////////////////////////////////////////////////////////////
//name: [globalEnv] in file: engine.ky near line: 599
