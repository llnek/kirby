/*Auto generated by Kirby - v1.0.0 czlab.kirby.engine Sat Dec 16 2017 22:57:08 GMT-0800 (PST)*/
...
const prefix = "kirby> ";
////////////////////////////////////////////////////////////////////////////////
//name: [expect!] in file: engine.ky near line: 52
...
class LEXEnv {
  ////////////////////////////////////////////////////////////////////////////////
  //name: [constructor] in file: engine.ky near line: 60
  ...
  ////////////////////////////////////////////////////////////////////////////////
  //name: [find] in file: engine.ky near line: 80
  //Find the env
  ...
  ////////////////////////////////////////////////////////////////////////////////
  //name: [set] in file: engine.ky near line: 87
  //Bind this symbol,
  //value to this env
  set(k, v) {
    expect_BANG(k);
  ...
  ////////////////////////////////////////////////////////////////////////////////
  //name: [get] in file: engine.ky near line: 92
  //Get value of
  //this symbol
  get(k) {
    expect_BANG(k);
  ...
  ////////////////////////////////////////////////////////////////////////////////
  //name: [select] in file: engine.ky near line: 98
  select(what) {
  ...
  ////////////////////////////////////////////////////////////////////////////////
  //name: [prn] in file: engine.ky near line: 105
  //Print set of vars
  prn() {
    return std.prn(this.data);
  }
  ////////////////////////////////////////////////////////////////////////////////
  //name: [pushNSP] in file: engine.ky near line: 108
  //Add a namespace
  pushNSP(nsp) {
    conj_BANG(this.nspaces, [nsp].join(""));
    return null;
  }
  ////////////////////////////////////////////////////////////////////////////////
  //name: [peekNSP] in file: engine.ky near line: 111
  //Returns the
  ...
  ////////////////////////////////////////////////////////////////////////////////
  //name: [popNSP] in file: engine.ky near line: 115
  //Return and remove
  ...
  ////////////////////////////////////////////////////////////////////////////////
  //name: [firstNSP] in file: engine.ky near line: 119
  //Get the first
  //added namespace
  firstNSP() {
  ...
  ////////////////////////////////////////////////////////////////////////////////
  //name: [countNSPCache] in file: engine.ky near line: 123
  //Count n# of
  //added namespaces
  countNSPCache() {
  ...
  ////////////////////////////////////////////////////////////////////////////////
  //name: [resetNSPCache] in file: engine.ky near line: 127
...
////////////////////////////////////////////////////////////////////////////////
//name: [Function.prototype.clone] in file: engine.ky near line: 135
...
////////////////////////////////////////////////////////////////////////////////
//name: [prnStr] in file: engine.ky near line: 143
...
////////////////////////////////////////////////////////////////////////////////
//name: [prnLn] in file: engine.ky near line: 146
...
////////////////////////////////////////////////////////////////////////////////
//name: [slurp] in file: engine.ky near line: 149
const slurp = function(f) {
  return fs.readFileSync(f, "utf-8");
};
////////////////////////////////////////////////////////////////////////////////
//name: [spit] in file: engine.ky near line: 152
const spit = function(f, s) {
  fs.writeFileSync(f, s, "utf-8");
  return null;
};
////////////////////////////////////////////////////////////////////////////////
//name: [clone] in file: engine.ky near line: 155
  ...
  return (function() {
    ...
    switch (oid) {
      ...
      case "array":
        ...
        break;
      case "object":
        S____7 = seq(obj).reduce(function(acc, G____8) {
          let k = G____8[0];
          let v = G____8[1];
          acc[k] = v;
          return acc;
...
////////////////////////////////////////////////////////////////////////////////
//name: [cons] in file: engine.ky near line: 172
const cons = function(a, b) {
  return [a].concat(b);
};
////////////////////////////////////////////////////////////////////////////////
//name: [conj] in file: engine.ky near line: 175
...
////////////////////////////////////////////////////////////////////////////////
//name: [fapply] in file: engine.ky near line: 187
const fapply = function(f) {
  let xs = Array.prototype.slice.call(arguments, 1);
  return f.apply(this, xs);
};
////////////////////////////////////////////////////////////////////////////////
//name: [fmap] in file: engine.ky near line: 190
const fmap = function(f, arr) {
  return arr.map(f);
};
////////////////////////////////////////////////////////////////////////////////
//name: [resolveJS] in file: engine.ky near line: 193
...
////////////////////////////////////////////////////////////////////////////////
//name: [filterJS] in file: engine.ky near line: 201
...
////////////////////////////////////////////////////////////////////////////////
//name: [withMeta] in file: engine.ky near line: 206
...
////////////////////////////////////////////////////////////////////////////////
//name: [meta] in file: engine.ky near line: 211
...
////////////////////////////////////////////////////////////////////////////////
//name: [evalJS] in file: engine.ky near line: 219
const evalJS = function(s) {
  return filterJS(eval(s.toString()));
};
////////////////////////////////////////////////////////////////////////////////
//name: [invokeJS] in file: engine.ky near line: 223
const invokeJS = function(method) {
  let xs = Array.prototype.slice.call(arguments, 1);
  let G____9 = resolveJS(method);
  let obj = G____9[0];
  let f = G____9[1];
...
const _STAR_runtime_DASH_funcs_STAR = {
  "macroexpand*": function(code) {
    ...
    let env = G____10[0];
    return (console ?
      console.log([std.prn(inflateMacro(code, (env || g_env)))].join("")) :
      null);
  },
  "macros*": function() {
    let G____11 = Array.prototype.slice.call(arguments, 0);
    let fout = G____11[0];
    let s = std.prn(CACHE);
    return (fout ?
      spit(fout, s) :
...
const CACHE = {};
////////////////////////////////////////////////////////////////////////////////
//name: [loadMacros] in file: engine.ky near line: 322
...
////////////////////////////////////////////////////////////////////////////////
//name: [setMacro] in file: engine.ky near line: 328
...
////////////////////////////////////////////////////////////////////////////////
//name: [getMacro] in file: engine.ky near line: 340
//Get macro
...
////////////////////////////////////////////////////////////////////////////////
//name: [dbg] in file: engine.ky near line: 355
...
////////////////////////////////////////////////////////////////////////////////
//name: [readAST] in file: engine.ky near line: 358
//Returns the AST
...
////////////////////////////////////////////////////////////////////////////////
//name: [isList?] in file: engine.ky near line: 365
//Returns true
//if a non-empty list
...
////////////////////////////////////////////////////////////////////////////////
//name: [backtick] in file: engine.ky near line: 371
      ...
      ((isList_QUERY(ast[0]) && (ast[0][0] == "splice-unquote")) ?
        ...
        (true ?
          (function() {
            let a0 = ast[0];
            let a1 = ast.slice(1);
            return [kirbystdlibref.symbol("cons*"), backtick(a0), backtick(a1)];
          }).call(this) :
          null))));
};
////////////////////////////////////////////////////////////////////////////////
//name: [isMacroCall?] in file: engine.ky near line: 388
const isMacroCall_QUERY = function(ast, env) {
  return (pairs_QUERY(ast) && symbol_QUERY(ast[0]) && getMacro([ast[0]].join("")));
};
////////////////////////////////////////////////////////////////////////////////
//name: [inflateMacro] in file: engine.ky near line: 394
...
////////////////////////////////////////////////////////////////////////////////
//name: [eval*] in file: engine.ky near line: 404
...
////////////////////////////////////////////////////////////////////////////////
//name: [handleAND] in file: engine.ky near line: 436
...
////////////////////////////////////////////////////////////////////////////////
//name: [handleOR] in file: engine.ky near line: 444
...
////////////////////////////////////////////////////////////////////////////////
//name: [handleLet] in file: engine.ky near line: 452
...
////////////////////////////////////////////////////////////////////////////////
//name: [handleMacro] in file: engine.ky near line: 462
const handleMacro = function(ast, env) {
  let rc = [ast[0], ast[1], [kirbystdlibref.symbol("lambda*"), ast[2]].concat(ast.slice(3))];
  let a2 = rc[2];
  let a1 = rc[1];
...
////////////////////////////////////////////////////////////////////////////////
//name: [handleTry] in file: engine.ky near line: 474
...
////////////////////////////////////////////////////////////////////////////////
//name: [handleIf] in file: engine.ky near line: 490
...
////////////////////////////////////////////////////////////////////////////////
//name: [read*] in file: engine.ky near line: 499
...
////////////////////////////////////////////////////////////////////////////////
//name: [fn-wrap] in file: engine.ky near line: 518
...
const _STAR_spec_DASH_forms_STAR = {
  "and*": function(a, e) {
    return [handleAND(a, e)];
  },
  "or*": function(a, e) {
    return [handleOR(a, e)];
  },
  "def*": function(a, e) {
    return [e.set(a[1], compute(a[2], e))];
  },
  "let*": function(a, e) {
  ...
  "syntax-quote": function(a, e) {
    return [backtick(a[1]), e];
  },
  "macro*": function(a, e) {
    return [handleMacro(a, e)];
  },
  "try*": function(a, e) {
    return [handleTry(a, e)];
  },
  "do*": function(a, e) {
  ...
  "if*": function(a, e) {
    return [handleIf(a, e), e];
  },
  "lambda*": function(a, e) {
    return [fn_DASH_wrap(compute, a[2], e, a[1])];
  }
};
////////////////////////////////////////////////////////////////////////////////
//name: [compute] in file: engine.ky near line: 547
...
const compute = function(expr, cenv) {
  ...
  (function() {
    ...
    let _f_ = function(env, ast) {
      (cmd = [g1(ast)].join(""), fc = _STAR_spec_DASH_forms_STAR[cmd], res = ((!Array.isArray(ast)) ?
        [eval_STAR(ast, env)] :
...
////////////////////////////////////////////////////////////////////////////////
//name: [newEnv] in file: engine.ky near line: 571
//Create a new interpreter environment
const newEnv = function() {
  return (function() {
    let ret = new LEXEnv();
    let G__3 = _STAR_runtime_DASH_funcs_STAR;
...
////////////////////////////////////////////////////////////////////////////////
//name: [runRepl] in file: engine.ky near line: 577
...
////////////////////////////////////////////////////////////////////////////////
//name: [reval] in file: engine.ky near line: 593
...
const reval = function(expr) {
  ...
  let f = function() {
    let ____args = Array.prototype.slice.call(arguments);
    let F__13 = readAST;
    let R__14 = F__13.apply(this, ____args);
    let F__15 = compute;
    let R__16 = F__15(R__14);
    let F__17 = prn;
    let R__18 = F__17(R__16);
    return R__18;
  };
  let ret = f(expr);
  let G__4 = xs;
...
var g_env = null;
////////////////////////////////////////////////////////////////////////////////
//name: [init] in file: engine.ky near line: 602
...
////////////////////////////////////////////////////////////////////////////////
//name: [globalEnv] in file: engine.ky near line: 611
