/*Auto generated by Kirby - v1.0.0 czlab.kirby.engine Thu Dec 14 2017 17:25:14 GMT-0800 (PST)*/
...
const prefix = "kirby> ";
////////////////////////////////////////////////////////////////////////////////
//name: [assertSymbol] in file: engine.ky near line: 47
...
class LEXEnv {
  ////////////////////////////////////////////////////////////////////////////////
  //name: [constructor] in file: engine.ky near line: 55
  ...
  ////////////////////////////////////////////////////////////////////////////////
  //name: [find] in file: engine.ky near line: 76
  //Find the env
  ...
  ////////////////////////////////////////////////////////////////////////////////
  //name: [set] in file: engine.ky near line: 83
  //Bind this symbol,
  //value to this env
  set(k, v) {
    assertSymbol(k);
  ...
  ////////////////////////////////////////////////////////////////////////////////
  //name: [get] in file: engine.ky near line: 88
  //Get value of
  //this symbol
  get(k) {
    assertSymbol(k);
  ...
  ////////////////////////////////////////////////////////////////////////////////
  //name: [select] in file: engine.ky near line: 95
  select(what) {
  ...
  ////////////////////////////////////////////////////////////////////////////////
  //name: [prn] in file: engine.ky near line: 103
  //Print set of vars
  prn() {
    return std.prn(this.data);
  }
  ////////////////////////////////////////////////////////////////////////////////
  //name: [pushNSP] in file: engine.ky near line: 106
  //Add a namespace
  pushNSP(nsp) {
    return conj_BANG(this.nspaces, [nsp].join(""));
  }
  ////////////////////////////////////////////////////////////////////////////////
  //name: [peekNSP] in file: engine.ky near line: 109
  //Returns the
  ...
  ////////////////////////////////////////////////////////////////////////////////
  //name: [popNSP] in file: engine.ky near line: 113
  //Return and remove
  ...
  ////////////////////////////////////////////////////////////////////////////////
  //name: [firstNSP] in file: engine.ky near line: 117
  //Get the first
  //added namespace
  firstNSP() {
  ...
  ////////////////////////////////////////////////////////////////////////////////
  //name: [countNSPCache] in file: engine.ky near line: 121
  //Count n# of
  //added namespaces
  countNSPCache() {
  ...
  ////////////////////////////////////////////////////////////////////////////////
  //name: [resetNSPCache] in file: engine.ky near line: 125
...
////////////////////////////////////////////////////////////////////////////////
//name: [Function.prototype.clone] in file: engine.ky near line: 133
...
////////////////////////////////////////////////////////////////////////////////
//name: [prnStr] in file: engine.ky near line: 140
...
////////////////////////////////////////////////////////////////////////////////
//name: [prnLn] in file: engine.ky near line: 143
...
////////////////////////////////////////////////////////////////////////////////
//name: [slurp] in file: engine.ky near line: 146
const slurp = function(f) {
  return fs.readFileSync(f, "utf-8");
};
////////////////////////////////////////////////////////////////////////////////
//name: [spit] in file: engine.ky near line: 149
const spit = function(f, s) {
  return fs.writeFileSync(f, s, "utf-8");
};
////////////////////////////////////////////////////////////////////////////////
//name: [clone] in file: engine.ky near line: 152
...
////////////////////////////////////////////////////////////////////////////////
//name: [cons] in file: engine.ky near line: 171
const cons = function(a, b) {
  return [a].concat(b);
};
////////////////////////////////////////////////////////////////////////////////
//name: [conj] in file: engine.ky near line: 174
...
////////////////////////////////////////////////////////////////////////////////
//name: [fapply] in file: engine.ky near line: 186
const fapply = function(f) {
  let xs = Array.prototype.slice.call(arguments, 1);
  return f.apply(this, xs);
};
////////////////////////////////////////////////////////////////////////////////
//name: [fmap] in file: engine.ky near line: 189
const fmap = function(f, arr) {
  return arr.map(f);
};
////////////////////////////////////////////////////////////////////////////////
//name: [resolveJS] in file: engine.ky near line: 192
...
////////////////////////////////////////////////////////////////////////////////
//name: [filterJS] in file: engine.ky near line: 200
...
////////////////////////////////////////////////////////////////////////////////
//name: [withMeta] in file: engine.ky near line: 205
...
////////////////////////////////////////////////////////////////////////////////
//name: [meta] in file: engine.ky near line: 210
...
////////////////////////////////////////////////////////////////////////////////
//name: [evalJS] in file: engine.ky near line: 218
const evalJS = function(s) {
  return filterJS(eval(s.toString()));
};
////////////////////////////////////////////////////////////////////////////////
//name: [invokeJS] in file: engine.ky near line: 222
...
var toolkit = {
  ...
  "macros*": function() {
    let G____10 = Array.prototype.slice.call(arguments, 0);
    let fout = G____10[0];
    let s = std.prn(CACHE);
    return (fout ?
      spit(fout, s) :
...
var CACHE = {};
////////////////////////////////////////////////////////////////////////////////
//name: [loadMacros] in file: engine.ky near line: 351
...
////////////////////////////////////////////////////////////////////////////////
//name: [setMacro] in file: engine.ky near line: 357
...
////////////////////////////////////////////////////////////////////////////////
//name: [getMacro] in file: engine.ky near line: 369
//Get macro
...
////////////////////////////////////////////////////////////////////////////////
//name: [dbg] in file: engine.ky near line: 384
...
////////////////////////////////////////////////////////////////////////////////
//name: [readAST] in file: engine.ky near line: 387
//Returns the AST
...
////////////////////////////////////////////////////////////////////////////////
//name: [isList?] in file: engine.ky near line: 394
//Returns true
//if a non-empty list
...
////////////////////////////////////////////////////////////////////////////////
//name: [quasiquote] in file: engine.ky near line: 400
...
////////////////////////////////////////////////////////////////////////////////
//name: [evalAst] in file: engine.ky near line: 433
...
////////////////////////////////////////////////////////////////////////////////
//name: [handleAND] in file: engine.ky near line: 465
...
////////////////////////////////////////////////////////////////////////////////
//name: [handleOR] in file: engine.ky near line: 473
...
////////////////////////////////////////////////////////////////////////////////
//name: [handleLet] in file: engine.ky near line: 481
...
////////////////////////////////////////////////////////////////////////////////
//name: [handleMacro] in file: engine.ky near line: 491
...
////////////////////////////////////////////////////////////////////////////////
//name: [globalEnv] in file: engine.ky near line: 682
