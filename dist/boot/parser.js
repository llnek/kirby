/*Auto generated by Kirby - v1.0.0 czlab.kirby.parser Mon Dec 11 2017 23:42:54 GMT-0800 (PST)*/
...
////////////////////////////////////////////////////////////////////////////////
//name: [dump*] in file: parser.ky near line: 393
...
const dump_STAR = function(tree) {
  ...
  return (vector_QUERY(tree) ?
    ...
    (map_QUERY(tree) ?
      ...
      (list_QUERY(tree) ?
        ["<list>", tree.map(function() {
          let ____args = Array.prototype.slice.call(arguments);
          return dump_STAR(____args[0]);
        }).join(""), "</list>"].join("") :
        (Array.isArray(tree) ?
          ["<sexpr>", tree.map(function() {
            let ____args = Array.prototype.slice.call(arguments);
            return dump_STAR(____args[0]);
          }).join(""), "</sexpr>"].join("") :
          (lambda_DASH_arg_QUERY(tree) ?
            ["<lambdaarg>%",(parseInt(tree.value) + 1), "</lambdaarg>"].join("") :
            (keyword_QUERY(tree) ?
              ["<keyword>", escXml(tree.value), "</keyword>"].join("") :
              (symbol_QUERY(tree) ?
                ["<symbol>", escXml(tree.value), "</symbol>"].join("") :
                ((typeof (tree) === "string") ?
...
////////////////////////////////////////////////////////////////////////////////
//name: [dumpTree] in file: parser.ky near line: 435
//Debug and dump the AST
