/*Auto generated by Kirby - v1.0.0 czlab.kirby.parser Sun Dec 10 2017 18:55:24 GMT-0800 (PST)*/
...
class Token {
  ////////////////////////////////////////////////////////////////////////////////
  //name: [constructor] in file: parser.ky near line: 20
  constructor(source, line, column, value) {
    (this["source"] = source, this["value"] = value, this["line"] = line, this["column"] = column);
    return this;
  }
  ////////////////////////////////////////////////////////////////////////////////
  //name: [toString] in file: parser.ky near line: 26
  toString() {
    return this.value;
  }
}
////////////////////////////////////////////////////////////////////////////////
//name: [mkToken] in file: parser.ky near line: 29
//Create a token
...
////////////////////////////////////////////////////////////////////////////////
//name: [testid?] in file: parser.ky near line: 64
//Returns true
...
////////////////////////////////////////////////////////////////////////////////
//name: [jsid] in file: parser.ky near line: 69
//Escape to
...
////////////////////////////////////////////////////////////////////////////////
//name: [lexer] in file: parser.ky near line: 89
//Lexical analyzer
...
////////////////////////////////////////////////////////////////////////////////
//name: [throwE] in file: parser.ky near line: 221
//Raise an error
...
////////////////////////////////////////////////////////////////////////////////
//name: [popToken] in file: parser.ky near line: 231
...
////////////////////////////////////////////////////////////////////////////////
//name: [peekToken] in file: parser.ky near line: 237
//Returns the next token,
...
////////////////////////////////////////////////////////////////////////////////
//name: [prevToken] in file: parser.ky near line: 242
//Returns the previous token
const prevToken = function(tokens) {
  return tokens[(tokens.pos - 1)];
};
////////////////////////////////////////////////////////////////////////////////
//name: [copyTokenData] in file: parser.ky near line: 246
...
////////////////////////////////////////////////////////////////////////////////
//name: [readAtom] in file: parser.ky near line: 256
//Process an atom
...
////////////////////////////////////////////////////////////////////////////////
//name: [readBlock] in file: parser.ky near line: 288
//Process a LISP form
...
////////////////////////////////////////////////////////////////////////////////
//name: [addAst] in file: parser.ky near line: 375
...
////////////////////////////////////////////////////////////////////////////////
//name: [parse] in file: parser.ky near line: 379
//Main parser routine
