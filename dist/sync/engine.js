/*Auto generated by Kirby - v1.0.0 czlab.kirby.engine - Sun Dec 17 2017 17:27:14 GMT-0800 (PST)*/
...
class LEXEnv {
  ...
  ////////////////////////////////////////////////////////////////////////////////
  //fn: [peekNSP] in file: engine.ky,line: 112
  //Returns the
  ...
  ////////////////////////////////////////////////////////////////////////////////
  //fn: [popNSP] in file: engine.ky,line: 116
  //Return and remove
  ...
  ////////////////////////////////////////////////////////////////////////////////
  //fn: [firstNSP] in file: engine.ky,line: 120
  //Get the first
  //added namespace
  firstNSP() {
  ...
  ////////////////////////////////////////////////////////////////////////////////
  //fn: [countNSPCache] in file: engine.ky,line: 124
  //Count n# of
  //added namespaces
  countNSPCache() {
  ...
  ////////////////////////////////////////////////////////////////////////////////
  //fn: [resetNSPCache] in file: engine.ky,line: 128
...
////////////////////////////////////////////////////////////////////////////////
//fn: [getMacro] in file: engine.ky,line: 342
//Get macro
...
////////////////////////////////////////////////////////////////////////////////
//fn: [dbg] in file: engine.ky,line: 357
...
////////////////////////////////////////////////////////////////////////////////
//fn: [readAST] in file: engine.ky,line: 360
...
////////////////////////////////////////////////////////////////////////////////
//fn: [backtick] in file: engine.ky,line: 366
const backtick = function(ast) {
  ...
  return ((!lst_QUERY(ast)) ?
    ...
    ((symbol_QUERY(ast[0]) && (ast[0] == "unquote")) ?
      ast[1] :
      ((lst_QUERY(ast[0]) && symbol_QUERY(ast[0][0]) && (ast[0][0] == "splice-unquote")) ?
        [
...
////////////////////////////////////////////////////////////////////////////////
//fn: [isMacroCall?] in file: engine.ky,line: 387
...
////////////////////////////////////////////////////////////////////////////////
//fn: [expand??] in file: engine.ky,line: 393
...
////////////////////////////////////////////////////////////////////////////////
//fn: [eval*] in file: engine.ky,line: 401
...
////////////////////////////////////////////////////////////////////////////////
//fn: [doAND] in file: engine.ky,line: 423
...
////////////////////////////////////////////////////////////////////////////////
//fn: [doOR] in file: engine.ky,line: 431
...
////////////////////////////////////////////////////////////////////////////////
//fn: [doLET] in file: engine.ky,line: 439
    ...
    try {
      ...
      return ((a3 && ("catch*" == a3[0])) ?
        (function() {
          ...
          return compute(a3[2], new LEXEnv(env, [
            a3[1]
          ], [
            e
          ]));
...
////////////////////////////////////////////////////////////////////////////////
//fn: [fn->raw] in file: engine.ky,line: 496
...
////////////////////////////////////////////////////////////////////////////////
//fn: [compute] in file: engine.ky,line: 519
...
////////////////////////////////////////////////////////////////////////////////
//fn: [newEnv] in file: engine.ky,line: 541
//Create a new interpreter environment
const newEnv = function() {
  return (function() {
    let ret = new LEXEnv();
    let GS__18 = _STAR_runtime_DASH_funcs_STAR;
...
////////////////////////////////////////////////////////////////////////////////
//fn: [runRepl] in file: engine.ky,line: 547
...
////////////////////////////////////////////////////////////////////////////////
//fn: [reval] in file: engine.ky,line: 563
...
const reval = function(expr) {
  ...
  let f = function() {
    let ____args = Array.prototype.slice.call(arguments);
    let F__19 = readAST;
    let R__20 = F__19.apply(this, ____args);
    let F__21 = compute;
    let R__22 = F__21(R__20);
    let F__23 = prn;
  ...
  let ret = f(expr);
  let GS__25 = xs;
  for (let GS__27 = 0, GS__26 = false, ____break = false; ((!____break) && ((!GS__26) && (GS__27 < GS__25.length))); GS__27 = (GS__27 + 1)) {
    let e = GS__25[GS__27];
    null;
    if ( (!true) ) {
      GS__26 = true;
...
var g_env = null;
////////////////////////////////////////////////////////////////////////////////
//fn: [init] in file: engine.ky,line: 572
...
////////////////////////////////////////////////////////////////////////////////
//fn: [globalEnv] in file: engine.ky,line: 581
