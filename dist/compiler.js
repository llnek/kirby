/*Auto generated by Kirby v1.0.0 - Mon Jan 22 2018 22:31:44 GMT-0800 (PST)
...
const lambdaArg_QUERY = std["lambdaArg_QUERY"];
...
const regexObj_QUERY = std["regexObj_QUERY"];
...
////////////////////////////////////////////////////////////////////////////////
//fn: [unmangle] in file: compiler.ky, line: 65
const unmangle = function(s) {
  return s.split(".").map(function() {
    let ____args = Array.prototype.slice.call(arguments);
    return parser.jsid(____args[0]);
  }).join(".");
};
////////////////////////////////////////////////////////////////////////////////
//fn: [tnodeEx] in file: compiler.ky, line: 69
//Create a node
...
////////////////////////////////////////////////////////////////////////////////
//fn: [tnode] in file: compiler.ky, line: 73
//Create a token
...
////////////////////////////////////////////////////////////////////////////////
//fn: [doFuncArgs] in file: compiler.ky, line: 83
...
////////////////////////////////////////////////////////////////////////////////
//fn: [destruct*] in file: compiler.ky, line: 125
//Decide on what the
...
////////////////////////////////////////////////////////////////////////////////
//fn: [destructVec] in file: compiler.ky, line: 144
...
////////////////////////////////////////////////////////////////////////////////
//fn: [destructMap] in file: compiler.ky, line: 185
...
////////////////////////////////////////////////////////////////////////////////
//fn: [simple?] in file: compiler.ky, line: 213
...
////////////////////////////////////////////////////////////////////////////////
//fn: [wrap] in file: compiler.ky, line: 217
...
////////////////////////////////////////////////////////////////////////////////
//fn: [exprHint] in file: compiler.ky, line: 222
...
////////////////////////////////////////////////////////////////////////////////
//fn: [stmt?] in file: compiler.ky, line: 226
...
////////////////////////////////////////////////////////////////////////////////
//fn: [error!] in file: compiler.ky, line: 230
...
////////////////////////////////////////////////////////////////////////////////
//fn: [testre?] in file: compiler.ky, line: 237
...
////////////////////////////////////////////////////////////////////////////////
//fn: [pad] in file: compiler.ky, line: 240
const pad = function(n) {
  return " ".repeat(n);
};
////////////////////////////////////////////////////////////////////////////////
//fn: [node'] in file: compiler.ky, line: 243
...
////////////////////////////////////////////////////////////////////////////////
//fn: [txTree] in file: compiler.ky, line: 251
...
////////////////////////////////////////////////////////////////////////////////
//fn: [txForm] in file: compiler.ky, line: 275
...
////////////////////////////////////////////////////////////////////////////////
//fn: [txAtom] in file: compiler.ky, line: 281
//Returns a SourceNode or String
const txAtom = function(a) {
  let s = [a].join("");
  return (lambdaArg_QUERY(a) ?
    [LARGS, "[", (parseInt(s.slice(1)) - 1), "]"].join("") :
    (regexObj_QUERY(a) ?
      node_QUOTE(a, tnodeEx(s, s.slice(1))) :
      (keyword_QUERY(a) ?
        node_QUOTE(a, tnodeEx(s, std.quote_DASH_str(s))) :
        (symbol_QUERY(a) ?
          node_QUOTE(a, tnodeEx(s, unmangle(s))) :
          (((a === null)) ?
            "null" :
            (primitive_QUERY(a) ?
              (function() {
...
const quoteSingle = function(a) {
  return (keyword_QUERY(a) ?
    [maybeStripStdlib([KBSTDLR, ".keyword"].join("")), "(\"", a.value, "\")"].join("") :
    (symbol_QUERY(a) ?
      [maybeStripStdlib([KBSTDLR, ".symbol"].join("")), "(\"", a.value, "\")"].join("") :
      (primitive_QUERY(a) ?
        (function() {
          a = a.value;
          return (((typeof (a) === "string")) ?
...
////////////////////////////////////////////////////////////////////////////////
//fn: [writeDoc] in file: compiler.ky, line: 444
//Convert to jsdoc
...
////////////////////////////////////////////////////////////////////////////////
//fn: [txDo] in file: compiler.ky, line: 453
...
////////////////////////////////////////////////////////////////////////////////
//fn: [meta??] in file: compiler.ky, line: 471
...
////////////////////////////////////////////////////////////////////////////////
//fn: [fmtRegoSpecOps] in file: compiler.ky, line: 483
const fmtRegoSpecOps = function(alias, fname) {
  return [parser.jsid("SPEC-OPS"), "[\"", alias, "\"] = ", fname].join("");
};
////////////////////////////////////////////////////////////////////////////////
//fn: [fmtSpecOps] in file: compiler.ky, line: 487
...
////////////////////////////////////////////////////////////////////////////////
//fn: [writeFuncPre] in file: compiler.ky, line: 494
...
////////////////////////////////////////////////////////////////////////////////
//fn: [writeFuncInfo] in file: compiler.ky, line: 501
...
////////////////////////////////////////////////////////////////////////////////
//fn: [evalMeta] in file: compiler.ky, line: 513
...
////////////////////////////////////////////////////////////////////////////////
//fn: [maybeStripStdlib] in file: compiler.ky, line: 528
...
////////////////////////////////////////////////////////////////////////////////
//fn: [assertArity] in file: compiler.ky, line: 537
...
////////////////////////////////////////////////////////////////////////////////
//fn: [assertInfo] in file: compiler.ky, line: 542
...
////////////////////////////////////////////////////////////////////////////////
//fn: [loadRLib] in file: compiler.ky, line: 550
const loadRLib = function(info, env) {
  let GS__18 = info;
  let ns = GS__18["ns"];
  let macros = GS__18["macros"];
  let ast,
    s;
  let GS__19 = macros;
  Object.entries(GS__19).forEach(function(e) {
    return (function(v, k) {
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-juxt] in file: compiler.ky, line: 565
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-deref] in file: compiler.ky, line: 587
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-compose] in file: compiler.ky, line: 598
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-quote] in file: compiler.ky, line: 623
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-deftype] in file: compiler.ky, line: 631
//Define a JS Class
const sf_DASH_deftype = function(ast, env) {
  ...
  let czargs = ast[3];
  let GS__20 = (((typeof (ast[4]) === "string")) ?
  ...
  ret.add(" {\n");
  let GS__21 = mtds;
  for (let GS__23 = 0, GS__22 = false, ____break = false; ((!____break) && ((!GS__22) && (GS__23 < GS__21.length))); GS__23 = (GS__23 + 1)) {
    let m = kirbystdlibref.getProp(GS__21, GS__23);
    null;
    if ( (!true) ) {
      GS__22 = true;
    } else {
...
SPEC_DASH_OPS["<="] = sf_DASH_compOp;
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-arithOp] in file: compiler.ky, line: 709
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-do] in file: compiler.ky, line: 746
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-case] in file: compiler.ky, line: 764
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-vardefs] in file: compiler.ky, line: 813
...
const sf_DASH_vardefs = function(ast, env) {
  ...
  if ( (pub_QUERY && std.peekNSP()) ) {
    let GS__25 = keys;
    Object.entries(GS__25).forEach(function(e) {
      return (function() {
        let ____args = Array.prototype.slice.call(arguments);
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-var] in file: compiler.ky, line: 842
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-inst?] in file: compiler.ky, line: 883
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-delete] in file: compiler.ky, line: 896
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-new] in file: compiler.ky, line: 911
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-throw] in file: compiler.ky, line: 925
//Throw an exception
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-x-opop] in file: compiler.ky, line: 941
...
SPEC_DASH_OPS["--$"] = sf_DASH_x_DASH_opop;
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-x-eq] in file: compiler.ky, line: 955
  ...
  let cmd = (function() {
    ...
    switch ([kirbystdlibref.getProp(ast, 0)].join("")) {
      ...
      case "exp=":
        ...
        break;
      default:
        C__27 = [kirbystdlibref.getProp(ast, 0)].join("");
        break;
    }
    return C__27;
  }).call(this);
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-setin!] in file: compiler.ky, line: 988
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-set] in file: compiler.ky, line: 1008
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-fn] in file: compiler.ky, line: 1026
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-func] in file: compiler.ky, line: 1045
...
const sf_DASH_func = function(ast, env) {
  ...
  let GS__29 = (((typeof (kirbystdlibref.getProp(ast, 2)) === "string")) ?
  ...
  let GS__30 = meta_QUERY__QUERY(kirbystdlibref.getProp(ast, pargs), env);
  let attrs = GS__30[0];
  let args = GS__30[1];
  if ( (!mtd_QUERY) ) {
    env.addVar(fname0, {
  ...
  if ( (pub_QUERY && (!dot_QUERY) && (!mtd_QUERY) && std.peekNSP()) ) {
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-if] in file: compiler.ky, line: 1167
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-get] in file: compiler.ky, line: 1196
...
////////////////////////////////////////////////////////////////////////////////
//fn: [require!] in file: compiler.ky, line: 1264
const require_BANG = function(path) {
  return require(path);
};
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-require] in file: compiler.ky, line: 1269
//Loads libs.
...
const sf_DASH_require = function(ast, env) {
  ...
  for (let i = 1, sz = kirbystdlibref.count(ast), ____break = false; ((!____break) && (i < sz)); i = (i + 1)) {
    ...
    if ( (!macros_only) ) {
      ret.add(["const ", parser.jsid(as), "= require(", tx_STAR(rpath, env), ");\n"]);
    } else {
      null;
    }
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-ns] in file: compiler.ky, line: 1360
...
const sf_DASH_ns = function(ast, env) {
  ...
  let mobj = null;
  let pos = 2;
  let GS__31 = meta_QUERY__QUERY(kirbystdlibref.getProp(ast, 1), env);
  let attrs = GS__31[0];
  let nsp = GS__31[1];
  if ( (!symbol_QUERY(nsp)) ) {
  ...
  return conj_BANG(ret, ["const ", std.MODULE_NAMESPACE, "= ", std.quote_DASH_str(nsp.id), ";\n"].join(""));
};
SPEC_DASH_OPS["ns"] = sf_DASH_ns;
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-comment] in file: compiler.ky, line: 1414
const sf_DASH_comment = function(ast, env) {
  return "";
};
SPEC_DASH_OPS["comment"] = sf_DASH_comment;
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-for] in file: compiler.ky, line: 1417
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-floop] in file: compiler.ky, line: 1437
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-jscode] in file: compiler.ky, line: 1481
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-macro] in file: compiler.ky, line: 1498
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-unary] in file: compiler.ky, line: 1552
...
SPEC_DASH_OPS["!"] = sf_DASH_unary;
////////////////////////////////////////////////////////////////////////////////
//fn: [getPrePost] in file: compiler.ky, line: 1565
...
////////////////////////////////////////////////////////////////////////////////
//fn: [xfi] in file: compiler.ky, line: 1581
...
////////////////////////////////////////////////////////////////////////////////
//fn: [spitMacros] in file: compiler.ky, line: 1595
const spitMacros = function() {
  return ((0 === kirbystdlibref.count(_STAR_macros_STAR)) ?
    "" :
    std.wrap_DASH_str(seq(_STAR_macros_STAR).map(function(GS__33) {
      let k = GS__33[0];
      let v = GS__33[1];
...
////////////////////////////////////////////////////////////////////////////////
//fn: [spitExterns] in file: compiler.ky, line: 1605
...
const spitExterns = function() {
  let mc = ((0 === kirbystdlibref.count(_STAR_macros_STAR)) ?
    ...
    "____macros");
  let s2 = "";
  let s1 = [EXPKEY, ": { ns: ", quote_DASH_str(std.peekNSP().id), ", macros: ", mc, " }"].join("");
  if (not_DASH_empty(_STAR_externs_STAR)) {
    s2 = [",\n", seq(_STAR_externs_STAR).map(function(GS__34) {
      let k = GS__34[0];
      let v = GS__34[1];
      return [k, ":", v].join("");
    }).join(",\n")].join("");
...
////////////////////////////////////////////////////////////////////////////////
//fn: [banner] in file: compiler.ky, line: 1622
//Banner text for the target file
const banner = function() {
  let GS__35 = std.peekNSP();
  let id = GS__35["id"];
  let meta = GS__35["meta"];
  return ["/*", "Auto generated by Kirby v", MOD_DASH_VER, " - ", new Date(), "\n", "  ", id, "\n", (meta ?
    std.prn(meta, true) :
    ""), "\n", "*/\n\n"].join("");
};
////////////////////////////////////////////////////////////////////////////////
//fn: [cleanCode] in file: compiler.ky, line: 1631
const cleanCode = function(code) {
  let tmp = null;
  let arr = [];
  let GS__36 = code.split("\n");
  for (let GS__38 = 0, GS__37 = false, ____break = false; ((!____break) && ((!GS__37) && (GS__38 < GS__36.length))); GS__38 = (GS__38 + 1)) {
    let s = kirbystdlibref.getProp(GS__36, GS__38);
    let tmp = s.trim();
    if ( (!true) ) {
      GS__37 = true;
    } else {
...
////////////////////////////////////////////////////////////////////////////////
//fn: [transpile*] in file: compiler.ky, line: 1640
...
const transpile_STAR = function(source, fname, options) {
  ...
  let gv = rt.genv();
  let ret = txTree(parser.parse(source, fname), gv);
  let GS__39 = options;
  let source_DASH_map = GS__39["source-map"];
  let format = GS__39["format"];
  let verbose = GS__39["verbose"];
...
const transpile = function(code, file) {
  let GS__40 = Array.prototype.slice.call(arguments, 2);
  let options = GS__40[0];
  return (function() {
    try {
