/*Auto generated by Kirby v1.0.0 - Thu Mar 22 2018 00:08:04 GMT-0700 (PDT)
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-for] in file: compiler.ky, line: 1458
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-floop] in file: compiler.ky, line: 1477
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-fxxx] in file: compiler.ky, line: 1519
//Generates native (js) for loop.
//(for* [initial-vars :while test :recur update-vars] ...)
const sf_DASH_fxxx = function(ast, env) {
  assertArity((kirbystdlibref.count(ast) >= 2), ast);
  let stmtQ = stmt_QMRK(ast);
  let ret = node_QUOT(ast);
  let body = exprHint(xfi(ast, Array.prototype.slice.call(ast, 2)), false);
  return ((0 === kirbystdlibref.count(body)) ?
    ret :
    sf_DASH_foop(ret, xfi(ast, ast[1]), body, env, stmtQ));
};
SPEC_DASH_OPS["for!"] = sf_DASH_fxxx;
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-foop] in file: compiler.ky, line: 1538
//For loop implementation
const sf_DASH_foop = function(ret, args, body, env, stmtQ) {
  ...
  let vars = [kirbystdlibref.symbol("____index"), 0];
  let recurs = [];
  let tst = undefined;
  let nb = undefined;
  let e = undefined;
  ...
  let end = undefined;
  let step = 1;
  for (let i = 0, sz = kirbystdlibref.count(args), ____break = false; ((!____break) && (i < sz)); i = (i + 2)) {
    (
    e = args[i]);
    if ( (e == "while") ) {
      (
  ...
  recurs.shift([kirbystdlibref.symbol("+"), kirbystdlibref.symbol("____index"), step]);
  for (let i = 0, k = 0, sz = kirbystdlibref.count(recurs), ____break = false; ((!____break) && (i < sz)); i = (i + 1), k = (k + 2)) {
    (
    e = recurs[i]);
    if ( (i !== 0) ) {
  ...
  ret.add(["){\n", sf_DASH_var(xfi(args, [kirbystdlibref.symbol("vars"), lvar, [kirbystdlibref.symbol("nth"), args, kirbystdlibref.symbol("____index")]]), env), txDo(body, env, false), "}\n"]);
  if ( (!stmtQ) ) {
    wrap(ret, "(function() {\n", "; return null; }).call(this)");
  } else {
    null;
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-jscode] in file: compiler.ky, line: 1592
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-macro] in file: compiler.ky, line: 1609
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-unary] in file: compiler.ky, line: 1662
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-listc] in file: compiler.ky, line: 1675
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-doseq] in file: compiler.ky, line: 1698
...
////////////////////////////////////////////////////////////////////////////////
//fn: [doseq-binds] in file: compiler.ky, line: 1751
...
////////////////////////////////////////////////////////////////////////////////
//fn: [getPrePost] in file: compiler.ky, line: 1773
...
////////////////////////////////////////////////////////////////////////////////
//fn: [xfi] in file: compiler.ky, line: 1789
...
////////////////////////////////////////////////////////////////////////////////
//fn: [spitMacros] in file: compiler.ky, line: 1803
...
////////////////////////////////////////////////////////////////////////////////
//fn: [spitExterns] in file: compiler.ky, line: 1813
...
////////////////////////////////////////////////////////////////////////////////
//fn: [banner] in file: compiler.ky, line: 1830
...
////////////////////////////////////////////////////////////////////////////////
//fn: [cleanCode] in file: compiler.ky, line: 1838
...
////////////////////////////////////////////////////////////////////////////////
//fn: [transpile] in file: compiler.ky, line: 1893
...
////////////////////////////////////////////////////////////////////////////////
//fn: [dbgAST] in file: compiler.ky, line: 1907
//Dump AST to xml
