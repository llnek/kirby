/*Auto generated by Kirby v1.0.0 - Sun Mar 18 2018 16:59:54 GMT-0700 (PDT)
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-listc] in file: compiler.ky, line: 1755
...
SPEC_DASH_OPS["listc"] = sf_DASH_listc;
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-doseq] in file: compiler.ky, line: 1771
const sf_DASH_doseq = function(ast, env) {
  let GS__45 = Array.prototype.slice.call(arguments, 2);
  let capRes = kirbystdlibref.getIndex(GS__45, 0);
  let body = exprHint(xfi(ast, Array.prototype.slice.call(ast, 2)), false);
  ...
  let GS__46 = split_DASH_with(function() {
    let ____args = Array.prototype.slice.call(arguments);
    return (!keyword_QMRK(____args[0]));
  }, args);
  let x = kirbystdlibref.getIndex(GS__46, 0);
  let y = kirbystdlibref.getIndex(GS__46, 1);
    ...
    let _f_ = function(p1, pn) {
      return (p1 ?
        (function() {
          ...
          let n_QUOT = gensym();
          (ret = node_QUOT(ast));
          ret.add(["for(let ", [n_QUOT].join(""), "=0,", tx_STAR(p1[0], env), "=undefined,", ((0 === kirbystdlibref.count(pn)) ?
          ...
          ret.add([tx_STAR(p1[0], env), "=", [e_QUOT].join(""), "[", [n_QUOT].join(""), "];\n"]);
          if (fst) {
            (
            fst = false);
...
////////////////////////////////////////////////////////////////////////////////
//fn: [doseq-binds] in file: compiler.ky, line: 1820
const doseq_DASH_binds = function(while_QUOT, ret, y, body, ast, env, capRes) {
  let patch = node_QUOT(ast);
  partition(2, y).forEach(function(GS__47) {
    let k = kirbystdlibref.getIndex(GS__47, 0);
    let expr = kirbystdlibref.getIndex(GS__47, 1);
    return ((k == "let") ?
  ...
  if (capRes) {
    ret.add(["(.push ", [capRes].join(""), " (function() {\n", txDo(body, env, true), "\n}).call(this))\n"]);
  } else {
