/*Auto generated by Kirby v1.0.0 - Wed Dec 27 2017 02:39:29 GMT-0800 (PST)
  czlab.kirby.parser
({ doc :
...
const read_STAR = function(tokens) {
  ...
  return ((Array.isArray(func)) ?
    kirbystdlibref.getProp(func, 0).apply(this, [
      tokens
    ]) :
...
const parse = function(source) {
  ...
  for (let ____break = false; ((!____break) && (tokens.pos < tlen));) {
    let f= read_STAR(tokens);
    console.log(std.prn(f,true))
    addAst(ast, f)
  }
  return ast;
};
