/*Auto generated by Kirby v1.0.0 - Wed Mar 21 2018 02:43:46 GMT-0700 (PDT)
  czlab.elmo.ecs.core
...
////////////////////////////////////////////////////////////////////////////////
//fn: [findEntities] in file: ecs-core.ky, line: 194
const findEntities = function(ecs, componentId) {
  ...
  let c = undefined;
  let sum = undefined;
  let GS__20 = ecs.value;
  let data = kirbystdlibref.getProp(GS__20, "data");
  let entities = kirbystdlibref.getProp(GS__20, "entities");
  ...
  for (let i = 0, sz = kirbystdlibref.count(cids), ____break = false; ((!____break) && (i < sz)); i = (i + 1)) {
    (cid = cids[i], c = kirbystdlibref.getProp(data, cid), cnt = count(c));
    if (nichts_QMRK(c)) {
      (
      missed_QMRK = true);
      (
  ...
  if ( ((ccsz > 0) && (!missed_QMRK)) ) {
    ...
    for (let GS__23 = 0, GS__21 = true, GS__22 = pmks, ____sz = kirbystdlibref.count(GS__22), ____break = false; (!____break && GS__21 && (GS__23 < ____sz)); ++GS__23) {
      let eid = GS__22[GS__23];
      let sum = 0;
      for (let GS__26 = 0, GS__24 = true, GS__25 = ccs, ____sz = kirbystdlibref.count(GS__25), ____break = false; (!____break && GS__24 && (GS__26 < ____sz)); ++GS__26) {
        let c = GS__25[GS__26];
        if ( (c === pm) ) {
          ++sum;
        } else {
...
////////////////////////////////////////////////////////////////////////////////
//fn: [addTemplate] in file: ecs-core.ky, line: 230
const addTemplate = function(ecs, id, template) {
  let more = Array.prototype.slice.call(arguments, 3);
  swap_BANG(ecs, function(root) {
    let templates = kirbystdlibref.getProp(root, "templates");
    partition(2, [id, template].concat(more)).forEach(function(GS__28) {
...
////////////////////////////////////////////////////////////////////////////////
//fn: [removeTemplate] in file: ecs-core.ky, line: 246
...
////////////////////////////////////////////////////////////////////////////////
//fn: [createTemplateEntity] in file: ecs-core.ky, line: 253
...
////////////////////////////////////////////////////////////////////////////////
//fn: [addSystem] in file: ecs-core.ky, line: 266
...
////////////////////////////////////////////////////////////////////////////////
//fn: [removeSystem] in file: ecs-core.ky, line: 274
...
////////////////////////////////////////////////////////////////////////////////
//fn: [updateECS] in file: ecs-core.ky, line: 283
