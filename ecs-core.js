/*Auto generated by Kirby v1.0.0 - Fri Mar 16 2018 19:16:28 GMT-0700 (PDT)
  czlab.elmo.ecs.core
...
const findEntities = function(ecs, componentId) {
  ...
  if ( ((ccsz > 0) && (!missed_QMRK)) ) {
    ...
    for (let i = 0, sz = kirbystdlibref.count(pmks), ____break = false; ((!____break) && (i < sz)); i = (i + 1)) {
      ...
      if ( (sum === ccsz) ) {
        let GS__21 = kirbystdlibref.getProp(this.ents, eid);
        let e = GS__21;
...
////////////////////////////////////////////////////////////////////////////////
//fn: [addTemplate] in file: ecs-core.ky, line: 233
const addTemplate = function(ecs, id, template) {
  let more = Array.prototype.slice.call(arguments, 3);
  swap_BANG(ecs, function(root) {
    let templates = kirbystdlibref.getProp(root, "templates");
    partition(2, [id, template].concat(more)).forEach(function(GS__23) {
      let a = kirbystdlibref.getIndex(GS__23, 0);
      let b = kirbystdlibref.getIndex(GS__23, 1);
...
////////////////////////////////////////////////////////////////////////////////
//fn: [removeTemplate] in file: ecs-core.ky, line: 249
...
////////////////////////////////////////////////////////////////////////////////
//fn: [createTemplateEntity] in file: ecs-core.ky, line: 256
...
////////////////////////////////////////////////////////////////////////////////
//fn: [addSystem] in file: ecs-core.ky, line: 269
...
////////////////////////////////////////////////////////////////////////////////
//fn: [removeSystem] in file: ecs-core.ky, line: 277
...
////////////////////////////////////////////////////////////////////////////////
//fn: [updateECS] in file: ecs-core.ky, line: 286
