/*Auto generated by Kirby v1.0.0 - Thu Mar 15 2018 22:43:22 GMT-0700 (PDT)
  czlab.elmo.ecs.test
...
////////////////////////////////////////////////////////////////////////////////
//fn: [compA] in file: ecs-test.ky, line: 20
...
////////////////////////////////////////////////////////////////////////////////
//fn: [compB] in file: ecs-test.ky, line: 21
...
////////////////////////////////////////////////////////////////////////////////
//fn: [compC] in file: ecs-test.ky, line: 22
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sys1] in file: ecs-test.ky, line: 35
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sys2] in file: ecs-test.ky, line: 36
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sys3] in file: ecs-test.ky, line: 37
...
const ecs_DASH_test = function() {
  ...
  return [kirbystdlibref.ensureTest(((ecs.getPoolSize(pool1) === 0)), "pool,size=0"), kirbystdlibref.ensureTest((function() {
    ...
    return ((7 === ecs.getPoolUsed(pool1)) && (12 === ecs.getPoolSize(pool1)));
      ...
      return count(ecs.getComponentKeys(_STAR_ecs_STAR));
    }).call(this)), "removeComponent,*"), kirbystdlibref.ensureTest((3 === (function() {
      ecs.addComponent(_STAR_ecs_STAR, "c1", compA, "c2", compB, "c3", compC);
      return count(ecs.getComponentKeys(_STAR_ecs_STAR));
    }).call(this)), "addComponent,**"), kirbystdlibref.ensureTest((2 === (function() {
    ...
    return (ecs.componentInEntity_QMRK(x, "c1", "c2", "c3") && ecs.getEntityData(x, "c1") && ecs.getEntityData(x, "c2") && ecs.getEntityData(x, "c3"));
    ...
    return (ecs.componentInEntity_QMRK(x, "c2", "c3") && nichts_QMRK(ecs.getEntityData(x, "c1")) && ecs.getEntityData(x, "c2") && ecs.getEntityData(x, "c3"));
    ...
    let y = ecs.getEntityData(x, "c3");
    let _ = ecs.removeEntity(_STAR_ecs_STAR, x);
    let z = ecs.getEntityData(x, "c1");
    return (some_QMRK(y) && nichts_QMRK(z));
  }).call(this), "removeEntity"), kirbystdlibref.ensureTest(ky.eq_QMRK([1, 2, 3], (function() {
    (
    TEMP_DASH_VAR = []);
