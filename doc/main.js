/*Auto generated by Kirby v1.0.0 - Thu Feb 08 2018 19:06:55 GMT-0800 (PST)
  czlab.kirby.main
...
watch.watchTree(cwd,{"ignoreDirectoryPattern": /node_modules/, "ignoreDotFiles": true, "filter": function (f,stat) {
...
(true ?
(function() {
return cp.spawn("bin/kirby.js",[ f.slice((cwd.length + 1)) ],{"stdio": "inherit"});
}).call(this) :
null)));
});
return null;
...
let version=kirbystdlibref.getProp(GS__14,"version");
let repl=kirbystdlibref.getProp(GS__14,"repl");
let watch=kirbystdlibref.getProp(GS__14,"watch");
let help=kirbystdlibref.getProp(GS__14,"help");
if (version) {
...
main();
module.exports = {
da57bc0172fb42438a11e6e8778f36fb: { ns: "czlab.kirby.main", macros: {} },
main:main
};