/*Auto generated by Kirby v1.0.0 - Wed Mar 21 2018 02:35:29 GMT-0700 (PDT)
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-jscode] in file: compiler.ky, line: 1519
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-macro] in file: compiler.ky, line: 1536
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-unary] in file: compiler.ky, line: 1589
...
////////////////////////////////////////////////////////////////////////////////
//fn: [xfi] in file: compiler.ky, line: 1618
...
////////////////////////////////////////////////////////////////////////////////
//fn: [spitMacros] in file: compiler.ky, line: 1632
const spitMacros = function() {
  return ((0 === kirbystdlibref.count(_STAR_macros_STAR)) ?
    "" :
    std.wrap_DASH_str(seq(_STAR_macros_STAR).map(function(GS__49) {
      let k = kirbystdlibref.getIndex(GS__49, 0);
      let v = kirbystdlibref.getIndex(GS__49, 1);
      return [quote_DASH_str([k].join("")), ":", quote_DASH_str(v)].join("");
    }).join(",\n"), "const ____macros = {\n", "};\n"));
};
////////////////////////////////////////////////////////////////////////////////
//fn: [spitExterns] in file: compiler.ky, line: 1642
...
const spitExterns = function() {
  ...
  if (not_DASH_empty(_STAR_externs_STAR)) {
    (
    s2 = [",\n", seq(_STAR_externs_STAR).map(function(GS__50) {
      let k = kirbystdlibref.getIndex(GS__50, 0);
      let v = kirbystdlibref.getIndex(GS__50, 1);
      return [k, ":", v].join("");
    }).join(",\n")].join(""));
  }
  return ["\n\nmodule.exports = {\n", s1, s2, "\n};\n"].join("");
...
////////////////////////////////////////////////////////////////////////////////
//fn: [banner] in file: compiler.ky, line: 1659
//Banner text for the target file
const banner = function() {
  let GS__51 = std.peekNSP();
  let id = kirbystdlibref.getProp(GS__51, "id");
  let meta = kirbystdlibref.getProp(GS__51, "meta");
  return ["/*", "Auto generated by Kirby v", MOD_DASH_VER, " - ", new Date(), "\n", "  ", id, "\n", (meta ?
    std.prn(meta, true) :
    ""), "\n", "*/\n\n"].join("");
};
////////////////////////////////////////////////////////////////////////////////
//fn: [cleanCode] in file: compiler.ky, line: 1667
...
////////////////////////////////////////////////////////////////////////////////
//fn: [transpile*] in file: compiler.ky, line: 1675
...
const transpile_STAR = function(source, fname, options) {
  let GS__52 = options;
  let source_DASH_map = kirbystdlibref.getProp(GS__52, "source-map");
  let no_DASH_format = kirbystdlibref.getProp(GS__52, "no-format");
  let verbose = kirbystdlibref.getProp(GS__52, "verbose");
...
////////////////////////////////////////////////////////////////////////////////
//fn: [transpile] in file: compiler.ky, line: 1722
//Compile kirby file to target source
const transpile = function(code, file) {
  let GS__53 = Array.prototype.slice.call(arguments, 2);
  let options = kirbystdlibref.getIndex(GS__53, 0);
...
////////////////////////////////////////////////////////////////////////////////
//fn: [dbgAST] in file: compiler.ky, line: 1736
//Dump AST to xml
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-listc] in file: compiler.ky, line: 1745
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-doseq] in file: compiler.ky, line: 1761
const sf_DASH_doseq = function(ast, env) {
  let GS__54 = Array.prototype.slice.call(arguments, 2);
  let capRes = kirbystdlibref.getIndex(GS__54, 0);
  let body = exprHint(xfi(ast, Array.prototype.slice.call(ast, 2)), false);
  ...
  let GS__55 = split_DASH_with(function() {
    let ____args = Array.prototype.slice.call(arguments);
    return (!keyword_QMRK(____args[0]));
  }, args);
  let x = kirbystdlibref.getIndex(GS__55, 0);
  let y = kirbystdlibref.getIndex(GS__55, 1);
