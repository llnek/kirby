/*Auto generated by Kirby v1.0.0 - Tue Mar 20 2018 23:08:41 GMT-0700 (PDT)
...
const txDo = function(ast, env) {
  ...
  let return_QMRK = kirbystdlibref.getIndex(GS__15, 0);
  let stmtQ = stmt_QMRK(ast);
  let ret = node_QUOT(ast);
  let e = null;
...
////////////////////////////////////////////////////////////////////////////////
//fn: [writeFuncInfo] in file: compiler.ky, line: 514
...
const loadRLib = function(info, env) {
  ...
  let s = undefined;
  let GS__16 = info;
  let ns = kirbystdlibref.getProp(GS__16, "ns");
  let macros = kirbystdlibref.getProp(GS__16, "macros");
  let GS__17 = macros;
...
const sf_DASH_deftype = function(ast, env) {
  ...
  let par = ast[2][0];
  let GS__20 = (((typeof (ast[3]) === "string")) ?
    [ast[3], Array.prototype.slice.call(ast, 4)] :
    [null, Array.prototype.slice.call(ast, 3)]);
  let doc = kirbystdlibref.getIndex(GS__20, 0);
  let mtds = kirbystdlibref.getIndex(GS__20, 1);
...
SPEC_DASH_OPS["<="] = sf_DASH_compOp;
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-arithOp] in file: compiler.ky, line: 716
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-do] in file: compiler.ky, line: 761
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-case] in file: compiler.ky, line: 779
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-var] in file: compiler.ky, line: 829
...
const sf_DASH_var = function(ast, env) {
  ...
  if (pub_QMRK) {
    ...
    if (kirbystdlibref.object_QMRK(GS__22)) {
      let GS__24 = GS__22;
      Object.keys(GS__24).forEach(function(p) {
        return GS__23(kirbystdlibref.getProp(GS__24, p), p);
      });
    } else {
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-inst?] in file: compiler.ky, line: 870
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-delete] in file: compiler.ky, line: 883
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-dissoc!] in file: compiler.ky, line: 898
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-new] in file: compiler.ky, line: 914
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-throw] in file: compiler.ky, line: 928
//Throw an exception
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-x-opop] in file: compiler.ky, line: 944
...
SPEC_DASH_OPS["--$"] = sf_DASH_x_DASH_opop;
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-x-eq] in file: compiler.ky, line: 958
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-assoc!] in file: compiler.ky, line: 991
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-assign!] in file: compiler.ky, line: 1008
//Object property assignment or array index setter.
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-set] in file: compiler.ky, line: 1023
...
const sf_DASH_func = function(ast, env) {
  ...
  let GS__27 = (((typeof (ast[2]) === "string")) ?
    [ast[2], 3] :
    [null, 2]);
  let doc = kirbystdlibref.getIndex(GS__27, 0);
  let pargs = kirbystdlibref.getIndex(GS__27, 1);
  let body = xfi(ast, Array.prototype.slice.call(ast, (pargs + 1)));
  let b1 = body[0];
  let GS__28 = meta_QMRK__QMRK(ast[pargs], env);
  let attrs = kirbystdlibref.getIndex(GS__28, 0);
  let args = kirbystdlibref.getIndex(GS__28, 1);
  if ( (!mtd_QMRK) ) {
...
SPEC_DASH_OPS["defn-"] = sf_DASH_func;
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-try] in file: compiler.ky, line: 1123
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-if] in file: compiler.ky, line: 1180
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-get] in file: compiler.ky, line: 1210
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-array] in file: compiler.ky, line: 1234
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-objObj] in file: compiler.ky, line: 1259
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-mapObj] in file: compiler.ky, line: 1276
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-setObj] in file: compiler.ky, line: 1291
//Returns a new Set.
//(set 1 2 3)
...
////////////////////////////////////////////////////////////////////////////////
//fn: [require!] in file: compiler.ky, line: 1309
const require_BANG = function(path) {
  return require(path);
};
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-require] in file: compiler.ky, line: 1314
//Loads libs.
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-ns] in file: compiler.ky, line: 1409
...
const sf_DASH_ns = function(ast, env) {
  ...
  let mobj = null;
  let pos = 2;
  let GS__29 = meta_QMRK__QMRK(ast[1], env);
  let attrs = kirbystdlibref.getIndex(GS__29, 0);
  let nsp = kirbystdlibref.getIndex(GS__29, 1);
  if ( (!symbol_QMRK(nsp)) ) {
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-comment] in file: compiler.ky, line: 1463
const sf_DASH_comment = function(ast, env) {
  return "";
};
SPEC_DASH_OPS["comment"] = sf_DASH_comment;
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-for] in file: compiler.ky, line: 1466
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-floop] in file: compiler.ky, line: 1485
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-jscode] in file: compiler.ky, line: 1527
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-macro] in file: compiler.ky, line: 1544
...
const sf_DASH_unary = function(ast, env) {
  assertArity((kirbystdlibref.count(ast) === 2), ast);
  let GS__30 = ast;
  let a0 = kirbystdlibref.getIndex(GS__30, 0);
  let a1 = kirbystdlibref.getIndex(GS__30, 1);
  let ret = node_QUOT(ast);
  if ( (a0 == "not") ) {
    (
...
const spitMacros = function() {
  return ((0 === kirbystdlibref.count(_STAR_macros_STAR)) ?
    "" :
    std.wrap_DASH_str(seq(_STAR_macros_STAR).map(function(GS__31) {
      let k = kirbystdlibref.getIndex(GS__31, 0);
      let v = kirbystdlibref.getIndex(GS__31, 1);
...
const spitExterns = function() {
  ...
  if (not_DASH_empty(_STAR_externs_STAR)) {
    (
    s2 = [",\n", seq(_STAR_externs_STAR).map(function(GS__32) {
      let k = kirbystdlibref.getIndex(GS__32, 0);
      let v = kirbystdlibref.getIndex(GS__32, 1);
      return [k, ":", v].join("");
    }).join(",\n")].join(""));
  }
  return ["\n\nmodule.exports = {\n", s1, s2, "\n};\n"].join("");
...
////////////////////////////////////////////////////////////////////////////////
//fn: [banner] in file: compiler.ky, line: 1669
//Banner text for the target file
const banner = function() {
  let GS__33 = std.peekNSP();
  let id = kirbystdlibref.getProp(GS__33, "id");
  let meta = kirbystdlibref.getProp(GS__33, "meta");
  return ["/*", "Auto generated by Kirby v", MOD_DASH_VER, " - ", new Date(), "\n", "  ", id, "\n", (meta ?
    std.prn(meta, true) :
    ""), "\n", "*/\n\n"].join("");
};
////////////////////////////////////////////////////////////////////////////////
//fn: [cleanCode] in file: compiler.ky, line: 1677
...
const transpile_STAR = function(source, fname, options) {
  let GS__34 = options;
  let source_DASH_map = kirbystdlibref.getProp(GS__34, "source-map");
  let no_DASH_format = kirbystdlibref.getProp(GS__34, "no-format");
  let verbose = kirbystdlibref.getProp(GS__34, "verbose");
...
const transpile = function(code, file) {
  ...
  let options = kirbystdlibref.getIndex(GS__35, 0);
...
const sf_DASH_doseq = function(ast, env) {
  let GS__36 = Array.prototype.slice.call(arguments, 2);
  let capRes = kirbystdlibref.getIndex(GS__36, 0);
  let body = exprHint(xfi(ast, Array.prototype.slice.call(ast, 2)), false);
  ...
  let GS__37 = split_DASH_with(function() {
    let ____args = Array.prototype.slice.call(arguments);
    return (!keyword_QMRK(____args[0]));
  }, args);
  let x = kirbystdlibref.getIndex(GS__37, 0);
  let y = kirbystdlibref.getIndex(GS__37, 1);
...
const doseq_DASH_binds = function(while_QUOT, ret, y, body, ast, env, capRes) {
  ...
  partition(2, y).forEach(function(GS__38) {
    let k = kirbystdlibref.getIndex(GS__38, 0);
    let expr = kirbystdlibref.getIndex(GS__38, 1);
    return ((k == "let") ?
