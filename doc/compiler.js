/*Auto generated by Kirby v1.0.0 - Tue Mar 27 2018 02:04:29 GMT-0700 (PDT)
...
////////////////////////////////////////////////////////////////////////////////
//fn: [tnodeEx] in file: compiler.ky, line: 74
//Create a node
...
////////////////////////////////////////////////////////////////////////////////
//fn: [tnode] in file: compiler.ky, line: 78
//Create a token
  ...
  for (let ____coll = args, i = 0, ____end = kirbystdlibref.count(____coll), ____break = false; ((!____break) && (i < ____end)); i = (i + 1)) {
    ...
    if (symbol_QMRK(e)) {
      if ( (e == "&") ) {
        ...
        rval.add([ARRSLICE, "(", JSARGS, ",", [i].join(""), ")"].join(""));
        if (symbol_QMRK(e)) {
    ...
    if (symbol_QMRK(e)) {
      if ( (e == "_") ) {
        ...
        if ( (e == "&") ) {
          ...
          rval.add([ARRSLICE, "(", as, ",", [i].join(""), ")"].join(""));
          if ( (!symbol_QMRK(e)) ) {
            (
          ...
          if (true) {
            ret.add(["let ", tx_STAR(e, env), "=", stripStd(GET_DASH_INDEX), "(", as, ",", [i].join(""), ");\n"]);
          }
        }
      }
    } else {
...
////////////////////////////////////////////////////////////////////////////////
//fn: [simple?] in file: compiler.ky, line: 208
...
////////////////////////////////////////////////////////////////////////////////
//fn: [wrap] in file: compiler.ky, line: 212
...
////////////////////////////////////////////////////////////////////////////////
//fn: [exprHint] in file: compiler.ky, line: 217
...
////////////////////////////////////////////////////////////////////////////////
//fn: [quoteSingle] in file: compiler.ky, line: 313
const quoteSingle = function(a) {
  return (keyword_QMRK(a) ?
    [stripStd(KEYW), "(\"", a.value, "\")"].join("") :
    (symbol_QMRK(a) ?
      [stripStd(SYMB), "(\"", a.value, "\")"].join("") :
      (primitive_QMRK(a) ?
        (function() {
          (
          a = a.value);
...
////////////////////////////////////////////////////////////////////////////////
//fn: [quoteMap] in file: compiler.ky, line: 332
const quoteMap = function(ast, env) {
  ...
  return wrap(ret, ["[", stripStd(SYMB), "(\"hash-map\")", cma], "]");
};
////////////////////////////////////////////////////////////////////////////////
//fn: [quoteBlock] in file: compiler.ky, line: 343
...
////////////////////////////////////////////////////////////////////////////////
//fn: [spreadInfo] in file: compiler.ky, line: 351
...
////////////////////////////////////////////////////////////////////////////////
//fn: [txPairs] in file: compiler.ky, line: 362
...
////////////////////////////////////////////////////////////////////////////////
//fn: [writeDoc] in file: compiler.ky, line: 430
//Convert to jsdoc
...
////////////////////////////////////////////////////////////////////////////////
//fn: [txDo] in file: compiler.ky, line: 439
...
////////////////////////////////////////////////////////////////////////////////
//fn: [meta??] in file: compiler.ky, line: 457
...
////////////////////////////////////////////////////////////////////////////////
//fn: [fmtRegoSpecOps] in file: compiler.ky, line: 469
const fmtRegoSpecOps = function(cmd, fname) {
  return [reader.jsid("SPEC-OPS"), "[\"", cmd, "\"] = ", fname].join("");
};
////////////////////////////////////////////////////////////////////////////////
//fn: [fmtSpecOps] in file: compiler.ky, line: 473
...
////////////////////////////////////////////////////////////////////////////////
//fn: [writeFuncPre] in file: compiler.ky, line: 481
...
////////////////////////////////////////////////////////////////////////////////
//fn: [writeFuncInfo] in file: compiler.ky, line: 489
...
////////////////////////////////////////////////////////////////////////////////
//fn: [evalMeta] in file: compiler.ky, line: 501
...
////////////////////////////////////////////////////////////////////////////////
//fn: [stripStd] in file: compiler.ky, line: 516
...
////////////////////////////////////////////////////////////////////////////////
//fn: [assertArity] in file: compiler.ky, line: 524
...
////////////////////////////////////////////////////////////////////////////////
//fn: [assertInfo] in file: compiler.ky, line: 529
...
////////////////////////////////////////////////////////////////////////////////
//fn: [loadRLib] in file: compiler.ky, line: 537
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-juxt] in file: compiler.ky, line: 551
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-deref] in file: compiler.ky, line: 571
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-compose] in file: compiler.ky, line: 582
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-quote] in file: compiler.ky, line: 611
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-deftype] in file: compiler.ky, line: 618
//Define a JS Class
...
SPEC_DASH_OPS["deftype-"] = sf_DASH_deftype;
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-compOp] in file: compiler.ky, line: 664
...
SPEC_DASH_OPS["="] = sf_DASH_compOp;
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-arithOp] in file: compiler.ky, line: 688
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-do] in file: compiler.ky, line: 731
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-case] in file: compiler.ky, line: 749
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-var] in file: compiler.ky, line: 795
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-inst?] in file: compiler.ky, line: 836
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-delete] in file: compiler.ky, line: 849
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-dissoc!] in file: compiler.ky, line: 863
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-new] in file: compiler.ky, line: 879
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-throw] in file: compiler.ky, line: 893
//Throw an exception
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-x-opop] in file: compiler.ky, line: 907
...
SPEC_DASH_OPS["--$"] = sf_DASH_x_DASH_opop;
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-x-eq] in file: compiler.ky, line: 921
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-assoc!] in file: compiler.ky, line: 954
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-assign!] in file: compiler.ky, line: 970
//Object property assignment or array index setter.
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-set] in file: compiler.ky, line: 984
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-fn] in file: compiler.ky, line: 1000
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-func] in file: compiler.ky, line: 1020
...
SPEC_DASH_OPS["defn-"] = sf_DASH_func;
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-try] in file: compiler.ky, line: 1082
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-if] in file: compiler.ky, line: 1139
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-get] in file: compiler.ky, line: 1169
...
const sf_DASH_get = function(ast, env) {
  assertArity((kirbystdlibref.count(ast) === 3), ast);
  let a0 = [ast[0]].join("");
  let cmd = stripStd(GET_DASH_PROP);
  return ((a0 == "get") ?
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-array] in file: compiler.ky, line: 1193
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-objObj] in file: compiler.ky, line: 1217
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-mapObj] in file: compiler.ky, line: 1233
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-setObj] in file: compiler.ky, line: 1247
//Returns a new Set.
//(set 1 2 3)
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-require2] in file: compiler.ky, line: 1269
...
const sf_DASH_require = function(ast, env) {
  ...
  for (let GS__43 = 0, GS__41 = true, GS__42 = ast.slice(1), ____sz = kirbystdlibref.count(GS__42), ____break = false; (!____break && GS__41 && (GS__43 < ____sz)); ++GS__43) {
    let a_QUOT = GS__42[GS__43];
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-ns] in file: compiler.ky, line: 1352
...
const sf_DASH_ns = function(ast, env) {
  ...
  let mobj = null;
  let pos = 2;
  let GS__44 = meta_QMRK__QMRK(ast[1], env);
  let attrs = kirbystdlibref.getIndex(GS__44, 0);
  let nsp = kirbystdlibref.getIndex(GS__44, 1);
  if ( (!symbol_QMRK(nsp)) ) {
  ...
  for (let GS__47 = 0, GS__45 = true, GS__46 = ast, ____sz = kirbystdlibref.count(GS__46), ____break = false; (!____break && GS__45 && (GS__47 < ____sz)); ++GS__47) {
    let e = GS__46[GS__47];
    if (pairs_QMRK(e)) {
      if ( ([e[0]].join("") == "require") ) {
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-comment] in file: compiler.ky, line: 1404
const sf_DASH_comment = function(ast, env) {
  return "";
};
SPEC_DASH_OPS["comment"] = sf_DASH_comment;
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-while] in file: compiler.ky, line: 1407
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-wloop] in file: compiler.ky, line: 1424
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-forxxx] in file: compiler.ky, line: 1439
//Generates native (js) for loop.
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-foop] in file: compiler.ky, line: 1455
//For loop implementation
  ...
  for (let ____coll = args, i = 0, ____end = kirbystdlibref.count(____coll), ____break = false; ((!____break) && (i < ____end)); i = (i + 1)) {
    ...
    if ( (ev == "&") ) {
      if ( (Array.isArray(args[(i + 1)])) ) {
        ...
        e = args[(i + 1)]);
        ++i;
        for (let GS__50 = 0, GS__48 = true, GS__49 = e, ____sz = kirbystdlibref.count(GS__49), ____break = false; (!____break && GS__48 && (GS__50 < ____sz)); ++GS__50) {
          let x = GS__49[GS__50];
          if ( (!symbol_QMRK(x)) ) {
            error_BANG("syntax-error", ast);
          } else {
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-unary] in file: compiler.ky, line: 1594
//Special unary operators.
const sf_DASH_unary = function(ast, env) {
  assertArity((kirbystdlibref.count(ast) === 2), ast);
  let GS__51 = ast;
  let a0 = kirbystdlibref.getIndex(GS__51, 0);
  let a1 = kirbystdlibref.getIndex(GS__51, 1);
  let ret = node_QUOT(ast);
  if ( (a0 == "not") ) {
    (
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-listc] in file: compiler.ky, line: 1607
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-doseq] in file: compiler.ky, line: 1630
//Repeatedly executes body (presumably for side-effects) with
//bindings and filtering as provided by "for".  Does not retain
//the head of the sequence. Returns nil.
const sf_DASH_doseq = function(ast, env) {
  let GS__52 = Array.prototype.slice.call(arguments, 2);
  let capRes = kirbystdlibref.getIndex(GS__52, 0);
  let body = exprHint(xfi(ast, Array.prototype.slice.call(ast, 2)), false);
  ...
  let GS__53 = split_DASH_with(function() {
    let ____args = Array.prototype.slice.call(arguments);
    return (!keyword_QMRK(____args[0]));
  }, args);
  let x = kirbystdlibref.getIndex(GS__53, 0);
  let y = kirbystdlibref.getIndex(GS__53, 1);
...
////////////////////////////////////////////////////////////////////////////////
//fn: [doseq-binds] in file: compiler.ky, line: 1683
const doseq_DASH_binds = function(while_QUOT, ret, y, body, ast, env, capRes) {
  let patch = node_QUOT(ast);
  partition(2, y).forEach(function(GS__54) {
    let k = kirbystdlibref.getIndex(GS__54, 0);
    let expr = kirbystdlibref.getIndex(GS__54, 1);
    return ((k == "let") ?
...
////////////////////////////////////////////////////////////////////////////////
//fn: [getPrePost] in file: compiler.ky, line: 1707
...
////////////////////////////////////////////////////////////////////////////////
//fn: [xfi] in file: compiler.ky, line: 1720
...
////////////////////////////////////////////////////////////////////////////////
//fn: [spitMacros] in file: compiler.ky, line: 1734
const spitMacros = function() {
  return ((0 === kirbystdlibref.count(_STAR_macros_STAR)) ?
    "{}" :
    std.wrap_DASH_str(seq(_STAR_macros_STAR).map(function(GS__55) {
      let k = kirbystdlibref.getIndex(GS__55, 0);
      let v = kirbystdlibref.getIndex(GS__55, 1);
      return [quote_DASH_str([k].join("")), ":", quote_DASH_str(v)].join("");
    }).join(",\n"), "{\n", "}\n"));
};
////////////////////////////////////////////////////////////////////////////////
//fn: [spitVars] in file: compiler.ky, line: 1744
...
////////////////////////////////////////////////////////////////////////////////
//fn: [spitExterns] in file: compiler.ky, line: 1752
...
const spitExterns = function() {
  ...
  if (not_DASH_empty(_STAR_externs_STAR)) {
    (
    s2 = [",\n", seq(_STAR_externs_STAR).map(function(GS__56) {
      let k = kirbystdlibref.getIndex(GS__56, 0);
      let v = kirbystdlibref.getIndex(GS__56, 1);
      return [k, ":", v].join("");
    }).join(",\n")].join(""));
  }
  return ["\n\nmodule.exports = {\n", s1, s2, "\n};\n"].join("");
...
////////////////////////////////////////////////////////////////////////////////
//fn: [banner] in file: compiler.ky, line: 1770
//Banner text for the target file
const banner = function() {
  let GS__57 = std.peekNSP();
  let id = kirbystdlibref.getProp(GS__57, "id");
  let meta = kirbystdlibref.getProp(GS__57, "meta");
  return ["/*", "Auto generated by Kirby v", MOD_DASH_VER, " - ", new Date(), "\n", "  ", id, "\n", (meta ?
    std.prn(meta, true) :
    ""), "\n", "*/\n\n"].join("");
};
////////////////////////////////////////////////////////////////////////////////
//fn: [cleanCode] in file: compiler.ky, line: 1778
...
////////////////////////////////////////////////////////////////////////////////
//fn: [transpile*] in file: compiler.ky, line: 1786
...
const transpile_STAR = function(source, fname, options) {
  let GS__58 = options;
  let source_DASH_map = kirbystdlibref.getProp(GS__58, "source-map");
  let no_DASH_format = kirbystdlibref.getProp(GS__58, "no-format");
  let verbose = kirbystdlibref.getProp(GS__58, "verbose");
...
////////////////////////////////////////////////////////////////////////////////
//fn: [transpile] in file: compiler.ky, line: 1830
//Compile kirby file to target source
const transpile = function(code, file) {
  let GS__59 = Array.prototype.slice.call(arguments, 2);
  let options = kirbystdlibref.getIndex(GS__59, 0);
...
////////////////////////////////////////////////////////////////////////////////
//fn: [dbgAST] in file: compiler.ky, line: 1844
//Dump AST to xml
