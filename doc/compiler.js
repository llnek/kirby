/*Auto generated by Kirby v1.0.0 - Thu Mar 22 2018 00:06:32 GMT-0700 (PDT)
...
const sf_DASH_foop = function(ret, args, body, env, stmtQ) {
  ...
  ret.add(["){\n", sf_DASH_var(xfi(ast, [kirbystdlibref.symbol("vars"), lvar, [kirbystdlibref.symbol("nth"), args, kirbystdlibref.symbol("____index")]]), env), txDo(body, env, false), "}\n"]);
  if ( (!stmtQ) ) {
    wrap(ret, "(function() {\n", "; return null; }).call(this)");
  } else {
    null;
