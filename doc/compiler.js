/*Auto generated by Kirby v1.0.0 - Wed Mar 28 2018 02:03:34 GMT-0700 (PDT)
...
////////////////////////////////////////////////////////////////////////////////
//fn: [unmangle] in file: compiler.ky, line: 70
...
////////////////////////////////////////////////////////////////////////////////
//fn: [tnodeEx] in file: compiler.ky, line: 75
...
////////////////////////////////////////////////////////////////////////////////
//fn: [tnode] in file: compiler.ky, line: 79
...
////////////////////////////////////////////////////////////////////////////////
//fn: [doFuncArgs] in file: compiler.ky, line: 88
...
////////////////////////////////////////////////////////////////////////////////
//fn: [dstru*] in file: compiler.ky, line: 122
//Decide on what the
...
////////////////////////////////////////////////////////////////////////////////
//fn: [dvec!] in file: compiler.ky, line: 138
//Destruct a vec
...
////////////////////////////////////////////////////////////////////////////////
//fn: [dmap!] in file: compiler.ky, line: 169
//Destruct a map
...
////////////////////////////////////////////////////////////////////////////////
//fn: [simple?] in file: compiler.ky, line: 187
//Nothing complex
...
////////////////////////////////////////////////////////////////////////////////
//fn: [wrap] in file: compiler.ky, line: 191
...
////////////////////////////////////////////////////////////////////////////////
//fn: [exprHint] in file: compiler.ky, line: 195
...
////////////////////////////////////////////////////////////////////////////////
//fn: [stmt?] in file: compiler.ky, line: 201
...
////////////////////////////////////////////////////////////////////////////////
//fn: [error!] in file: compiler.ky, line: 205
...
////////////////////////////////////////////////////////////////////////////////
//fn: [testre?] in file: compiler.ky, line: 212
//Test a regex
...
////////////////////////////////////////////////////////////////////////////////
//fn: [fn??] in file: compiler.ky, line: 213
...
////////////////////////////////////////////////////////////////////////////////
//fn: [pad] in file: compiler.ky, line: 217
const pad = function(n) {
  return " ".repeat(n);
};
////////////////////////////////////////////////////////////////////////////////
//fn: [node'] in file: compiler.ky, line: 220
...
////////////////////////////////////////////////////////////////////////////////
//fn: [txTree] in file: compiler.ky, line: 225
...
////////////////////////////////////////////////////////////////////////////////
//fn: [txForm] in file: compiler.ky, line: 244
...
////////////////////////////////////////////////////////////////////////////////
//fn: [txAtom] in file: compiler.ky, line: 249
...
////////////////////////////////////////////////////////////////////////////////
//fn: [tx*] in file: compiler.ky, line: 271
...
////////////////////////////////////////////////////////////////////////////////
//fn: [gcmd] in file: compiler.ky, line: 275
...
////////////////////////////////////////////////////////////////////////////////
//fn: [quoteSingle] in file: compiler.ky, line: 285
...
////////////////////////////////////////////////////////////////////////////////
//fn: [quote!] in file: compiler.ky, line: 296
...
////////////////////////////////////////////////////////////////////////////////
//fn: [quoteMap] in file: compiler.ky, line: 303
...
////////////////////////////////////////////////////////////////////////////////
//fn: [quoteBlock] in file: compiler.ky, line: 314
...
////////////////////////////////////////////////////////////////////////////////
//fn: [spreadInfo] in file: compiler.ky, line: 321
...
////////////////////////////////////////////////////////////////////////////////
//fn: [txPairs] in file: compiler.ky, line: 330
...
////////////////////////////////////////////////////////////////////////////////
//fn: [writeDoc] in file: compiler.ky, line: 383
//Convert to jsdoc
...
////////////////////////////////////////////////////////////////////////////////
//fn: [txDo] in file: compiler.ky, line: 390
...
////////////////////////////////////////////////////////////////////////////////
//fn: [meta??] in file: compiler.ky, line: 408
...
////////////////////////////////////////////////////////////////////////////////
//fn: [fmtRegoSpecOps] in file: compiler.ky, line: 420
const fmtRegoSpecOps = function(cmd, fname) {
  return [reader.jsid("SPEC-OPS"), "[\"", cmd, "\"] = ", fname].join("");
};
////////////////////////////////////////////////////////////////////////////////
//fn: [fmtSpecOps] in file: compiler.ky, line: 424
...
////////////////////////////////////////////////////////////////////////////////
//fn: [writeFuncPre] in file: compiler.ky, line: 432
...
////////////////////////////////////////////////////////////////////////////////
//fn: [writeFuncInfo] in file: compiler.ky, line: 440
...
////////////////////////////////////////////////////////////////////////////////
//fn: [evalMeta] in file: compiler.ky, line: 452
...
////////////////////////////////////////////////////////////////////////////////
//fn: [slib!] in file: compiler.ky, line: 467
...
////////////////////////////////////////////////////////////////////////////////
//fn: [assertArity] in file: compiler.ky, line: 475
...
////////////////////////////////////////////////////////////////////////////////
//fn: [assertInfo] in file: compiler.ky, line: 480
...
////////////////////////////////////////////////////////////////////////////////
//fn: [loadRLib] in file: compiler.ky, line: 488
//Load in all the exported macros from the external lib
const loadRLib = function(info, env) {
  let ast = undefined;
  let s = undefined;
  let GS__30 = info;
  let ns = kirbystdlibref.getProp(GS__30, "ns");
  let macros = kirbystdlibref.getProp(GS__30, "macros");
  let GS__31 = macros;
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-juxt] in file: compiler.ky, line: 502
...
const sf_DASH_juxt = function(ast, env) {
  ...
  for (let GS__36 = 0, GS__34 = true, GS__35 = ast.slice(1), ____sz = kirbystdlibref.count(GS__35), ____break = false; (!____break && GS__34 && (GS__36 < ____sz)); ++GS__36) {
    let a_QUOT = GS__35[GS__36];
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-deref] in file: compiler.ky, line: 522
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-compose] in file: compiler.ky, line: 533
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-quote] in file: compiler.ky, line: 562
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-deftype] in file: compiler.ky, line: 569
//Define a JS Class
const sf_DASH_deftype = function(ast, env) {
  ...
  let par = ast[2][0];
  let GS__37 = (((typeof (ast[3]) === "string")) ?
    [ast[3], Array.prototype.slice.call(ast, 4)] :
    [null, Array.prototype.slice.call(ast, 3)]);
  let doc = kirbystdlibref.getIndex(GS__37, 0);
  let mtds = kirbystdlibref.getIndex(GS__37, 1);
  rt.addVar(czname0, (new Map([["ns", std._STAR_ns_STAR()], ["alias", czname0], ["type", "class"]])));
  ret.add(["class ", czname].join(""));
  if (par) {
  ...
  mtds.forEach(function(m) {
    ...
    m.unshift(mtd);
    rt.addVar(cn, (new Map([["ns", std._STAR_ns_STAR()], ["alias", cn], ["type", "method"]])));
  ...
  if (pub_QMRK) {
    conj_BANG(_STAR_vars_STAR, czname0);
...
SPEC_DASH_OPS["deftype-"] = sf_DASH_deftype;
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-compOp] in file: compiler.ky, line: 615
...
SPEC_DASH_OPS["="] = sf_DASH_compOp;
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-arithOp] in file: compiler.ky, line: 639
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-do] in file: compiler.ky, line: 682
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-case] in file: compiler.ky, line: 700
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-var] in file: compiler.ky, line: 746
...
const sf_DASH_var = function(ast, env) {
  ...
  for (let ____coll = ast, i = 1, ____end = kirbystdlibref.count(____coll), ____break = false; ((!____break) && (i < ____end)); i = (i + 2)) {
    ...
    if (symbol_QMRK(lhs)) {
      ...
      if ( (!("let" == cmd)) ) {
        rt.addVar([x].join(""), (new Map([["ns", std._STAR_ns_STAR()], ["alias", [x].join("")], ["type", "var"]])));
      } else {
        null;
      }
      ...
      (out = node_QUOT(ast), rhs = dstru_STAR(lhs, out, env));
  ...
  if (pub_QMRK) {
    ...
    if (kirbystdlibref.object_QMRK(GS__39)) {
      let GS__41 = GS__39;
      Object.keys(GS__41).forEach(function(p) {
        return GS__40(kirbystdlibref.getProp(GS__41, p), p);
      });
    } else {
      GS__39.forEach(GS__40);
    }
  }
  return ret;
};
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-inst?] in file: compiler.ky, line: 787
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-delete] in file: compiler.ky, line: 800
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-dissoc!] in file: compiler.ky, line: 814
//Remove a key from Map.
const sf_DASH_dissoc_BANG = function(ast, env) {
  assertArity((kirbystdlibref.count(ast) === 3), ast);
  let ret = node_QUOT(ast);
  ret.add([slib_BANG([KBSTDLR, ".", tx_STAR(symbol("dissoc!"), env)].join("")), "(", tx_STAR(ast[1], env), ",", tx_STAR(ast[2], env), ")"]);
  return ret;
};
SPEC_DASH_OPS["dissoc!"] = sf_DASH_dissoc_BANG;
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-new] in file: compiler.ky, line: 830
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-throw] in file: compiler.ky, line: 844
//Throw an exception
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-x-opop] in file: compiler.ky, line: 858
...
SPEC_DASH_OPS["--$"] = sf_DASH_x_DASH_opop;
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-x-eq] in file: compiler.ky, line: 872
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-assoc!] in file: compiler.ky, line: 905
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-assign!] in file: compiler.ky, line: 921
//Object property assignment or array index setter.
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-set] in file: compiler.ky, line: 935
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-func] in file: compiler.ky, line: 971
...
const sf_DASH_func = function(ast, env) {
  ...
  let GS__44 = (((typeof (ast[2]) === "string")) ?
    [ast[2], 3] :
    [null, 2]);
  let doc = kirbystdlibref.getIndex(GS__44, 0);
  let pargs = kirbystdlibref.getIndex(GS__44, 1);
  let body = xfi(ast, Array.prototype.slice.call(ast, (pargs + 1)));
  let b1 = body[0];
  let GS__45 = meta_QMRK__QMRK(ast[pargs], env);
  let attrs = kirbystdlibref.getIndex(GS__45, 0);
  let args = kirbystdlibref.getIndex(GS__45, 1);
  if ( (!mtd_QMRK) ) {
    rt.addVar(fname0, (new Map([["ns", std._STAR_ns_STAR()], ["alias", fname0], ["type", "fn"]])));
  } else {
    null;
  }
  if ( (!(Array.isArray(args))) ) {
...
SPEC_DASH_OPS["defn-"] = sf_DASH_func;
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-try] in file: compiler.ky, line: 1033
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-if] in file: compiler.ky, line: 1090
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-get] in file: compiler.ky, line: 1120
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-array] in file: compiler.ky, line: 1144
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-objObj] in file: compiler.ky, line: 1168
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-mapObj] in file: compiler.ky, line: 1184
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-setObj] in file: compiler.ky, line: 1198
//Returns a new Set.
//(set 1 2 3)
...
////////////////////////////////////////////////////////////////////////////////
//fn: [require!] in file: compiler.ky, line: 1215
const require_BANG = function(path) {
  return require(path);
};
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-require2] in file: compiler.ky, line: 1220
const sf_DASH_require2 = function(ret, fdir, ast, env) {
  ...
  for (let ____coll = refers, ____index = 0, ____end = kirbystdlibref.count(____coll), ____break = false; ((!____break) && (____index < ____end)); ____index = (____index + 1)) {
    ...
    (rs = [r].join(""), v = tx_STAR(r, env), m = kirbystdlibref.getProp(mcs, rs), f = kirbystdlibref.getProp(rlib, reader.jsid(rs)));
    if (f) {
      (
      t = typeid(f));
    }
    ...
    rt.addVar(rs, (new Map([["ns", nsp], ["alias", rs], ["type", t]])));
  ...
  return (function() {
    for (let ____coll = renames, i = 0, ____end = kirbystdlibref.count(____coll), ____break = false; ((!____break) && (i < ____end)); i = (i + 2)) {
      let ro = ____coll[i];
      (e = tx_STAR(ro, env), r = renames[(i + 1)], rs = [r].join(""), v = tx_STAR(r, env), m = kirbystdlibref.getProp(mcs, [ro].join("")), f = kirbystdlibref.getProp(rlib, reader.jsid([ro].join(""))));
      if (f) {
        (
        t = typeid(f));
      }
      ...
      rt.addVar(rs, (new Map([["ns", nsp], ["alias", [ro].join("")], ["type", t]])));
...
const sf_DASH_require = function(ast, env) {
  ...
  for (let GS__48 = 0, GS__46 = true, GS__47 = ast.slice(1), ____sz = kirbystdlibref.count(GS__47), ____break = false; (!____break && GS__46 && (GS__48 < ____sz)); ++GS__48) {
    let a_QUOT = GS__47[GS__48];
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-ns] in file: compiler.ky, line: 1303
...
const sf_DASH_ns = function(ast, env) {
  ...
  let mobj = null;
  let pos = 2;
  let GS__49 = meta_QMRK__QMRK(ast[1], env);
  let attrs = kirbystdlibref.getIndex(GS__49, 0);
  let nsp = kirbystdlibref.getIndex(GS__49, 1);
  if ( (!symbol_QMRK(nsp)) ) {
  ...
  for (let GS__52 = 0, GS__50 = true, GS__51 = ast, ____sz = kirbystdlibref.count(GS__51), ____break = false; (!____break && GS__50 && (GS__52 < ____sz)); ++GS__52) {
    let e = GS__51[GS__52];
    if (pairs_QMRK(e)) {
      if ( ([e[0]].join("") == "require") ) {
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-comment] in file: compiler.ky, line: 1355
const sf_DASH_comment = function(ast, env) {
  return "";
};
SPEC_DASH_OPS["comment"] = sf_DASH_comment;
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-while] in file: compiler.ky, line: 1358
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-wloop] in file: compiler.ky, line: 1375
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-forxxx] in file: compiler.ky, line: 1390
//Generates native (js) for loop.
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-foop] in file: compiler.ky, line: 1406
//For loop implementation
...
const sf_DASH_macro = function(ast, env) {
  ...
  for (let ____coll = args, i = 0, ____end = kirbystdlibref.count(____coll), ____break = false; ((!____break) && (i < ____end)); i = (i + 1)) {
    ...
    if ( (ev == "&") ) {
      if ( (Array.isArray(args[(i + 1)])) ) {
        ...
        e = args[(i + 1)]);
        ++i;
        for (let GS__55 = 0, GS__53 = true, GS__54 = e, ____sz = kirbystdlibref.count(GS__54), ____break = false; (!____break && GS__53 && (GS__55 < ____sz)); ++GS__55) {
          let x = GS__54[GS__55];
          if ( (!symbol_QMRK(x)) ) {
            error_BANG("syntax-error", ast);
          } else {
  ...
  rt.addVar(mname, (new Map([["ns", std._STAR_ns_STAR()], ["alias", null], ["type", "macro"]])));
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-unary] in file: compiler.ky, line: 1545
//Special unary operators.
const sf_DASH_unary = function(ast, env) {
  assertArity((kirbystdlibref.count(ast) === 2), ast);
  let GS__56 = ast;
  let a0 = kirbystdlibref.getIndex(GS__56, 0);
  let a1 = kirbystdlibref.getIndex(GS__56, 1);
  let ret = node_QUOT(ast);
  if ( (a0 == "not") ) {
    (
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-listc] in file: compiler.ky, line: 1558
...
////////////////////////////////////////////////////////////////////////////////
//fn: [sf-doseq] in file: compiler.ky, line: 1581
//Repeatedly executes body (presumably for side-effects) with
//bindings and filtering as provided by "for".  Does not retain
//the head of the sequence. Returns nil.
const sf_DASH_doseq = function(ast, env) {
  let GS__57 = Array.prototype.slice.call(arguments, 2);
  let capRes = kirbystdlibref.getIndex(GS__57, 0);
  let body = exprHint(xfi(ast, Array.prototype.slice.call(ast, 2)), false);
  let kount = slib_BANG([KBSTDLR, ".count"].join(""));
  let args = ast[1];
  ...
  let GS__58 = split_DASH_with(function() {
    let ____args = Array.prototype.slice.call(arguments);
    return (!keyword_QMRK(____args[0]));
  }, args);
  let x = kirbystdlibref.getIndex(GS__58, 0);
  let y = kirbystdlibref.getIndex(GS__58, 1);
...
////////////////////////////////////////////////////////////////////////////////
//fn: [doseq-binds] in file: compiler.ky, line: 1634
const doseq_DASH_binds = function(while_QUOT, ret, y, body, ast, env, capRes) {
  let patch = node_QUOT(ast);
  partition(2, y).forEach(function(GS__59) {
    let k = kirbystdlibref.getIndex(GS__59, 0);
    let expr = kirbystdlibref.getIndex(GS__59, 1);
    return ((k == "let") ?
...
////////////////////////////////////////////////////////////////////////////////
//fn: [getPrePost] in file: compiler.ky, line: 1658
...
////////////////////////////////////////////////////////////////////////////////
//fn: [xfi] in file: compiler.ky, line: 1671
...
////////////////////////////////////////////////////////////////////////////////
//fn: [spitMacros] in file: compiler.ky, line: 1685
const spitMacros = function() {
  return ((0 === kirbystdlibref.count(_STAR_macros_STAR)) ?
    "{}" :
    std.wrap_DASH_str(seq(_STAR_macros_STAR).map(function(GS__60) {
      let k = kirbystdlibref.getIndex(GS__60, 0);
      let v = kirbystdlibref.getIndex(GS__60, 1);
      return [quote_DASH_str([k].join("")), ":", quote_DASH_str(v)].join("");
    }).join(",\n"), "{\n", "}\n"));
};
////////////////////////////////////////////////////////////////////////////////
//fn: [spitVars] in file: compiler.ky, line: 1695
const spitVars = function() {
  return ((0 === kirbystdlibref.count(_STAR_vars_STAR)) ?
    "[]" :
    std.wrap_DASH_str(_STAR_vars_STAR.map(function(k) {
      return quote_DASH_str([k].join(""));
    }).join(","), "[ ", "]"));
};
////////////////////////////////////////////////////////////////////////////////
//fn: [spitExterns] in file: compiler.ky, line: 1703
//Write out export info
const spitExterns = function() {
  let mc = spitMacros();
  let vs = spitVars();
  let s2 = "";
  let s1 = [EXPKEY, ": { ns: ", quote_DASH_str(std._STAR_ns_STAR()), ", vars: ", vs, ", macros: ", mc, " }"].join("");
  if (not_DASH_empty(_STAR_externs_STAR)) {
    (
    s2 = [",\n", seq(_STAR_externs_STAR).map(function(GS__61) {
      let k = kirbystdlibref.getIndex(GS__61, 0);
      let v = kirbystdlibref.getIndex(GS__61, 1);
      return [k, ":", v].join("");
    }).join(",\n")].join(""));
  }
  return ["\n\nmodule.exports = {\n", s1, s2, "\n};\n"].join("");
...
////////////////////////////////////////////////////////////////////////////////
//fn: [banner] in file: compiler.ky, line: 1721
//Banner text for the target file
const banner = function() {
  let GS__62 = std.peekNSP();
  let id = kirbystdlibref.getProp(GS__62, "id");
  let meta = kirbystdlibref.getProp(GS__62, "meta");
  return ["/*", "Auto generated by Kirby v", MOD_DASH_VER, " - ", new Date(), "\n", "  ", id, "\n", (meta ?
    std.prn(meta, true) :
    ""), "\n", "*/\n\n"].join("");
};
////////////////////////////////////////////////////////////////////////////////
//fn: [cleanCode] in file: compiler.ky, line: 1729
...
const transpile_STAR = function(source, fname, options) {
  let GS__63 = options;
  let source_DASH_map = kirbystdlibref.getProp(GS__63, "source-map");
  let no_DASH_format = kirbystdlibref.getProp(GS__63, "no-format");
  let verbose = kirbystdlibref.getProp(GS__63, "verbose");
  ...
  let lbs = rt.getLibKeys();
  let vas = rt.getVarKeys();
  if (verbose) {
    println("<macros>\n", std.prn(mcs, true));
    println("<libs>\n", std.prn(lbs, true));
...
////////////////////////////////////////////////////////////////////////////////
//fn: [transpile] in file: compiler.ky, line: 1781
//Compile kirby file to target source
const transpile = function(code, file) {
  let GS__64 = Array.prototype.slice.call(arguments, 2);
  let options = kirbystdlibref.getIndex(GS__64, 0);
  (_STAR_externs_STAR = (new Map([])), _STAR_vars_STAR = std.into_BANG("vector", []), _STAR_macros_STAR = (new Map([])), _STAR_last_DASH_line_STAR = 0, _STAR_last_DASH_col_STAR = 0);
  return (function() {
    try {
...
////////////////////////////////////////////////////////////////////////////////
//fn: [dbgAST] in file: compiler.ky, line: 1795
//Dump AST to xml
