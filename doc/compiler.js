/*Auto generated by Kirby v1.0.0 - Sat Mar 17 2018 22:23:34 GMT-0700 (PDT)
...
const sf_DASH_doseq = function(ast, env) {
  ...
  rseq(partition(2, x)).forEach(function(GS__46) {
    ...
    let n_QUOT = gensym();
    (ret = node_QUOT(ast));
    ret.add(["for(let ", [n_QUOT].join(""), "=0,", tx_STAR(v, env), "=undefined,", [e_QUOT].join(""), "=", tx_STAR(expr, env), ",", "sz=count(", [e_QUOT].join(""), "),____break=false; ", "(!____break && (", [n_QUOT].join(""), " < sz)); ++", [n_QUOT].join(""), "){\n"]);
