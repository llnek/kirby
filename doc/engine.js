/*Auto generated by Kirby v1.0.0 - Tue Jan 30 2018 01:27:29 GMT-0800 (PST)
  czlab.kirby.engine
...
class LEXEnv {
  ...
  constructor(parent, vars, vals) {
    ...
    for (let i = 0, e = null, ev = null, sz = kirbystdlibref.count(vars), ____break = false; ((!____break) && (i < sz)); i = (i + 1)) {
      (e = vars[i], ev = e.value);
      if ( (ev == "&") ) {
        (this.data.set([vars[i + 1]].join(""), Array.prototype.slice.call(vals, i)));
        (
        ____break = true);
      } else {
        if (ev.startsWith("&")) {
          (this.data.set(ev.slice(1), Array.prototype.slice.call(vals, i)));
          (
          ____break = true);
        } else {
          if (true) {
...
const CACHE = (new Map([]));
////////////////////////////////////////////////////////////////////////////////
//fn: [setMacro] in file: engine.ky, line: 320
...
////////////////////////////////////////////////////////////////////////////////
//fn: [getMacro] in file: engine.ky, line: 334
//Get macro
...
////////////////////////////////////////////////////////////////////////////////
//fn: [expand??] in file: engine.ky, line: 395
...
////////////////////////////////////////////////////////////////////////////////
//fn: [eval*] in file: engine.ky, line: 403
              ...
              (map_QMRK(ast) ?
                (function() {
                  ...
                  for (let i = 0, sz = kirbystdlibref.count(ast), ____break = false; ((!____break) && (i < sz)); i = (i + 2)) {
                    (m.set(compute(ast[i], env), compute(ast[i + 1], env)));
                  }
                  return m;
                }).call(this) :
                (true ?
...
////////////////////////////////////////////////////////////////////////////////
//fn: [doAND] in file: engine.ky, line: 425
...
////////////////////////////////////////////////////////////////////////////////
//fn: [doOR] in file: engine.ky, line: 433
...
////////////////////////////////////////////////////////////////////////////////
//fn: [doLET] in file: engine.ky, line: 441
...
////////////////////////////////////////////////////////////////////////////////
//fn: [doMACRO] in file: engine.ky, line: 452
...
const form_STAR = function(ast, env) {
  ...
  return ((vector_QMRK(ast) || obj_QMRK(ast) || map_QMRK(ast) || list_QMRK(ast)) ?
    atom(el) :
    ((Array.isArray(el)) ?
      (function() {
...
////////////////////////////////////////////////////////////////////////////////
//fn: [genv] in file: engine.ky, line: 587
