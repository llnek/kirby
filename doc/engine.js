/*Auto generated by Kirby v1.0.0 - Wed Jan 24 2018 00:35:00 GMT-0800 (PST)
  czlab.kirby.engine
...
const prefix = "kirby> ";
////////////////////////////////////////////////////////////////////////////////
//fn: [expect!] in file: engine.ky, line: 48
...
class LEXEnv {
  ////////////////////////////////////////////////////////////////////////////////
  //fn: [constructor] in file: engine.ky, line: 56
  ...
  ////////////////////////////////////////////////////////////////////////////////
  //fn: [prn] in file: engine.ky, line: 101
  //Print set of vars
  prn() {
    return std.prn(this.data);
  }
  ////////////////////////////////////////////////////////////////////////////////
  //fn: [getLib] in file: engine.ky, line: 105
  getLib(alias) {
    return (this.par ?
  ...
  ////////////////////////////////////////////////////////////////////////////////
  //fn: [addVar] in file: engine.ky, line: 110
  addVar(sym, info) {
    return (this.par ?
  ...
  ////////////////////////////////////////////////////////////////////////////////
  //fn: [getVar] in file: engine.ky, line: 118
  getVar(sym) {
    return (this.par ?
      this.par.getVar(sym) :
  ...
  ////////////////////////////////////////////////////////////////////////////////
  //fn: [hasVar?] in file: engine.ky, line: 123
  hasVar_QMRK(sym) {
    return (this.par ?
  ...
  ////////////////////////////////////////////////////////////////////////////////
  //fn: [addLib] in file: engine.ky, line: 128
  addLib(alias, lib) {
    return (this.par ?
...
const _STAR_runtime_DASH_funcs_STAR = {
  "macroexpand*": function(code) {
    ...
    let env = GS__13[0];
    return println(std.prn(expand_QMRK__QMRK(code, (env || g_env))));
  },
...
var loadedMacros_QMRK = false;
const CACHE = {};
////////////////////////////////////////////////////////////////////////////////
//fn: [loadMacros] in file: engine.ky, line: 332
const loadMacros = function() {
  if ( (!loadedMacros_QMRK) ) {
    (
    loadedMacros_QMRK = true);
    require("./macros.ky");
  }
  return loadedMacros_QMRK;
};
////////////////////////////////////////////////////////////////////////////////
//fn: [setMacro] in file: engine.ky, line: 338
...
////////////////////////////////////////////////////////////////////////////////
//fn: [getMacro] in file: engine.ky, line: 352
//Get macro
